...
MemoryTemplate (arf192b080e1r1w0cbbehbaa4acw_dfx_wrapper) {

  CellName              : arf192b080e1r1w0cbbehbaa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  ...
  AddressCounter {
    ...
    Function (RowAddress) {
      CountRange[79:0];  //Encoded Address
    }
  }
  ...
  Port ( FUNC_WR_DATA_IN_P0[191:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P0[191:0];
    }
  }
...
//----- Start of Redundancy Analysis Segment -------------
  ...
  RedundancyAnalysis { 
    ...
    ColumnSegment(All) {
      ...
      ShiftedIORange : DATA_OUT_P0[191:0] ;
      FuseSet {
        FuseMap[7:0] {
...
} //end MemoryTemplate (arf192b080e1r1w0cbbehbaa4acw_dfx_wrapper)