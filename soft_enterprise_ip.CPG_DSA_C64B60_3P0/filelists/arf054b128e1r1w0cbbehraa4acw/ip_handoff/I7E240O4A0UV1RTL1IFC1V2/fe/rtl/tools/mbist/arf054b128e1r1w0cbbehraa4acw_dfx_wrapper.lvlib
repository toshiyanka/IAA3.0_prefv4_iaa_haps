...
MemoryTemplate (arf054b128e1r1w0cbbehraa4acw_dfx_wrapper) {

  CellName              : arf054b128e1r1w0cbbehraa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  ...
  Port ( FUNC_WR_DATA_IN_P0[53:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P0[53:0];
    }
  }
...
//----- Start of Redundancy Analysis Segment -------------
  ...
  RedundancyAnalysis { 
    ...
    ColumnSegment(All) {
      ...
      ShiftedIORange : DATA_OUT_P0[53:0] ;
      FuseSet {
        FuseMap[5:0] {
...
} //end MemoryTemplate (arf054b128e1r1w0cbbehraa4acw_dfx_wrapper)