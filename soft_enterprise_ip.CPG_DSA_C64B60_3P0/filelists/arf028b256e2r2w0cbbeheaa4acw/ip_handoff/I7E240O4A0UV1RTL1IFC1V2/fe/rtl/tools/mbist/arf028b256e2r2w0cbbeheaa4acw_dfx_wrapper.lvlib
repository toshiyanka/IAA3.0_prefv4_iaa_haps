...
MemoryTemplate (arf028b256e2r2w0cbbeheaa4acw_dfx_wrapper) {

  CellName              : arf028b256e2r2w0cbbeheaa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  ...
  Port ( FUNC_WR_ADDR_IN_P1[7:0] ) {
    LogicalPort: Write_Ports_1;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_WR_ADDR_IN_P1[7:0];
    }
  }
  ...
  Port ( FUNC_RD_ADDR_IN_P1[7:0] ) {
    LogicalPort: Read_Ports_1;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_RD_ADDR_IN_P1[7:0];
    }
  }
...
} //end MemoryTemplate (arf028b256e2r2w0cbbeheaa4acw_dfx_wrapper)