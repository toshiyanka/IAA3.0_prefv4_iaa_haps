...
MemoryTemplate (arf074b032e1r1w0cbbehsaa4acw_dfx_wrapper) {

  CellName              : arf074b032e1r1w0cbbehsaa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  ...
  Port ( FUNC_WR_DATA_IN_P0[73:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P0[73:0];
    }
  }
...
//----- Start of Redundancy Analysis Segment -------------
  ...
  RedundancyAnalysis { 
    ...
    ColumnSegment(All) {
      ...
      ShiftedIORange : DATA_OUT_P0[73:0] ;
      FuseSet {
        FuseMap[6:0] {
...
} //end MemoryTemplate (arf074b032e1r1w0cbbehsaa4acw_dfx_wrapper)