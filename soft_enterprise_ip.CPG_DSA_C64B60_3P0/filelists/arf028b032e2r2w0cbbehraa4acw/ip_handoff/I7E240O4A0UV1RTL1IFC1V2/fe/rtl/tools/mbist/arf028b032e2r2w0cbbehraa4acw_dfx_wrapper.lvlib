...
MemoryTemplate (arf028b032e2r2w0cbbehraa4acw_dfx_wrapper) {

  CellName              : arf028b032e2r2w0cbbehraa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  ...
  AddressCounter {
    Function (Address) {
      LogicalAddressMap {
        RowAddress[4:0] : Address[4:0];
      }
    }
    Function (RowAddress) {
      CountRange[31:0];  //Encoded Address
    }
  }
  ...
  Port ( FUNC_WR_ADDR_IN_P0[4:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_WR_ADDR_IN_P0[4:0];
    }
  }

  Port ( FUNC_WR_DATA_IN_P0[27:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P0[27:0];
    }
  }
  ...
  Port ( FUNC_WR_ADDR_IN_P1[4:0] ) {
    LogicalPort: Write_Ports_1;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_WR_ADDR_IN_P1[4:0];
    }
  }

  Port ( FUNC_WR_DATA_IN_P1[27:0] ) {
    LogicalPort: Write_Ports_1;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P1[27:0];
    }
  }
  ...
  Port ( FUNC_RD_ADDR_IN_P0[4:0] ) {
    LogicalPort: Read_Ports_0;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_RD_ADDR_IN_P0[4:0];
    }
  }

  Port ( DATA_OUT_P0[27:0] ) {
    LogicalPort: Read_Ports_0;
    Direction:   Output;
    Function:    Data;
  }
  ...
  Port ( FUNC_RD_ADDR_IN_P1[4:0] ) {
    LogicalPort: Read_Ports_1;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_RD_ADDR_IN_P1[4:0];
    }
  }

  Port ( DATA_OUT_P1[27:0] ) {
    LogicalPort: Read_Ports_1;
    Direction:   Output;
    Function:    Data;
  }
...
//----- Start of Redundancy Analysis Segment -------------
  ...
  RedundancyAnalysis { 
    ...
    ColumnSegment(All) {
      ...
      ShiftedIORange : DATA_OUT_P0[27:0] ;
      FuseSet {
        FuseMap[4:0] {
...
} //end MemoryTemplate (arf028b032e2r2w0cbbehraa4acw_dfx_wrapper)