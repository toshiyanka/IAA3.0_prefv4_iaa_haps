...
MemoryTemplate (arf156b040e2r2w0cbbehbaa4acw_dfx_wrapper) {

  CellName              : arf156b040e2r2w0cbbehbaa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  LogicalPorts          : 2R2W;    //2R2W0C
  NumberofWords         : 40;
  NumberofBits          : 156;
  //BitGrouping           : 1;
  ...
  AddressCounter {
    ...
    Function (RowAddress) {
      CountRange[39:0];  //Encoded Address
    }
  }
  ...
  Port ( FUNC_WR_DATA_IN_P0[155:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P0[155:0];
    }
  }
  ...
  Port ( FUNC_WR_CLK_IN_P1 ) {
    LogicalPort: Write_Ports_1;
    Direction:   Input;
    Function:    Clock;
    Polarity:    ActiveHigh;
    EmbeddedTestLogic {
      TestInput: BIST_WR_CLK_IN_P1;
    }
  }

  Port ( FUNC_WR_EN_IN_P1 ) {
    LogicalPort: Write_Ports_1;
    Direction:   Input;
    Function:    WriteEnable;
    DisableDuringScan: Off;
    Polarity:    ActiveHigh;
    EmbeddedTestLogic {
      TestInput: BIST_WR_EN_IN_P1;
    }
  }


  Port ( FUNC_WR_ADDR_IN_P1[5:0] ) {
    LogicalPort: Write_Ports_1;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_WR_ADDR_IN_P1[5:0];
    }
  }

  Port ( FUNC_WR_DATA_IN_P1[155:0] ) {
    LogicalPort: Write_Ports_1;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P1[155:0];
    }
  }

  Port ( WRAPPER_WR_CLK_EN_P1 ) {
    Direction:   Input;
    Function:    None;
    Polarity:    ActiveHigh;
    SafeValue:   1;
  ...
  Port ( FUNC_RD_CLK_IN_P1 ) {
    LogicalPort: Read_Ports_1;
    Direction:   Input;
    Function:    Clock;
    Polarity:    ActiveHigh;
    EmbeddedTestLogic {
      TestInput: BIST_RD_CLK_IN_P1;
    }
  }

  Port ( FUNC_RD_EN_IN_P1 ) {
    LogicalPort: Read_Ports_1;
    Direction:   Input;
    Function:    ReadEnable;
    DisableDuringScan: Off;
    Polarity:    ActiveHigh;
    EmbeddedTestLogic {
      TestInput: BIST_RD_EN_IN_P1;
    }
  }


  Port ( FUNC_RD_ADDR_IN_P1[5:0] ) {
    LogicalPort: Read_Ports_1;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_RD_ADDR_IN_P1[5:0];
    }
  }

  Port ( DATA_OUT_P1[155:0] ) {
    LogicalPort: Read_Ports_1;
    Direction:   Output;
    Function:    Data;
  }

  Port ( OUTPUT_RESET_P1 ) {
    Direction:   Input;
    Function:    None;
    Polarity:    ActiveHigh;
    SafeValue:   0;
...
//----- Start of Redundancy Analysis Segment -------------
  ...
  RedundancyAnalysis { 
    ...
    ColumnSegment(All) {
      ...
      ShiftedIORange : DATA_OUT_P0[155:0] ;
      FuseSet {
        FuseMap[7:0] {
...
} //end MemoryTemplate (arf156b040e2r2w0cbbehbaa4acw_dfx_wrapper)