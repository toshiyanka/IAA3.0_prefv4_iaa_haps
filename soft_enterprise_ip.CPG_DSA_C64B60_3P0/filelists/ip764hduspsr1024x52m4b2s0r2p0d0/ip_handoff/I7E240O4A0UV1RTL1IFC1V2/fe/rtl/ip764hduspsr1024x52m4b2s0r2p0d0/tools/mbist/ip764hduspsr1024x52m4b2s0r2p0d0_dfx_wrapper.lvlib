...
MemoryTemplate (ip764hduspsr1024x52m4b2s0r2p0d0_dfx_wrapper) {
//ArrayRTLHier:  ip764hduspsr1024x52m4b2s0r2p0d0_upf_wrapper.ip764hduspsr1024x52m4b2s0r2p0d0.ip764hduspsr1024x52m4b2s0r2p0d0_bmod.ip764hduspsr1024x52m4b2s0r2p0d0_array.array[Address][BIST_WR_DATA_IN]

        MemoryType                           : SRAM;
        CellName                             : ip764hduspsr1024x52m4b2s0r2p0d0_dfx_wrapper;
        LogicalPorts                         : 1RW;
        ...
        MinHold                              : 0.00;
        MilliWattsPerMegaHertz               : 0.00540;
//       MilliWattsPerMegaHertz   <default>   : 0.22464;

    AddressCounter {
        Function (Address) {
            LogicalAddressMap {
                ColumnAddress[1:0] : Address[1:0] ; // SRAM Column Address
                RowAddress[2:0]    : Address[4:2] ; // SRAM LSB Row Address
                BankAddress[0]     : Address[5] ; // Bank Address
                RowAddress[6:3]    : Address[9:6] ; // SRAM MSB Row Address
            }
        }
...
//----- Start of Logical Port wrapper definition -------------------
    ...
    Port ( FUNC_ADDR_IN[9:0])     { Direction: Input; Function: Address; EmbeddedTestLogic { TestInput: BIST_ADDR_IN[9:0] ; } }
    ...
    Port ( FUNC_WR_DATA_IN[51:0])  { Direction: Input; Function: Data; EmbeddedTestLogic { TestInput: BIST_WR_DATA_IN[51:0] ; } }
    ...
    Port ( DATA_OUT[51:0])         { Direction: Output; Function: Data; }
  ...
  RedundancyAnalysis {
        ...
        ShiftedIORange : DATA_OUT[51:0] ;
          FuseSet {
            FuseMap[5:0] {
              ...
              ShiftedIO(DATA_OUT[39]) : 6'b100111;
              ShiftedIO(DATA_OUT[40]) : 6'b101000;
              ShiftedIO(DATA_OUT[41]) : 6'b101001;
              ShiftedIO(DATA_OUT[42]) : 6'b101010;
              ShiftedIO(DATA_OUT[43]) : 6'b101011;
              ShiftedIO(DATA_OUT[44]) : 6'b101100;
              ShiftedIO(DATA_OUT[45]) : 6'b101101;
              ShiftedIO(DATA_OUT[46]) : 6'b101110;
              ShiftedIO(DATA_OUT[47]) : 6'b101111;
              ShiftedIO(DATA_OUT[48]) : 6'b110000;
              ShiftedIO(DATA_OUT[49]) : 6'b110001;
              ShiftedIO(DATA_OUT[50]) : 6'b110010;
              ShiftedIO(DATA_OUT[51]) : 6'b110011;
    ...
    RowSegment (ALL) {
      NumberOfSpareElements : 2;
        FuseSet {
          Fuse[0] : AddressPort(FUNC_ADDR_IN[2]);
          Fuse[1] : AddressPort(FUNC_ADDR_IN[3]);
          Fuse[2] : AddressPort(FUNC_ADDR_IN[4]);
          Fuse[3] : AddressPort(FUNC_ADDR_IN[5]);
          Fuse[4] : AddressPort(FUNC_ADDR_IN[6]);
          Fuse[5] : AddressPort(FUNC_ADDR_IN[7]);
          Fuse[6] : AddressPort(FUNC_ADDR_IN[8]);
          Fuse[7] : AddressPort(FUNC_ADDR_IN[9]);
        }
        PinMap  {
          SpareElement {
