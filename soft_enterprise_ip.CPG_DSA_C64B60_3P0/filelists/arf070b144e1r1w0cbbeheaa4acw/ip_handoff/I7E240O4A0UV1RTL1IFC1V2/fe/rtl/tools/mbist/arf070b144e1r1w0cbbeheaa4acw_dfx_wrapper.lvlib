...
MemoryTemplate (arf070b144e1r1w0cbbeheaa4acw_dfx_wrapper) {

  CellName              : arf070b144e1r1w0cbbeheaa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  ...
  AddressCounter {
    ...
    Function (RowAddress) {
      CountRange[143:0];  //Encoded Address
    }
  }
  ...
  Port ( FUNC_WR_DATA_IN_P0[69:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P0[69:0];
    }
  }
...
//----- Start of Redundancy Analysis Segment -------------
  ...
  RedundancyAnalysis { 
    ...
    ColumnSegment(All) {
      ...
      ShiftedIORange : DATA_OUT_P0[69:0] ;
      FuseSet {
        FuseMap[6:0] {
...
} //end MemoryTemplate (arf070b144e1r1w0cbbeheaa4acw_dfx_wrapper)