...
MemoryTemplate (arf066b128e2r1w0cbbehsaa4acw_dfx_wrapper) {

  CellName              : arf066b128e2r1w0cbbehsaa4acw_dfx_wrapper;
  MemoryType            : SRAM;
  LogicalPorts          : 2R1W;    //2R1W0C
  NumberofWords         : 128;
  NumberofBits          : 66;
  //BitGrouping           : 1;
  ...
  Port ( FUNC_WR_DATA_IN_P0[65:0] ) {
    LogicalPort: Write_Ports_0;
    Direction:   Input;
    Function:    Data;
    EmbeddedTestLogic {
      TestInput: BIST_WR_DATA_IN_P0[65:0];
    }
  }
  ...
  Port ( FUNC_RD_ADDR_IN_P1[6:0] ) {
    LogicalPort: Read_Ports_1;
    Direction:   Input;
    Function:    Address;
    EmbeddedTestLogic {
      TestInput: BIST_RD_ADDR_IN_P1[6:0];
    }
  }

  Port ( DATA_OUT_P1[65:0] ) {
    LogicalPort: Read_Ports_1;
    Direction:   Output;
    Function:    Data;
  }
...
//----- Start of Redundancy Analysis Segment -------------
  ...
  RedundancyAnalysis { 
    ...
    ColumnSegment(All) {
      ...
      ShiftedIORange : DATA_OUT_P0[65:0] ;
      FuseSet {
        FuseMap[6:0] {
...
} //end MemoryTemplate (arf066b128e2r1w0cbbehsaa4acw_dfx_wrapper)