...
##ADD DCP#
source -notrace $env(FPGA_ROOT)/cfg/vivado/dcp_files.tcl

#dalabuns - vivado 2017 and onward use whitebox IP integration.
read_ip $env(UHFI_ROOT)/subIP/pcie_ctrl/source/rtl/plda_bridge/phy/vivado/xcvu440/xcvu440_pcie_phy/xcvu440_pcie_phy.xci 
...
# @dalabuns
eval phys_opt_design $phys_opt_design_flags
