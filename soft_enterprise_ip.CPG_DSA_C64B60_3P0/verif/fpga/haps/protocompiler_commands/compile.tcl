...
#ANK if {[catch { run compile -ucdb vcs_output.db -srclist $env(WORKAREA)/verif/fpga/edif_list.f -src $env(WORKAREA)/subip/sip/fpga/cfg/vivado/xcvu440_pcie_phy/xcvu440_pcie_phy.edf -out compile} err ]} {
