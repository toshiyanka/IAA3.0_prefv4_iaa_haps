...
### $Header: //synplicity/ui201809pcost/misc/run_vivado_haps_template.tcl#2 $
### End History
################################################# 
puts "Script version is \$Header: //synplicity/ui201809pcost/misc/run_vivado_haps_template.tcl#2 $"
#################################################
###     SET DESIGN VARIABLES      ###
#################################################
set DesignName  	"mb1_uA"
set FamilyName  	"VIRTEX UltraScale FPGAs"
set DeviceName  	"XCVU440"
set PackageName 	"FLGA2892"
set SpeedGrade  	"-1-c"
set TopModule   	"mb1_uA"
set PartName    	"XCVU440-FLGA2892-1-c"
set DcpFile			""
set VivadoOptionFiles ""
set InputMode   	"EDIF"
set Flow   			"Standard" ;# Flow can be set to "Incremental" or "Standard"
set StrategyMode	"custom_run"
#ANK  set StrategyMode	"default"
...
switch -- $StrategyMode {
	"custom_run" {
    set opt_design_flags      "-directive Default"
##DAL##		set opt_design_flags      "-directive Explore"
    set place_design_flags    "-directive SSI_SpreadLogic_high"
##DAL##		set place_design_flags    "-directive Explore"
    set route_design_flags    "-directive AlternateCLBRouting"
##DAL##		set route_design_flags    "-directive AggressiveExplore"
		set phys_opt_design_flags "-directive AggressiveExplore"
	}
	"fast_turn_around" {
        ...
        default {
                set opt_design_flags    "-directive Default"
                set place_design_flags  "-directive Default"
                set route_design_flags  "-directive Default"
	}
}
...
catch {set_property SEVERITY {Warning} [get_drc_checks INBB-3]}

##Vishal Added for combinatatorial loops found in following nets
##DAL##catch {set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets dino/pardinomisc/sapmas0_wrapper/sapmas0/sapmas_pgd/pma_pmrc_logic/pma_haltclk_cfn/un1_SyncCnttoRiseGnnnH_lut6_2_O6[0]]}
##DAL##catch {set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets dino/pardinomisc/sapmas0_wrapper/sapmas0/sapmas_pgd/pma_pmrc_logic/pma_haltclk_cfn/un8_SyncCnttoRiseGnnnH_cry_3_RNO_2_lut6_2_O5]}
...
if {${InputMode} == "EDIF"} {
	...
	if {[file exists ${DesignName}_edif.xdc]} {
		...
		read_xdc /nfs/site/disks/xne_sv_0001/ankitdh/iaa_haps_uv4/verif/fpga/haps/vivado/extra_constraints_mb1_uA.xdc
	}
...
##ADD DCP#
#ANK  source -notrace $env(FPGA_ROOT)/cfg/vivado/dcp_files.tcl
source -notrace /nfs/site/disks/xne_sv_0001/ankitdh/iaa_haps/soft_enterprise_ip.CPG_DSA_C64B60_3P0/subIP/fpga/cfg/vivado/dcp_files.tcl

#dalabuns - vivado 2017 and onward use whitebox IP integration.
#ANK read_ip $env(UHFI_ROOT)/subIP/pcie_ctrl/source/rtl/plda_bridge/phy/vivado/xcvu440/xcvu440_pcie_phy/xcvu440_pcie_phy.xci 
read_ip /nfs/site/disks/xne_sv_0001/ankitdh/iaa_haps/soft_enterprise_ip.CPG_DSA_C64B60_3P0/subIP/UHFI_v4.13.0/subIP/pcie_ctrl/source/rtl/plda_bridge/phy/vivado/xcvu440/xcvu440_pcie_phy/xcvu440_pcie_phy.xci
...
##DAL-NO-DCP## write_checkpoint -force post_place.dcp

# @dalabuns
#ANK chk with SNPS eval phys_opt_design $phys_opt_design_flags
