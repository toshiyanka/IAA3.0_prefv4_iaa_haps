...
#ANK UV# congestion set StrategyMode	"custom"
...
set generateBackAnnotationFiles "1"

if [ info exists ::env(VIVADO_DISABLE_BACK_ANNOTATION_FILES) ] {
    set generateBackAnnotationFiles "0"
}
if [ info exists ::env(VIVADO_ENABLE_BACK_ANNOTATION_FILES) ] {
    set generateBackAnnotationFiles "1"
}
...
if { (${DeviceName} == "XCVU19P") && (${DisableSLLTDM} !="1") } {
    set SllOptVivadoEnable "1"
}
if [ info exists ::env(VIVADO_SLL_TDM_DISABLE) ] {
    set SllOptVivadoEnable "0"
}
...
#TG Strategy mode used in vivado_pc_flags to set directives, sourced below
#TG switch -- $StrategyMode {
#TG     "timing_qor" {
#TG         set opt_design_flags    "-directive Explore"
#TG         set place_design_flags  "-directive Explore"
#TG         set route_design_flags  "-directive Explore"
#TG     }
#TG     "fast_turn_around" {
#TG         set opt_design_flags    "-directive RuntimeOptimized"
#TG         set place_design_flags  "-directive RuntimeOptimized"
#TG         set route_design_flags  "-directive RuntimeOptimized"
#TG     }
#TG     "custom_run" {
#TG         set opt_design_flags    "custom_opt_design_flags"
#TG         set place_design_flags  "custom_place_design_flags"
#TG         set route_design_flags  "custom_route_design_flags"
#TG     }
#TG     default {
#TG         set opt_design_flags    ""
#TG         set place_design_flags  ""
#TG         set route_design_flags  ""
#TG     }
#TG }
...
source -notrace $env(WORKAREA)/verif/fpga/haps/vivado/vivado_pc_flags.tcl
source -notrace ./vivado_pc_env.tcl
source -notrace $env(WORKAREA)/verif/fpga/haps/vivado/vivado_pc_procs.tcl
global env
#global VivadoOptionFiles
