...
setenv OUTPUT_DIR /nfs/site/disks/ncsg_00170/users/jkerth/hqm-srvrgen4/output/hqm/collage//hqm_AW_or2 
setenv PASS  
setenv TOP_MODULE hqm_AW_or2 
setenv DUT hqm 
...
cd $COLLAGE_WORK; 
$CORE_TOOLS_DIR/$CORE_TOOLS_VER/bin/coreBuilder -timeout 10 -shell -no_home_init -x "source $COLLAGE_ROOT/core/common/tcl/collage_init.tcl" -f /nfs/site/disks/ncsg_00170/users/jkerth/hqm-srvrgen4/integration/collage/script/builder.hqm_AW_or2.tcl
