...
hqm_respect_pragma $::env(WORKAREA)/subip/sip/hqm_memory_solution/src/rtl/hqm_list_sel_mem.sv $hqm_respect_pragma_dir/hqm_list_sel_mem.sv
...
set ::collage_ip_info::ip_name "hqm_list_sel_mem"
set ::collage_ip_info::ip_top_module_name "hqm_list_sel_mem"
...
set ::collage_ip_info::ip_input_files "\
    ...
    $hqm_respect_pragma_dir/hqm_list_sel_mem.sv \
"
