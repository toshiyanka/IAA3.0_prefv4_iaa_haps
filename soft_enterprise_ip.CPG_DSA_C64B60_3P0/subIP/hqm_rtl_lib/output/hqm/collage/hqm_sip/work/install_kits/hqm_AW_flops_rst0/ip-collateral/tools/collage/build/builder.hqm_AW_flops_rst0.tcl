...
set ::collage_ip_info::ip_name "hqm_AW_flops_rst0"
set ::collage_ip_info::ip_top_module_name "hqm_AW_flops_rst0"
set ::collage_ip_info::ip_version "0.0"
set ::collage_ip_info::ip_intent_sp ""
set ::collage_ip_info::ip_input_files "$::env(WORKAREA)/subIP/sip/AW/src/rtl/hqm_AW_pkg.sv $::env(WORKAREA)/subIP/sip/AW/src/rtl/hqm_AW_flops_rst0.sv"
#set ::collage_ip_info::ip_input_files "$::env(WORKAREA)/subIP/sip/AW/src/rtl/hqm_AW_flops_rst0.sv"
