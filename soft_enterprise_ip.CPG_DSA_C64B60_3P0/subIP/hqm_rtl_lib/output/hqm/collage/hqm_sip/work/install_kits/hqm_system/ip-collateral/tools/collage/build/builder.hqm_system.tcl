...
hqm_respect_pragma $::env(WORKAREA)/src/rtl/system/hqm_system.sv $hqm_respect_pragma_dir/hqm_system.sv
...
set ::collage_ip_info::ip_name "hqm_system"
set ::collage_ip_info::ip_top_module_name "hqm_system"
...
set ::collage_ip_info::ip_input_files "\
    ...
    $hqm_respect_pragma_dir/hqm_system.sv \
"
set ::collage_ip_info::ip_input_language SystemVerilog
set ::collage_ip_info::ip_rtl_inc_dirs "$::env(WORKAREA)/src/rtl $::env(WORKAREA)/src/rtl/system"
