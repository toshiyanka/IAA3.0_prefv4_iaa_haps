...
hqm_respect_pragma $::env(WORKAREA)/src/rtl/hqm_list_sel_pipe.sv $hqm_respect_pragma_dir/hqm_list_sel_pipe.sv
...
set ::collage_ip_info::ip_name "hqm_list_sel_pipe"
set ::collage_ip_info::ip_top_module_name "hqm_list_sel_pipe"
...
set ::collage_ip_info::ip_input_files "\
    ...
    $hqm_respect_pragma_dir/hqm_list_sel_pipe.sv \
"
