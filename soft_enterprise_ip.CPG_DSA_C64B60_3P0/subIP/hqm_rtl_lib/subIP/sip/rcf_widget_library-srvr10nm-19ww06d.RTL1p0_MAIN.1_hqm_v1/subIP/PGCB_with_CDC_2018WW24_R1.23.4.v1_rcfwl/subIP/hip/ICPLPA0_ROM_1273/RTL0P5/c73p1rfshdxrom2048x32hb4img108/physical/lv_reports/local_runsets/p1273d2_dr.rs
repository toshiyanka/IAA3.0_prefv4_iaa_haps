// $Header: /ds/data/2647/server_vault/Projects/drwork/x12dev_drwork/rst/x12dev_drwork_rst/PXL/1273/p1273d2_dr.rs.rca 1.15 Fri Oct  3 19:40:37 2014 dgthakur Experimental $ 
// $Log: p1273d2_dr.rs.rca $
// 
//  Revision: 1.15 Fri Oct  3 19:40:37 2014 dgthakur
//  updated for rev1.0 rules. 

#ifndef _P1273d2_DR_RS_
   #define _P1273d2_DR_RS_
   ...
   TV1_32:double = 30; // TV1A length, fixed value, drawn
   TV1_400:double = 0; // TV1SIZEID layer (80;97) must be drawn line-on-line with EOA.  (This will be checked when DR_FULL_DIE is set to YES)
   TV1_432:double = 25; // TV1A length, fixed value, after synthesized downsizing
   ...
   drHash:typeHashString2String = { 
      ...
      xc(TV1_32) => "TV1A length, fixed value, drawn",
      xc(TV1_400) => "TV1SIZEID layer (80;97) must be drawn line-on-line with EOA.  (This will be checked when DR_FULL_DIE is set to YES)",
      xc(TV1_432) => "TV1A length, fixed value, after synthesized downsizing",
   ...
   Error_TV1_400 = empty_violation();
   drErrHash[xc(TV1_400)] = Error_TV1_400;
   Error_TV1_432 = empty_violation();
   drErrHash[xc(TV1_432)] = Error_TV1_432;
