...
sub generate_lintra_report{
    ...
    if (-e $file_name) {
       ...
       print  "LINTRA Not successfully completed. \n";
    }
    #close $parfile;
}
...
sub generate_cdc_report {
    ...
    print $file_name."\n";
    #open (my $parfile,"> summary_cdc.rpt") or warn "$!\n";
    my $i=0;
    my $start="";
    print  "================================================================================ \n";
    print  "CDC SUMMARY.\n";
    ...
    open(FILE,"<$file_name"); #open the file
       ...
       print "CDC is not completed successfully. \n";
    }
    #close $parfile;
}
