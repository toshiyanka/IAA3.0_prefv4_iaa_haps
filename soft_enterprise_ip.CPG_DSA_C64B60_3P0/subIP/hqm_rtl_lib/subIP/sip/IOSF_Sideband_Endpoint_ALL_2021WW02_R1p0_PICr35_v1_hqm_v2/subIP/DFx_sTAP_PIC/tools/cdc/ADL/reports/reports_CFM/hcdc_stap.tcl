...
# Created: Thu Nov  1 08:18:27 2018
####################################################################################################

# INPUT PORTS

# hier clock { fdfx_earlyboot_exit }  -group { grp_policy_update } -module { stap }
# hier clock { fdfx_policy_update }  -group { grp_policy_update } -module { stap }
# hier port domain { fdfx_powergood } -sync -combo_logic -module { stap }
# hier reset { fdfx_powergood } -active_low -sync -module { stap }
# hier stable { fdfx_secure_policy } -module { stap }
# hier port domain { ftap_pwrdomain_rst_b } -ignore -module { stap }
# hier stable { ftap_slvidcode } -module { stap }
# hier clock { ftap_tck }  -group { grp_ftap_tck } -module { stap }
# hier port domain { ftap_tdi } -clock { ftap_tck } -combo_logic -module { stap }
# hier port domain { ftap_tms } -clock { ftap_tck } -combo_logic -module { stap }
# hier port domain { ftap_trst_b } -clock { ftap_tck } -combo_logic -module { stap }
...
# hier port domain { stap_isol_en_b } -ignore -module { stap }
