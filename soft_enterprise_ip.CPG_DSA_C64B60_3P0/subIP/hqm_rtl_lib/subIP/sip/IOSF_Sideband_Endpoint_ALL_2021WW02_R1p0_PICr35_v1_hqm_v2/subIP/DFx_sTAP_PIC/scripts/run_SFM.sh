...
mutt -s "STAP : SFM summary" -a $SYN_ATTACH_CSV_PATH pavan.n.m@intel.com ramamohanx.v@intel.com krishnadas.b.bhagwat@intel.com shivaprashant.bulusu@intel.com mohanx.k.gangadharappa@intel.com < ${SFM_PATH}/qa/summary.rpt
