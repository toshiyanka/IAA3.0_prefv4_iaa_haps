...
set SCALE_FACTOR 1.33 

#STAP Primary Clock
set TAP_CLK ftap_tck
set TAP_FREQ 100 
set ftap_tck_period     [expr $G_NS / ($TAP_FREQ*$SCALE_FACTOR)]
...
set TAP_SLV_FREQ 100 
set ftapsslv_tck_period     [expr $G_NS / ($TAP_SLV_FREQ*$SCALE_FACTOR)]
