package trunk_clock_switch_final_cfg;
use ToolConfig;
...
$dc_cfg = {-owner => ['prbhatt'],
	...
	-project_settings_override => "$ENV{MODEL_ROOT}/tools/febe/inputs/common/trunk_clock_switch_dc_config.cfg",       
    -rm_search => [],
    -files_first => [],
    -files => [],
    -rm_files => [], 
    ...
    -add_ctech_files => [#"/nfs/pdx/disks/srvr10nm_0041/brownmic/lib_work/CTECH_OVERRIDES/source/p1274/ec0/ln/ctech_lib_msff_async_rst_meta.v",
                       ...
                       #" $ENV{MODEL_ROOT}/subIP/v15ww03e/source/p1274/ec0/ln/ctech_lib_or2.v",
                       #" $ENV{MODEL_ROOT}/subIP/v15ww03e/source/p1274/ec0/ln/ctech_lib_and2.v",
                       #"$ENV{MODEL_ROOT}/subIP/v15ww03e/source/p1274/ec0/ln/ctech_lib_doublesync_rst.v",
                         #"$ENV{MODEL_ROOT}/subIP/v15ww03e/source/p1274/ec0/ln/ctech_lib_clk_and.v",
                         #&ToolConfig::ToolConfig_get_tool_path("ipconfig/ctech_exp")."/source/p1274/ec0/ln/ctech_lib_rcb_and.sv",
			 ],
