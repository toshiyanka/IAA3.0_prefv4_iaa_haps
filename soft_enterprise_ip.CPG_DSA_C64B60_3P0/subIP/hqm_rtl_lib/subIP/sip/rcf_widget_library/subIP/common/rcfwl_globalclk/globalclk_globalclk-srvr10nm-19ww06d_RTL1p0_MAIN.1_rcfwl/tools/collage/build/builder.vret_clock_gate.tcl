...
set ::collage_ip_info::ip_name "vret_clock_gate"
set ::collage_ip_info::ip_top_module_name "rcfwl_gclk_vret_clock_gate"
...
set ::collage_ip_info::ip_input_files $::env(MODEL_ROOT)/src/rtl/clkdist/rcfwl_gclk_vret_clock_gate.sv

set ::collage_ip_info::ip_plugin_dir "" ; # Directories - space separated list - with tcl plugin files
set ::collage_ip_info::ip_ifc_def_hook "vret_clock_gate_create_ifc_instances" ; # Set this to procedure to add IP interfaces - defined below

######################################################################
# Procedure to create IP interfaces
######################################################################
proc vret_clock_gate_create_ifc_instances {} {
