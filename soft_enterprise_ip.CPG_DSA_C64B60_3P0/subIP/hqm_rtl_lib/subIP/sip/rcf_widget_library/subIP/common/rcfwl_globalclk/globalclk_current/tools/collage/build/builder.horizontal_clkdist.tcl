...
set ::collage_ip_info::ip_name "gclk_horizontal_clkdist"
set ::collage_ip_info::ip_top_module_name "rcfwl_gclk_horizontal_clkdist"
...
set ::collage_ip_info::ip_input_files $::env(MODEL_ROOT)/src/rtl/clkdist/rcfwl_gclk_horizontal_clkdist.sv

set ::collage_ip_info::ip_plugin_dir "" ; # Directories - space separated list - with tcl plugin files
set ::collage_ip_info::ip_ifc_def_hook "horizontal_clkdist_create_ifc_instances" ; # Set this to procedure to add IP interfaces - defined below

######################################################################
# Procedure to create IP interfaces
######################################################################
proc horizontal_clkdist_create_ifc_instances {} {
