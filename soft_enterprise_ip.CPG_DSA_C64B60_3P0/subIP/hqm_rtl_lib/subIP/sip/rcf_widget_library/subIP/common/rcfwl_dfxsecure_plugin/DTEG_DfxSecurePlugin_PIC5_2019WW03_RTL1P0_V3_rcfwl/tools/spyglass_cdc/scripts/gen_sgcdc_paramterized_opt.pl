...
chomp ($work_dir);
my $file_name = "$work_dir/verif/tests/spyglasscdc/dfxsecure_plugin/dfxsecure_plugin.opt";        # input uniquified opt file for reading
my $file_name1 = "$work_dir/scripts/ip_override_sgcdc_params.txt";                            # ip_override_sgcdc_params.txt for reading
my $file_name2 = "$work_dir/verif/tests/spyglasscdc/dfxsecure_plugin/dfxsecure_plugin_new.opt";   # output file  
