// $Header: /ds/data/2647/server_vault/Projects/drwork/x12dev_drwork/rst/x12dev_drwork_rst/PXL/1273/p1273d5_dr.rs.rca 1.24 Fri Oct  3 19:40:39 2014 dgthakur Experimental $ 
// $Log: p1273d5_dr.rs.rca $
// 
//  Revision: 1.24 Fri Oct  3 19:40:39 2014 dgthakur
//  updated for rev1.0 rules. 

#ifndef _P1273d5_DR_RS_
   #define _P1273d5_DR_RS_
   ...
   APC_42:double = 0.054; // Polycon end overlap of poly for PC_41
   APC_44:double = 0.016; // Polycon end space to poly side
   ...
   APL_11:double = 0.045; // Poly endcap length
   ...
   APL_25:double = 0.078; // Poly end space to diffusion PGD
   ...
   BLDI_102:double = 10.4; // Max allowed INTERMEDIATE Exposed N-diffusion density (%), within a 245um x 245um window size (RF X73Aonly)
   ...
   BLD_433:double = 58.4; // Max allowed local N + P diffusion density (%), 24.5um x 24.5um window size (HPC)
   ...
   BNW_28:double = 9.7; // P1273 NW_28 relaxation for sram
   BNW_29:double = 9.6; // P1273 NW_29 relaxation for sram
   ...
   BU_04:double = 157; // Bump to Bump separation core region (center-to-center, maximum)***
   BU_21:double = 750; // Width of outer ring from EOA that requires additional rules
   ...
   CDW_105:double = 2.1; // Window for CD_105
   ...
   CDW_205:double = 3.15; // Window for CD_205
   ...
   CD_105:double = 40; // Minimum concentrated local Metal 5 density (%), within a 2.1um x 2.1um window size
   ...
   CD_205:double = 78; // Maximum concentrated local Metal 5 density (%), within a 3.15um x 3.15um window size
   ...
   DA_03:double = 0.042; // Any transition regions to transition region space OGD
   ...
   DA_31:double = 0; // Poly fixed layout comparison for Digital-to-TGULV Transition Ring
   ...
   DC_05:double = 0.336; // Max allowed space between any Diffcon or Polycon edges, in the smaller of either direction
   ...
   DC_23:double = 0.112; // Minimum space on both sides of the isolated diffcon
   DC_24:double = 0.056; // Minimum space from atleast one end of the isolated diffcon
   ...
   DF_56:double = 0; // Tap PGD/OGD edges must follow standard diffusion rules
   DF_80:double = 0; // Every diffusion should have a TCN
   DF_84:double = 0.084; // Tap to Transistor diffusion space PGD (within same well)
   DG_01:double = 0.028; // Diffusion check grid width (fixed value)
   DG_02:double = 0.056; // Diffusion check grid space (fixed value)
   DG_03:double = 1.75; // Minimum Diffusion check grid length
   ...
   DN_01:double = 0.56; // DN_01 deep n-well width 
   DN_02:double = 1.47; // DN_02 deep n-well space 
   DN_03:double = 0.14; // DN_03 deep n-well overlap of n-well 
   DN_04:double = 0.56; // DN_04 extension of n-well beyond deep n-well 
   DN_05:double = 0.7; // DN_05 deep n-well space to n-well outside 
   DN_07:double = 0.174; // DN_07 deep n-well enclosure of p-gates 
   DN_08:double = 0.174; // DN_08 deep n-well space to p-gates outside the deep nwell 
   DN_09:double = 1.16; // DN_09 deep n-well space to BJTID, CAPID or wellResID 
   DN_10:double = 0; // DN_10 The isolated pwell inside the deep nwell must have a pwell tap (ptap) 
   DN_11:double = 4.2; // DN_11 Max distance from N+ active diff inside DNW to a ptap connected to Vss 
   DN_12:double = 4.2; // DN_12 Max distance from N+ active diff (inside DNW) to ntap in nwell (connected to DNW) connected to Vcc* 
   DN_13:double = 0.7; // DN_13 deep n-well space to diffusions outside (active or tap) 
   ...
   DT_03:double = 0.042; // Any transition regions to transition region space OGD
   ...
   DT_31:double = 0; // Poly fixed layout comparison for Digital-to-TG Transition Ring
   ...
   DX_03:double = 0.042; // Any transition regions to transition region space OGD
   ...
   DX_31:double = 0; // Poly fixed layout comparison for Digital-to-ULP Transition Ring
   ...
   EA_01:double = 1.512; // Edge-of-Active (EOA) PGD length must be a whole multiple of
   EA_02:double = 4.2; // Edge-of-Active (EOA) OGD length must be a whole multiple of
   ...
   EHV_01:double = 0.032; // Polycon space to Diffcon
   EHV_02:double = 0.032; // VCN space to Diffcon (PGD)
   EHV_04:double = 0.032; // VCN space to polycon (PGD)
   ...
   EHV_23:double = 0.032; // Via3-Via4 space (min)
   EHV_24:double = 0.026; // Via4-Metal4 space (min)
   ...
   ENW_14:double = 0.36; // N-well space
   ENW_21:double = 0.12; // N+ active diffusion space to extra high voltage nwells
   ENW_22:double = 0.12; // P+ active diffusion enclosure by extra high voltage nwell
   ...
   FM_292:double = 1750; // Maximum floating metal area for MT5  MT0 network  (sq um)
   ...
   FM_298:double = 3625; // Maximum floating metal area for MT11 - MT0 network  (sq um)
   ...
   FM_51:double = 1011; // Maximum area of floating MT5 with zero facing edge component  (sq um)
   FM_52:double = 1177; // Max length of floating MT5 edge facing a Vss MT5 edge within 2Xmin spacing
   FM_53:double = 98; // Maximum area of floating MT5 with non-zero facing edge component  (sq um)
   ...
   GD_105:double = 44; // Minimum Global Metal 5 Layer density (%)
   ...
   GD_110:double = 50; // Minimum Global Metal 10 Layer density (%)
   GD_111:double = 50; // Minimum Global Metal 11 Layer density (%)
   ...
   GD_205:double = 69; // Max Global Metal 5 layer density (%)
   ...
   GD_210:double = 80; // Max Global Metal 10 layer density (%)
   GD_211:double = 80; // Max Global Metal 11 layer density (%)
   ...
   HNW_14:double = 0.22; // N-well space
   HNW_21:double = 0.06; // N+ active diffusion space to high voltage nwells
   HNW_22:double = 0.06; // P+ active diffusion enclosure by high voltage nwell
   HV_01:double = 0.03; // Polycon space to Diffcon
   HV_02:double = 0.03; // VCN space to Diffcon (PGD)
   HV_04:double = 0.03; // VCN space to polycon (PGD)
   ...
   HV_23:double = 0.03; // Via3-Via4 space (min)
   ...
   IPDW_111:double = 3300; // Limit Ratio of Metal area (on the PMOS source) to N-discharge-transistor Ze  (um^2 /um) in isolated pwell
   IPDW_191:double = 8; // Limit Ratio of Metal or GCN+TCN area to logic/SRAM N-transistor Drain Ze (um^2 /um) no sub-tap
   IPDW_193:double = 3.5; // Limit Ratio of TM1 area to logic/SRAM N-transistor Drain Ze (um^2 /um) no sub-tap
   IPDW_201:double = 0; // Limit Ratio of Metal or GCN+TCNarea to nom N-transistor Ze   (um^2 /um)
   IPDW_391:double = 800; // Limit Ratio of Metal area to TG N-transistor Drain Ze (um^2 /um) no sub-tap
   IPDW_395:double = 0; // Limit Ratio of Metal area to n-transistor (TG-gNAC) Ze, for TG n-transistor protection  (um)
   IPDW_611:double = 800; // Limit Ratio of Metal area (on the PMOS source) to TG N-discharge-transistor Ze  (um^2 /um) in isolated pwell
   IPD_00:double = 14200; // GCN+TCN (Polycon+Diffcon)
   IPD_01:double = 14200; // Metal-0
   IPD_02:double = 14200; // Metal-1
   IPD_03:double = 14200; // Metal-2
   IPD_04:double = 14200; // Metal-3
   IPD_05:double = 14200; // Metal-4
   IPD_06:double = 14200; // Metal-5
   IPD_07:double = 14200; // Metal-6
   IPD_08:double = 14200; // Metal-7
   IPD_09:double = 14200; // Metal-8
   IPD_10:double = 14200; // Metal-9
   IPD_100:double = 14200; // GCN+TCN (Polycon+Diffcon)
   IPD_101:double = 14200; // Metal-0
   IPD_102:double = 14200; // Metal-1
   IPD_103:double = 14200; // Metal-2
   IPD_104:double = 14200; // Metal-3
   IPD_105:double = 14200; // Metal-4
   IPD_106:double = 14200; // Metal-5
   IPD_107:double = 14200; // Metal-6
   IPD_108:double = 14200; // Metal-7
   IPD_109:double = 14200; // Metal-8
   IPD_11:double = 14200; // Metal-10
   IPD_110:double = 14200; // Metal-9
   IPD_111:double = 14200; // Metal-10
   IPD_112:double = 14200; // Metal-11
   IPD_113:double = 14200; // TM1
   IPD_12:double = 14200; // Metal-11
   IPD_13:double = 14200; // TM1
   IPD_200:double = 50; // ViaCN
   IPD_201:double = 50; // Via0
   IPD_202:double = 50; // Via1 
   IPD_203:double = 50; // Via2 
   IPD_204:double = 50; // Via3 
   IPD_205:double = 50; // Via4 (non vcc nodes)
   IPD_206:double = 50; // Via5 (non vcc nodes)
   IPD_207:double = 50; // Via6 (non vcc nodes)
   IPD_208:double = 50; // Via7 (non vcc nodes)
   IPD_209:double = 50; // Via8 (non vcc nodes)
   IPD_210:double = 50; // Via9 (non vcc nodes)
   IPD_211:double = 50; // Via10 (non vcc nodes)
   IPD_212:double = 50; // Via11 (non vcc nodes)
   IPD_300:double = 50; // ViaCN
   IPD_301:double = 50; // Via0
   IPD_302:double = 50; // Via1 
   IPD_303:double = 50; // Via2 
   IPD_304:double = 50; // Via3 
   IPD_305:double = 50; // Via4 (non vcc nodes)
   IPD_306:double = 50; // Via5 (non vcc nodes)
   IPD_307:double = 50; // Via6 (non vcc nodes)
   IPD_308:double = 50; // Via7 (non vcc nodes)
   IPD_309:double = 50; // Via8 (non vcc nodes)
   IPD_310:double = 50; // Via9 (non vcc nodes)
   IPD_311:double = 50; // Via10 (non vcc nodes)
   IPD_312:double = 50; // Via11 (non vcc nodes)
   IPD_405:double = 1000; // Via4 (vcc nodes)
   IPD_406:double = 1000; // Via5 (vcc nodes)
   IPD_407:double = 1000; // Via6 (vcc nodes)
   IPD_408:double = 1000; // Via7 (vcc nodes)
   IPD_409:double = 1000; // Via8 (vcc nodes)
   IPD_410:double = 1000; // Via9 (vcc nodes)
   IPD_411:double = 1000; // Via10 (vcc nodes)
   IPD_412:double = 1000; // Via11 (vcc nodes)
   IPD_505:double = 1000; // Via4 (vcc nodes)
   IPD_506:double = 1000; // Via5 (vcc nodes)
   IPD_507:double = 1000; // Via6 (vcc nodes)
   IPD_508:double = 1000; // Via7 (vcc nodes)
   IPD_509:double = 1000; // Via8 (vcc nodes)
   IPD_510:double = 1000; // Via9 (vcc nodes)
   IPD_511:double = 1000; // Via10 (vcc nodes)
   IPD_512:double = 1000; // Via11 (vcc nodes)
   ...
   IPG_01:double = 3500; // Limit Ratio of Metal or GCN+TCNarea to uv1/uv2/nal N-transistors
   ...
   IPG_04:double = 2800; // Limit Ratio of Metal or GCN+TCNarea to uv1/uv2/nal inverter with sub-tap Ze (smaller of N/P Z)  (um^2 /um)
   IPG_05:double = 40; // Limit Ratio of Metal area to nwell area  (um^2 /um^2).
   ...
   IPG_301:double = 350; // Limit Ratio of TV1 area to uv1/uv2/nal N-transistors
   ...
   IPG_304:double = 280; // Limit Ratio of TV1 area to uv1/uv2/nal inverter with sub-tap Ze (smaller of N/P Z)  (um^2 /um)
   IPG_305:double = 4; // Limit Ratio of TV1 area to nwell area  (um^2 /um^2)
   ...
   IPN_01:double = 280; // Metal-0
   IPN_02:double = 280; // Metal-1
   IPN_03:double = 280; // Metal-2
   IPN_04:double = 280; // Metal-3
   IPN_05:double = 280; // Metal-4
   IPN_06:double = 280; // Metal-5
   IPN_07:double = 280; // Metal-6
   IPN_08:double = 280; // Metal-7
   IPN_09:double = 280; // Metal-8
   IPN_10:double = 280; // Metal-9
   IPN_100:double = 42; // GCN+TCN (Polycon+Diffcon)
   IPN_101:double = 170; // Metal-0
   IPN_102:double = 170; // Metal-1
   IPN_103:double = 170; // Metal-2
   IPN_104:double = 170; // Metal-3
   IPN_105:double = 170; // Metal-4
   IPN_106:double = 170; // Metal-5
   IPN_107:double = 170; // Metal-6
   IPN_108:double = 170; // Metal-7
   IPN_109:double = 170; // Metal-8
   IPN_11:double = 112; // Metal-10
   IPN_110:double = 170; // Metal-9
   IPN_111:double = 55; // Metal-10
   IPN_112:double = 55; // Metal-11
   IPN_113:double = 0; // TM1
   IPN_12:double = 112; // Metal-11
   IPN_13:double = 0; // TM1
   IPN_200:double = 140; // GCN+TCN (Polycon+Diffcon)
   IPN_201:double = 570; // Metal-0
   IPN_202:double = 570; // Metal-1
   IPN_203:double = 570; // Metal-2
   IPN_204:double = 570; // Metal-3
   IPN_205:double = 570; // Metal-4
   IPN_206:double = 570; // Metal-5
   IPN_207:double = 570; // Metal-6
   IPN_208:double = 570; // Metal-7
   IPN_209:double = 570; // Metal-8
   IPN_210:double = 570; // Metal-9
   IPN_211:double = 170; // Metal-10
   IPN_212:double = 170; // Metal-11
   IPN_213:double = 0; // TM1
   IPN_300:double = 9; // ViaCN
   IPN_301:double = 9; // Via0
   IPN_302:double = 36; // Via1
   IPN_303:double = 36; // Via2
   IPN_304:double = 36; // Via3
   IPN_305:double = 42; // Via4
   IPN_306:double = 55; // Via5
   IPN_307:double = 55; // Via6
   IPN_308:double = 95; // Via7
   IPN_309:double = 95; // Via8
   IPN_310:double = 95; // Via9
   IPN_311:double = 7; // Via10
   IPN_312:double = 7; // Via11
   IPN_400:double = 9; // ViaCN
   IPN_401:double = 9; // Via0
   IPN_402:double = 36; // Via1
   IPN_403:double = 36; // Via2
   IPN_404:double = 36; // Via3
   IPN_405:double = 42; // Via4
   IPN_406:double = 55; // Via5
   IPN_407:double = 55; // Via6
   IPN_408:double = 95; // Via7
   IPN_409:double = 95; // Via8
   IPN_410:double = 95; // Via9
   IPN_411:double = 7; // Via10
   IPN_412:double = 7; // Via11
   ...
   LDIW_505:double = 70; // Window for LDI_505
   ...
   LDI_02:double = 8; // Max allowed INTERMEDIATE Exposed N-diffusion density (%), within a 245um x 245um window size
   ...
   LDI_505:double = -10; // Min Intermediate Metal 5 density (%) relative to actual global Metal 5 density, within a 70um x 70um window size. 
   ...
   LDW_105:double = 25; // Window for LD_105
   ...
   LDW_110:double = 25; // Window for LD_110
   ...
   LDW_111:double = 25; // Window for LD_111
   ...
   LDW_205:double = 9; // Window for LD_205
   ...
   LDW_210:double = 9; // Window for LD_210
   ...
   LDW_211:double = 9; // Window for LD_211
   ...
   LDW_508:double = 11; // Window for LD_508
   ...
   LDW_510:double = 53; // Window for LD_510
   ...
   LDW_511:double = 53; // Window for LD_511
   ...
   LDW_610:double = 53; // Window for LD_610
   LDW_610_X = LDW_610; // Window for LD_610 for x
   LDW_610_Y = LDW_610; // Window for LD_610 for y
   LDW_610_X_STEP = LDW_610; // Window for LD_610 for x-step
   LDW_610_Y_STEP = LDW_610; // Window for LD_610 for y-step
   ...
   LDW_81:double = 120; // Window for LD_81
   ...
   LD_105:double = 40; // Min required local Metal 5 density (%), within a 25um x 25um window size
   ...
   LD_110:double = 40; // Min required local Metal 10 density (%), within a 25um x 25um window size
   LD_111:double = 40; // Min required local Metal 11 density (%), within a 25um x 25um window size
   ...
   LD_205:double = 78; // Max allowed local Metal 5 density (%), within a 9um x 9um window size
   ...
   LD_210:double = 90; // Max allowed local Metal 10 density (%), within a 9um x 9um window size
   LD_211:double = 90; // Max allowed local Metal 11 density (%), within a 9um x 9um window size
   ...
   LD_508:double = 0.3; // Min required local Via8 density (%), within a 11um x 11um window size
   LD_509:double = 0.3; // Min required local Via9 density (%), within a 11um x 11um window size
   LD_510:double = 0.5; // Min required local Via10 density (%), within a 53um x 53um window size
   LD_511:double = 0.5; // Min required local Via11 density (%), within a 53um x 53um window size
   ...
   LD_604:double = 15; // Max required local Via4 density (%), within a 3.9um x 3.9um window size
   ...
   LD_610:double = 12; // Max required local Via10 density (%), within a 53um x 53um window size
   ...
   LD_81:double = 30; // Min required local RDL density (%), 120um x 120um window size
   ...
   LMI_04:double = 95; // Separation of LMI arrays, orthogonal to TSV spine
   LMI_05:double = 1000; // Separation of LMI arrays, parallel to TSV spine
   LMI_06:double = 0.707; // RDL (217;0), RDLPAD (217;40 or 217;47) enclosure of LMI (all sides), fixed
   LMI_07:double = 0; // Cantilever LMI pads will not extend beyond the square that encloses the standard LMI array
   LMI_08:double = 0; // Cantilever LMI pads must be centered with the standard LMI array along the central axis
   LMI_09:double = 1; // Cantilever LMI pad array width (number of pad), only allowed value in OGD
   LMI_10:double = 10; // Cantilever LMI pad array height (number of pads), only allowed value in PGD
   ...
   LMI_13:double = 1000; // LMI array edge distance to active die edge (EOA) (parallel to spine)
   LMI_14:double = 2500; // LMI array edge distance to active die edge (EOA) (orthogonal to spine)
   ...
   M0_126:double = 0; // (B:28-32),(C:54-80)
   M0_127:double = 0; // (B:36-60),(C:78-80)
   M0_128:double = 0; // (B:78-80),(C:28)
   M0_129:double = 0; // (B),(B)
   M0_130:double = 0; // (C),(C)
   ...
   M0_137:double = 0; // (B:28-32),(C:42-80),(B:28-48)
   M0_138:double = 0; // (B:28-32),(C:28,48-80),(B:54-60)
   M0_139:double = 0; // (B:28-32),(C:28,54-80),(B:78-80)
   M0_140:double = 0; // (B:36-48),(C:54-80),(B:36-48)
   M0_141:double = 0; // (B:36-60),(C:28,78-80),(B:54-80)
   M0_142:double = 0; // (B:78-80),(C:28),(B:78-80)
   ...
   M0_812:double = 0.158; // Metal0 line-end overlap of TG poly, fixed value 1 (M0 line ends must terminate within the poly)
   M0_813:double = 0.088; // Metal0 line-end overlap of TG poly, fixed value 2 (M0 line ends must terminate within the poly)
   M0_814:double = 0.018; // Metal0 line-end overlap of TG poly, fixed value 3 (M0 line ends must terminate within the poly)
   M0_82:double = 0.022; // Metal0 line-end overlap of poly, fixed value (M0 line ends must terminate within the poly)
   M0_822:double = 0.088; // Metal0 line-end overlap of TGULV poly, fixed value 1 (M0 line ends must terminate within the poly)
   M0_823:double = 0.018; // Metal0 line-end overlap of TGULV poly, fixed value 2 (M0 line ends must terminate within the poly)
   ...
   M10_00:double = 0; // Only Rectangular M10 shape is allowed for width_01 and width_03/05/06/09/10 shield wires.
   M10_01:double = 0.54; // M10 width
   M10_02:double = 0.54; // M10 space
   M10_03:double = 0.21; // width_03 value (OGD/PGD)
   M10_04:double = 0.28; // width_04 value (OGD only)
   M10_05:double = 0.36; // width_05 value (OGD only)
   M10_06:double = 0.378; // width_06 value (OGD only)
   M10_07:double = 0.42; // width_07 value (OGD only)
   M10_08:double = 0.7; // width_08 value (OGD only)
   M10_09:double = 0.714; // width_09 value (OGD only)
   M10_10:double = 0.798; // width_10 value (OGD only)
   M10_121:double = 0.126; // width_06 to width_06 space, fixed space exception
   M10_20:double = 0; // width_01 wire cannot be sandwiched between two width_03/05/06/09/10 wires at min space on both sides
   M10_21:double = 6; // Maximum allowed M10 width
   M10_22:double = 2.2; // Min required M10 hole area (sq um)
   M10_23:double = 0.54; // Minimum length of at least one M10 segment, when two segments are adjacent at a corner
   M10_24:double = 2.13; // Min required M10 length/extent
   M10_35:double = 0.14; // width_02/03 to width_02/03 space, min unrestricted
   M10_37:double = 0.198; // max edge lengths that can violate the forbidden spaces if space between the edges is >=M10_38
   M10_38:double = 0.378; // width_01-10 to width_01-10 unrestricted space (min) 
   M10_41:double = 0.05; // M10 coverage of Square Via9 (one edge at a corner)
   M10_42:double = 0.198; // Metal10 end-to-end space width_01 line to any line (min)
   M10_43:double = 0.13; // M10 coverage of Square Via9 orthogonal edge
   M10_50:double = 0; // width_02/03 attacker (PGD) to width_01 victim (OGD) is not allowed.  Width_01 victim must be shielded (physically) by parallel rectangular-only width_03/05/06/09/10 wire.
   M10_51:double = 0.05; // M10 coverage of Rectangular Via9 (one edge at a corner)
   M10_52:double = 0.13; // M10 coverage of Rectangular Via9 orthogonal edge
   ...
   M10_80:double = 0.178; // Corner-to-corner space, when corners have no overlap
   M10_81:double = 0.178; // Internal corner-to-corner width 
   M10_82:double = 0.14; // Width between facing concave corner extensions of opposite directions 
   ...
   M11_01:double = 0.54; // M11 width
   M11_02:double = 0.54; // M11 space
   M11_21:double = 6; // Maximum allowed M11 width
   M11_22:double = 2.2; // Min required M11 hole area (sq um)
   M11_23:double = 0.54; // Minimum length of at least one M11 segment, when two segments are adjacent at a corner
   M11_24:double = 2.13; // Min required M11 length/extent
   M11_41:double = 0.05; // M11 coverage of Square Via10 (one edge at a corner)
   M11_43:double = 0.13; // M11 coverage of Square Via10 orthogonal edge
   M11_51:double = 0.05; // M11 coverage of Rectangular Via10 (one edge at a corner)
   M11_52:double = 0.13; // M11 coverage of Rectangular Via10 orthogonal edge
   ...
   M1_01:double = 0.042; // width_01 value, PGD only
   M1_100:double = 0; // M1 width_02 is only allowed inside ULPpitchID
   M1_101:double = 0.056; // width_02 value, PGD only
   M1_21:double = 0.028; // width_01 to width_01 or width_02 to width_02 space1 (fixed value, minimum)
   ...
   M1_36:double = 0.239; // Maximum space (OGD/PGD) (<)
   ...
   M1_69:double = 0.126; // A short line < M1_69 long cannot have exposed edges >M1_85 on one side or both sides
   ...
   M2BB_22:double = 0.376; // (B) - (B) unrestricted space (multi track skip) (M2BB_31/M2BB_32 is the exception to this rule)
   M2BB_31:double = 0.088; // (B) - (B) min unrestricted space (>)
   M2BB_32:double = 0.232; // (B) - (B) max unrestricted space (<)
   M2BB_33:double = 0.056; // Min width of B line next to the unrestricted space
   M2BB_34:double = 0.038; // Min width of C line next to the above B line next to the unrestricted space
   M2BB_35:double = 0; // The above B line next to the unrestricted space needs to be floating (no vias above or below)
   M2BB_36:double = 0.232; // Maximum space (PGD) (<)
   M2BB_37:double = 0.308; // Maximum space (OGD) (<)
   M2BB_38:double = 0.198; // Min PGD space between unrestricted spaces
   M2BC_21:double = 0.312; // (B) to (C-B) unrestricted space (multi track skip)
   ...
   M2CC_27:double = 0.248; // (B-C) to (C-B) unrestricted space (multi track skip)
   M2CC_28:double = 0.564; // For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)
   ...
   M2_126:double = 0; // (B:28-36),(C:60-84)
   M2_127:double = 0; // (B:38-46),(C:84)
   M2_128:double = 0; // (B:56-84),(C:28-36)
   M2_129:double = 0; // (B),(B)
   M2_130:double = 0; // (C),(C)
   ...
   M2_136:double = 0; // (B:28-36),(C:56-84),(B:28-36)
   M2_137:double = 0; // (B:28-46),(C:60-84),(B:38-46)
   M2_138:double = 0; // (B:28-36),(C:28-36,60-84),(B:56-84)
   M2_139:double = 0; // (B:38-46),(C:28-36,84),(B:56-84)
   M2_140:double = 0; // (B:56-84),(C:28-36),(B:56-84)
   M2_141:double = 0; // (B:28),(C:56),(B:76)
   M2_147:double = 0.024; // Width <= 32nm (M2S_03), need line end offset on sides >= M2_147
   M2_148:double = 0.014; // 32nm (M2S_03) < Width <= 46nm (M2M_03), need line end offset on sides >= M2_148
   M2_20:double = 0.05; // Line end are extended by M2_20 before doing any side to side space checks
   M2_21:double = 0.024; // B to C min space
   ...
   M2_37:double = 0.112; // max edge lengths that can violate the forbidden spaces if space  between the edges is >=M2_38
   M2_38:double = 0.076; // Unrestricted space (min) 
   ...
   M2_44:double = 0; // All line ends for widths <= M2_45 must be a aligned or covered at M2_46 space 
   M2_45:double = 0.055; // Max widths for M2_44 check 
   M2_46:double = 0.024; // Space at which the line ends must be aligned or covered 
   M2_47:double = 0; // Lines <= M2_45 wide cannot be isolated, must be next to another narrow or wide line 
   M2_48:double = 0.07; // Minimum overlap of line ends in opposite directions at minimum space
   M2_49:double = 0.056; // Minimum offset of line ends in opposite directions (line ends are extended by M2_43), applies to > M2_45 wide wires
   ...
   M3BB_22:double = 0.376; // (B) - (B) unrestricted space (multi track skip) (M3BB_31/M3BB_32 is the exception to this rule)
   M3BB_31:double = 0.088; // (B) - (B) min unrestricted space (>)
   M3BB_32:double = 0.232; // (B) - (B) max unrestricted space (<)
   M3BB_33:double = 0.056; // Min width of B line next to the unrestricted space
   M3BB_34:double = 0.038; // Min width of C line next to the above B line next to the unrestricted space
   M3BB_35:double = 0; // The above B line next to the unrestricted space needs to be floating (no vias above or below) 
   M3BB_36:double = 0.232; // Maximum space (OGD) (<)
   M3BB_37:double = 0.308; // Maximum space (PGD) (<)
   M3BB_38:double = 0.198; // Min OGD space between unrestricted spaces
   M3BC_21:double = 0.312; // (B) to (C-B) unrestricted space (multi track skip)
   ...
   M3CC_27:double = 0.248; // (B-C) to (C-B) unrestricted space (multi track skip)
   M3CC_28:double = 0.564; // For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)
   ...
   M3_126:double = 0; // (B:28-36),(C:60-84)
   M3_127:double = 0; // (B:40-46),(C:84)
   M3_128:double = 0; // (B:56-84),(C:28-36)
   M3_129:double = 0; // (B),(B)
   M3_130:double = 0; // (C),(C)
   ...
   M3_136:double = 0; // (B:28-36),(C:56-84),(B:28-36)
   M3_137:double = 0; // (B:28-46),(C:60-84),(B:40-46)
   M3_138:double = 0; // (B:28-36),(C:28-36,60-84),(B:56-84)
   M3_139:double = 0; // (B:40-46),(C:28-36,84),(B:56-84)
   M3_140:double = 0; // (B:56-84),(C:28-36),(B:56-84)
   M3_141:double = 0; // (B:28),(C:56),(B:76)
   M3_142:double = 0; // (B:38-52),(C:82-84),(B:56-84)
   M3_143:double = 0; // (B:56-84),(C:32-36),(B:56-84)
   M3_147:double = 0.024; // Width <= 32nm (M3S_03), need line end offset on sides >= M3_147
   M3_148:double = 0.014; // 32nm (M3S_03) < Width <= 46nm (M3M_03), need line end offset on sides >= M3_148
   M3_20:double = 0.05; // Line end are extended by M3_20 before doing any side to side space checks
   M3_21:double = 0.024; // B to C min space
   ...
   M3_37:double = 0.112; // max edge lengths that can violate the forbidden spaces if space  between the edges is >=M3_38
   M3_38:double = 0.076; // Unrestricted space (min) 
   ...
   M3_45:double = 0.055; // Max widths for M3_44 check 
   M3_46:double = 0.024; // Space at which the line ends must be aligned or covered 
   M3_47:double = 0; // Lines <= M3_45 wide cannot be isolated, must be next to another narrow or wide line 
   M3_48:double = 0.07; // Minimum overlap of line ends in opposite directions at minimum space
   M3_49:double = 0.056; // Minimum offset of line ends in opposite directions (line ends are extended by M3_43), applies to > M3_45 wide wires
   ...
   M4BB_22:double = 0.376; // (B) - (B) unrestricted space (multi track skip) (M4BB_31/M4BB_32 is the exception to this rule)
   M4BB_31:double = 0.088; // (B) - (B) min unrestricted space (>)
   M4BB_32:double = 0.232; // (B) - (B) max unrestricted space (<)
   M4BB_33:double = 0.056; // Min width of B line next to the unrestricted space
   M4BB_34:double = 0.038; // Min width of C line next to the above B line next to the unrestricted space
   M4BB_35:double = 0; // The above B line next to the unrestricted space needs to be floating (no vias above or below) 
   M4BB_36:double = 0.232; // Maximum space (PGD) (<)
   M4BB_37:double = 0.308; // Maximum space (OGD) (<)
   M4BB_38:double = 0.198; // Min PGD space between unrestricted spaces
   M4BC_21:double = 0.312; // (B) to (C-B) unrestricted space (multi track skip)
   ...
   M4CC_27:double = 0.248; // (B-C) to (C-B) unrestricted space (multi track skip)
   M4CC_28:double = 0.564; // For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)
   ...
   M4_126:double = 0; // (B:28-36),(C:60-84)
   M4_127:double = 0; // (B:40-46),(C:84)
   M4_128:double = 0; // (B:54-84),(C:28-36)
   M4_129:double = 0; // (B),(B)
   M4_130:double = 0; // (C),(C)
   ...
   M4_136:double = 0; // (B:28-36),(C:54-84),(B:28-36)
   M4_137:double = 0; // (B:28-46),(C:60-84),(B:40-46)
   M4_138:double = 0; // (B:28-36),(C:28-36,60-84),(B:54-84)
   M4_139:double = 0; // (B:40-46),(C:28-36,84),(B:54-84)
   M4_140:double = 0; // (B:54-84),(C:28-36),(B:54-84)
   M4_141:double = 0; // (B:28),(C:56),(B:76)
   M4_142:double = 0; // (B:28),(C:54),(B:76)
   M4_147:double = 0.024; // Width <= 32nm (M4S_03), need line end offset on sides >= M4_147
   M4_148:double = 0.014; // 32nm (M4S_03) < Width <= 46nm (M4M_03), need line end offset on sides >= M4_148
   M4_20:double = 0.05; // Line end are extended by M4_20 before doing any side to side space checks
   M4_21:double = 0.024; // B to C min space
   ...
   M4_23:double = 0.04; // width_02 to width_02 space range min
   ...
   M4_37:double = 0.112; // max edge lengths that can violate the forbidden spaces if space  between the edges is >=M4_38
   M4_38:double = 0.076; // Unrestricted space (min) 
   ...
   M4_45:double = 0.055; // Max widths for M4_44 check 
   M4_46:double = 0.024; // Space at which the line ends must be aligned or covered 
   M4_47:double = 0; // Lines <= M4_45 wide cannot be isolated, must be next to another narrow or wide line 
   M4_48:double = 0.07; // Minimum overlap of line ends in opposite directions at minimum space
   M4_49:double = 0.056; // Minimum offset of line ends in opposite directions (line ends are extended by M4_43), applies to > M4_45 wide wires
   ...
   M5BB_22:double = 0.376; // (B) - (B) unrestricted space (multi track skip) (M5BB_31/M5BB_32 is the exception to this rule)
   M5BB_31:double = 0.088; // (B) - (B) min unrestricted space (>)
   M5BB_32:double = 0.232; // (B) - (B) max unrestricted space (<)
   M5BB_33:double = 0.056; // Min width of B line next to the unrestricted space
   M5BB_34:double = 0.038; // Min width of C line next to the above B line next to the unrestricted space
   M5BB_35:double = 0; // The above B line next to the unrestricted space needs to be floating (no vias above or below) 
   M5BB_36:double = 0.232; // Maximum space (OGD) (<)
   M5BB_37:double = 0.308; // Maximum space (PGD) (<)
   M5BB_38:double = 0.198; // Min OGD space between unrestricted spaces
   M5BC_21:double = 0.312; // (B) to (C-B) unrestricted space (multi track skip)
   ...
   M5CC_27:double = 0.248; // (B-C) to (C-B) unrestricted space (multi track skip)
   M5CC_28:double = 0.564; // For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)
   ...
   M5_01:double = 0.054; // width_01 value (PGD only)
   M5_02:double = 0.066; // width_02 value (PGD only)
   M5_03:double = 0.08; // width_03 value (PGD only)
   M5_04:double = 0.086; // width_04 value (PGD only)
   M5_05:double = 0.094; // width_05 value (PGD only)
   M5_06:double = 0.112; // width_06 value (PGD/OGD)
   M5_07:double = 0.15; // width_07 value (PGD only)
   M5_08:double = 0.158; // width_08 value (PGD only)
   M5_126:double = 0; // (B:28-36),(C:60-84)
   M5_127:double = 0; // (B:40-46),(C:84)
   M5_128:double = 0; // (B:56-84),(C:28-36)
   M5_129:double = 0; // (B),(B)
   M5_130:double = 0; // (C),(C)
   M5_131:double = 0; // (B:28-36),(C:28-46),(B:28-36)
   M5_132:double = 0; // (B:28-46),(C:28-56),(B:40-46)
   M5_133:double = 0; // (B:28-36),(C:40-56),(B:56-84)
   M5_134:double = 0; // (B:40-46),(C:40-76),(B:56-84)
   M5_135:double = 0; // (B:56-84),(C:40-84),(B:56-84)
   M5_136:double = 0; // (B:28-36),(C:56-84),(B:28-36)
   M5_137:double = 0; // (B:28-46),(C:60-84),(B:40-46)
   M5_138:double = 0; // (B:28-36),(C:28-36,60-84),(B:56-84)
   M5_139:double = 0; // (B:40-46),(C:28-36,84),(B:56-84)
   M5_140:double = 0; // (B:56-84),(C:28-36),(B:56-84)
   M5_141:double = 0; // (B:28),(C:56),(B:76)
   M5_147:double = 0.024; // Width <= 32nm (M5S_03), need line end offset on sides >= M5_147
   M5_148:double = 0.014; // 32nm (M5S_03) < Width <= 46nm (M5M_03), need line end offset on sides >= M5_148
   M5_20:double = 0.05; // Line end are extended by M5_20 before doing any side to side space checks
   M5_21:double = 0.024; // B to C min space
   M5_22:double = 0; // Every C line should have an adjacent B line at M5_21 space on atleast one side, along its entire length (allowed to have M5_42 ETE gaps)
   M5_23:double = 0.05; // width_02 to width_02-06 space range min
   M5_24:double = 0.066; // width_02 to width_02-06 space range max
   M5_25:double = 0.05; // width_03-08 to width_03-08 unrestricted space min
   M5_26:double = 0.05; // width_07/08 to width_00/01/02 space range min
   M5_27:double = 0.06; // width_07/08 to width_00/01/02 space range max
   M5_28:double = 0.048; // Width_00 to width_05/06 space exception (fixed value)
   M5_35:double = 0.09; // width_06 to width_06 unrestricted space (min)
   M5_37:double = 0.112; // max edge lengths that can violate the forbidden spaces if space  between the edges is >=M5_38
   M5_38:double = 0.076; // Unrestricted space (min) 
   M5_41:double = 0.056; // End-to-end space (min), when line-ends are completely aligned and lines are same type (B-B, C-C)
   ...
   M5_44:double = 0; // All line ends for widths <= M5_45 must be a aligned or covered at M5_46 space 
   M5_45:double = 0.055; // Max widths for M5_44 check 
   M5_46:double = 0.024; // Space at which the line ends must be aligned or covered 
   M5_47:double = 0; // Lines <= M5_45 wide cannot be isolated, must be next to another narrow or wide line 
   M5_48:double = 0.07; // Minimum overlap of line ends in opposite directions at minimum space
   M5_49:double = 0.056; // Minimum offset of line ends in opposite directions (line ends are extended by M5_43), applies to > M5_45 wide wires
   M5_51:double = 0.06; // Width_06 attacker to width_00-08 victim min space
   M5_52:double = 0.09; // Width_00-08 attacker to width_06 victim min space
   M5_60:double = 0.084; // Min length of M5 line (any type, any width)
   M5_65:double = 0.308; // Min length of holes
   M5_70:double = 0.026; // Minimum segment length
   M5_71:double = 0.054; // Minimum length of at least one segment, when two segments are adjacent at a corner
   M5_72:double = 0; // segments can be smaller than M5_70 if both adjacent segments are >= M5_73
   M5_73:double = 0.5; // Minimum segment lengths for M5_72
   M5_74:double = 0.09; // M5_72 segment to line end space
   M5_80:double = 0.076; // Corner-to-corner space, when corners have no overlap
   M5_81:double = 0.076; // Internal corner-to-corner width 
   M5_82:double = 0.094; // Width between facing concave corner extensions of opposite directions 
   M5_83:double = 0.094; // Min width of notched line section
   M5_84:double = 0.15; // Above rule applies to notch length less than
   ...
   M6_153:double = 0.03; // Minimum overlap of the line ends forming the ETE space (>=)
   M6_16:double = 0; // width_13/14/15 must be rectangles only (no jog or junction allowed)
   M6_160:double = 0.04; // Minimum overlap of Width_04 line end with an adjacent line in the opposite direction, if the ETE space of the width_04 line is = M6_161 
   M6_161:double = 0.08; // Maximum ETE space for M6_160 (=)
   M6_162:double = 0.08; // Minimum overlap of Width_04 line end with an adjacent line in the opposite direction, if the ETE space of the width_04 line is > M6_161 
   ...
   M6_44:double = 0.16; // Width_01/02 to width_01-15 end-to-end space if overlap between facing ends is < M6_45 (min)
   M6_45:double = 0.03; // Overlap between facing line ends
   M6_46:double = 0.08; // Length of unfaced edge of a width_01-07/12 line (max value)
   M6_47:double = 0.1; // ETE space between a <=M6_03 line and a <=M6_07 line, when the line ends are not facing each other (The line ends of the <=M6_03 wide lines are extended by M6_48 prior to this check)
   M6_48:double = 0.013; // Line end extensions of the <=M6_3 wide line for M6_47 check
   ...
   M6_72:double = 0; // segments can be smaller than M6_70 if both adjacent segments are >= M6_73
   M6_73:double = 0.35; // Minimum segment lengths for M6_72
   M6_80:double = 0.056; // Corner-to-corner space, when corners have no overlap
   M6_81:double = 0.056; // Internal corner-to-corner width 
   M6_82:double = 0.09; // Width between facing concave corner extensions of opposite directions 
   M6_83:double = 0.09; // Min width of notched line section
   M6_84:double = 0.124; // Above rule applies to notch length less than
   ...
   M7_37:double = 0.09; // max edge lengths that can violate the forbidden spaces if space  between the edges is >=M7_38
   M7_38:double = 0.168; // width_01/02/03/04/05/06/07 to width_01/02/03/04/05/06/07 unrestricted space (min) 
   ...
   M7_71:double = 0.116; // Minimum lengths of at least one segment, when both adjacent at a corner
   M7_72:double = 0; // segments can be smaller than M7_70 if both adjacent segments are >= M7_73
   M7_73:double = 0.5; // Minimum segment lengths for M7_72
   M7_74:double = 0.09; // M7_72 segment to line end space
   M7_80:double = 0.079; // Corner-to-corner space, when corners have no overlap
   M7_81:double = 0.079; // Internal corner-to-corner width 
   M7_82:double = 0.084; // Width between facing concave corner extensions of opposite directions 
   M7_83:double = 0.084; // Min width of notched line section
   M7_84:double = 0.168; // Above rule applies to notch length less than
   ...
   M8_00:double = 0; // Only Rectangular M8 shape is allowed for width_01 and width_03/05/06/09/10 shield wires.
   M8_01:double = 0.126; // width_01 value (OGD only)
   M8_02:double = 0.14; // width_02 value (OGD/PGD)
   M8_03:double = 0.21; // width_03 value (OGD/PGD)
   M8_04:double = 0.28; // width_04 value (OGD only)
   M8_05:double = 0.36; // width_05 value (OGD only)
   M8_06:double = 0.378; // width_06 value (OGD only)
   M8_07:double = 0.42; // width_07 value (OGD only)
   M8_08:double = 0.7; // width_08 value (OGD only)
   M8_09:double = 0.714; // width_09 value (OGD only)
   M8_10:double = 0.798; // width_10 value (OGD only)
   M8_121:double = 0.126; // width_06 to width_06 space, fixed space exception
   M8_20:double = 0; // width_01 wire cannot be sandwiched between two width_03/05/06/09/10 wires at min space on both sides
   M8_21:double = 0.126; // width_01 to width_01/03/05/06/09/10 space, fixed space1
   M8_22:double = 0.378; // width_01 to width_01/03/05/06/09/10 space, fixed space2
   M8_23:double = 0.63; // width_01 to width_01/03/05/06/09/10 space, fixed space3
   M8_24:double = 0.14; // width_02-10 to width_02-10 space, min unrestricted
   M8_25:double = 0.4; // width_00 to width_00-09 unrestricted space min
   M8_26:double = 0.08; // width_00 to width_07-09 space range1 min
   M8_27:double = 0.11; // width_00 to width_07-09 space range1 max
   M8_32:double = 0.08; // width_02-09 to width_02-09 unrestricted space (min)
   M8_35:double = 0.14; // width_02/03 to width_02/03 space, min unrestricted
   M8_37:double = 0.198; // max edge lengths that can violate the forbidden spaces if space between the edges is >=M8_38
   M8_38:double = 0.378; // width_01-10 to width_01-10 unrestricted space (min) 
   M8_41:double = 0.14; // Metal8 end-to-end space (min)
   M8_42:double = 0.198; // Metal8 end-to-end space width_01 line to any line (min)
   ...
   M8_51:double = 0.14; // OGD/PGD attacker to victim unrestricted space (min)
   M8_52:double = 0.198; // Width_01 attacker to victim unrestricted space (min)
   M8_60:double = 0.274; // Min length for all widths
   M8_65:double = 0.148; // Min required M8 hole area (sq um)
   M8_70:double = 0.04; // Minimum segment length
   M8_71:double = 0.14; // Minimum length of at least one segment, when two segments are adjacent at a corner
   M8_80:double = 0.178; // Corner-to-corner space, when corners have no overlap
   M8_81:double = 0.178; // Internal corner-to-corner width 
   M8_82:double = 0.14; // Width between facing concave corner extensions of opposite directions 
   M8_83:double = 0.148; // Min width of notched line section
   M8_84:double = 0.24; // Above rule applies to notch length less than
   ...
   M9_00:double = 0; // Only Rectangular M9 shape is allowed for width_01 and width_03/05/06/09/10 shield wires.
   M9_01:double = 0.126; // width_01 value (PGD only)
   M9_02:double = 0.14; // width_02 value (OGD/PGD)
   M9_03:double = 0.21; // width_03 value (OGD/PGD)
   M9_04:double = 0.28; // width_04 value (PGD only)
   M9_05:double = 0.36; // width_05 value (PGD only)
   M9_06:double = 0.378; // width_06 value (PGD only)
   M9_07:double = 0.42; // width_07 value (PGD only)
   M9_08:double = 0.7; // width_08 value (PGD only)
   M9_09:double = 0.714; // width_09 value (PGD only)
   M9_10:double = 0.798; // width_10 value (PGD only)
   M9_121:double = 0.126; // width_06 to width_06 space, fixed space exception
   M9_20:double = 0; // width_01 wire cannot be sandwiched between two width_03/05/06/09/10 wires at min space on both sides
   M9_21:double = 0.126; // width_01 to width_01/03/05/06/09/10 space, fixed space1
   M9_22:double = 0.378; // width_01 to width_01/03/05/06/09/10 space, fixed space2
   M9_23:double = 0.63; // width_01 to width_01/03/05/06/09/10 space, fixed space3
   M9_24:double = 0.14; // width_02-10 to width_02-10 space, min unrestricted
   M9_35:double = 0.14; // width_02/03 to width_02/03 space, min unrestricted
   M9_37:double = 0.198; // max edge lengths that can violate the forbidden spaces if space between the edges is >=M9_38
   M9_38:double = 0.378; // width_01-10 to width_01-10 unrestricted space (min) 
   M9_41:double = 0.14; // Metal9 end-to-end space (min)
   M9_42:double = 0.198; // Metal9 end-to-end space width_01 line to any line (min)
   M9_43:double = 0.13; // M9 coverage of Square Via8 orthogonal edge
   M9_50:double = 0; // width_02/03 attacker (OGD) to width_01 victim (PGD) is not allowed.  Width_01 victim must be shielded (physically) by parallel rectangular-only width_03/05/06/09/10 wire.
   M9_51:double = 0.14; // OGD/PGD attacker to victim unrestricted space (min)
   M9_52:double = 0.198; // Width_01 attacker to victim unrestricted space (min)
   M9_60:double = 0.274; // Min length for all widths
   M9_65:double = 0.148; // Min required M9 hole area (sq um)
   M9_71:double = 0.14; // Minimum length of at least one segment, when two segments are adjacent at a corner
   M9_80:double = 0.178; // Corner-to-corner space, when corners have no overlap
   M9_81:double = 0.178; // Internal corner-to-corner width 
   M9_82:double = 0.14; // Width between facing concave corner extensions of opposite directions 
   MC_01:double = 0; // Outer edges of the PRS cells must be line-on-line with the EDM cells boundary.
   MC_02:double = 0; // CE1/2/3 cannot overlap the PRS cells
   MC_03:double = 0; // CE1/2/3 cannot overlap the logo cells
   ...
   MIM_51:double = 0.4; // Minimum CE1/2 enclosure of Via10 (all directions)
   MIM_52:double = 1; // Via10 space to unconnected CE1/2
   MIM_53:double = 0; // Via10 cannot land on overlapping CE1/2
   MIM_54:double = 1.76; // Via10 space to unconnected CE1, when the Via10 is connected to 0 or 1 capacitor plates
   MIM_55:double = 1.6; // Via10 space to unconnected CE2, when the Via10 is connected to 0 or 1 capacitor plates
   MIM_61:double = 0; // CE1/2 electrode layers cannot be used as a resistor, must have a M10 or TM1 shunt
   ...
   NW_01:double = 0.021; // N-well space to N+ active (all directions), P+ tap (OGD)
   NW_03:double = 0.021; // N-well enclosure of P+ active (all directions), N+ tap (OGD)
   NW_12:double = 0.126; // N-well width
   NW_128:double = 5.6; // Maximum distance from P active diff with gate in the well to a well tap, for I/O and high voltage wells and pad-connected diffusions
   NW_129:double = 5.6; // Maximum distance from N active diff with gate in the p-well to a sub tap, for I/O and high voltage wells and pad-connected diffusions
   NW_14:double = 0.126; // N-well space
   NW_17:double = 0.05; // Min required drawn N-well area (in sq um)
   NW_18:double = 0.05; // Min required drawn N-well hole area (in sq um)
   NW_21:double = 0.042; // N+ active diffusion space to high voltage nwells
   NW_22:double = 0.042; // P+ active diffusion enclosure by high voltage nwell
   NW_23:double = 0.107; // N-well convex corner enclosure of P+ active diffusion corner
   NW_24:double = 0.107; // N-well concave corner space to N+ active diffusion corner
   NW_25:double = 0.126; // Minimum N-well segment lengths, when both adjacent at a corner
   ...
   NW_31:double = 0.042; // N-well space to P+ tap (PGD)
   NW_33:double = 0.042; // N-well enclosure of N+ tap (PGD)
   ...
   NW_55:double = 0.154; // N-well X- or Y-direction enclosure of N+ tap diff near short n-well jog <=NW_57
   NW_56:double = 0.154; // N-well X- or Y-direction space to P+ tap diff near short n-well jog <=NW_57
   NW_57:double = 0.112; // Max length of short NWL jog for which rules NW_55,NW_56 apply
   NW_58:double = 0.154; // N+ tap diff or P+ tap diff distance to NWL edge when facing an opposite-type tap spaced at <NW_58 from the NWL edge
   ...
   PC_21:double = 0.052; // Polycon side-to-side space (min)
   PC_23:double = 0.115; // Polycon side-to-side forbidden space (fixed value)
   PC_25:double = 0.05; // Min Polycon end-to-end space, when facing ends are aligned (min)
   ...
   PC_36:double = 0.018; // Minimum overlap between line-ends in opposite directions, when at a PC_21 side-to-side space. PC_36 overlap is allowed when the ETE space is > PC_56 or the length of all the adjacent GCNs is >=PC_57
   PC_41:double = 0.032; // Poly overlap of polycon (PGD) for PC_42
   PC_42:double = 0.024; // Polycon end overlap of poly for PC_41
   PC_43:double = 0.023; // Polycon side space to poly line-end
   PC_44:double = 0.012; // Polycon end space to poly side
   PC_45:double = 0.019; // Poly overlap of polycon (PGD) for PC_46
   PC_46:double = 0.03; // Polycon end extension beyond poly side for PC_45
   ...
   PC_56:double = 0.06; // Min Polycon end-to-end space to allow PC_36 overlap
   PC_57:double = 0.088; // Min length of the 3 adjacent GCNs to allow PC_36 overlap
   PC_61:double = 0.026; // Min Polycon side space to gate/diffusion OGD edge
   PC_81:double = 0.026; // Polycon space to Diffcon
   PC_82:double = 0.032; // Diffcon overlap of Polycon in PGD for PC_83
   PC_83:double = 0.023; // Polycon end overlap of Diffcon in OGD for PC_82
   PC_84:double = 0.016; // Diffcon overlap of Polycon in PGD for PC_85
   PC_85:double = 0.031; // Polycon end extension beyond Diffcon side (OGD) for PC_84
   PC_91:double = 0; // PC_21, PC_92 spaces on opposite sides of a GCN are not allowed
   PC_92:double = 0.094; // Space for the PC_91 check
   PC_93:double = 0.05; // Polycon line extension for PC_91/92 side-to-side space checks only
   PG_01:double = 0.042; // Poly check grid width (fixed value)
   PG_02:double = 0.14; // Poly check grid Pitch (fixed value)
   ...
   PL_04:double = 0.036; // Short poly end-to-end space (fixed value) (cannot be isolated)
   PL_05:double = 0.078; // Long poly end-to-end space (fixed value)
   PL_06:double = 0.26; // Long poly end-to-end space range (maximum)
   PL_07:double = 0.078; // Medium poly end-to-end space (fixed value)
   PL_08:double = 0.099; // Long poly end-to-end space range unrestricted min
   PL_09:double = 0; // Space between PL_05 and PL_08 is not allowed
   ...
   PL_105:double = 0; // Need an even number of synthesized polygons in the loop 
   PL_106:double = 0.068; // Oversize of narrow cut for PL_105 check
   PL_11:double = 0.024; // Poly endcap length
   ...
   PL_25:double = 0.018; // Poly end space to diffusion PGD
   ...
   PL_62:double = 0; // A PL_04 end-to-end adjacent to a long cut on one side must also be adjacent to a PL_04 or a long cut on its other side. PL_04 cannot be isolated.
   ...
   PL_69:double = 0; // A PL_07 region adjacent to a PL_04 must be centered or satify PL_16
   PL_70:double = 0; // Cannot have a single isolated PL_04 next to a centered PL_07
   PL_71:double = 0; // A centered PL_07 cannot have a GCN
   ...
   RDL_06:double = 12.67; // RDL distance from LMI PAD center (center of (217;40)) to unconnected RDL wire, minimum 
   ...
   RDL_16:double = 350; // Maximum RDL wire length
   ...
   SK_62:double = 0; // Disallowed V6/V7 non-redundant stack, if under TV1 and max via5 density > 5% (600X600nm window)  and metal7 density < 40% (500X500nm window)
   ...
   SK_72:double = 0; // Disallowed V7/V8 non-redundant stack, if under TV1 and max via6 density > 5% (600X600nm window) and metal8 density < 40% (500X500nm window)
   ...
   TM1_51:double = 3; // TM1 coverage of Via10 (all directions)
   TM1_60:double = 0; // TM1 space above inductors templates has special handling
   TPC_42:double = 0.084; // Polycon end overlap of poly for PC_41
   TPC_44:double = 0.016; // Polycon end space to poly side
   TPC_46:double = 0.108; // Polycon overlap with poly (in OGD) for PC_45
   ...
   TPL_11:double = 0.045; // Poly endcap length
   ...
   TPL_25:double = 0.078; // Poly end space to diffusion PGD
   ...
   TSV_07:double = 10; // Transistor keepout zone from M1 catch cup grid (all sides)
   ...
   TV1_51:double = 3; // TM1 enclosure of  TV1 (all directions)
   ...
   TX_06:double = 0.039; // TGOXID enclosure of poly end,  in PGD
   TX_07:double = 0.039; // TGOXID space to poly end,  in PGD
   ...
   UHV_01:double = 0.045; // Polycon space to Diffcon
   UHV_02:double = 0.045; // VCN space to Diffcon (PGD)
   UHV_04:double = 0.045; // VCN space to polycon (PGD)
   ...
   UHV_21:double = 0.04; // Via5-Metal5 space (min)
   UHV_34:double = 0.031; // Metal4-Metal4 space (min)
   UHV_36:double = 0.084; // Metal6-Metal6 space (min)
   UHV_40:double = 0.04; // VCN space to Diffcon side (OGD)
   UHV_41:double = 0.042; // VCN space to Polycon end (OGD)
   ...
   UHV_53:double = 0.045; // Via3-Via4 space (min)
   UHV_54:double = 0.039; // Via4-Metal4 space (min)
   UHV_55:double = 0.041; // Via4-Via4 space (min)
   UHV_56:double = 0.036; // Via4-Metal5 space (min)
   ...
   UNW_14:double = 0.48; // N-well space
   UNW_21:double = 0.175; // N+ active diffusion space to ultra high voltage nwells
   UNW_22:double = 0.175; // P+ active diffusion enclosure by ultra high voltage nwell
   ...
   V0_122:double = 0.1; // Unrestricted Via0AY-to-Via0AY center-to-center space
   V0_142:double = 0.026; // Minimum Via0TBX/TBY overlap of M0
   V0_171:double = 0.118; // Unrestricted Via0-Via0 center-to-center space for all V0AY/BY/CY/DY/EY/AW/BW/PAY (if centers are closer, vias are allowed on maximum of any 2 corners)
   V0_19:double = 0; // V0_02-V0T_10 edges are SA edges, the line end edge of Via0PAX can also be self aligned
   V0_22:double = 0.089; // Unrestricted Via0AX-to-Via0AX center-to-center space
   V0_23:double = 0; // Parallel full-facing metal-aligned Via0 edges can be as closely spaced as the minimum allowed M1 space.  (merged via)
   ...
   V0_252:double = 0; // Via0TAY/TBY can have 2 or fewer via0 at V0_70<=CTC<V0_250 on any 2 corners, other vias must be >=V0_250 CTC from Via0TAY/TBY 
   ...
   V0_31:double = 0.028; // Via0 to VCN space (on different Metal0)
   V0_32:double = 0.076; // Facing V0PAX/PAY pair to adjacent V0PAX/PAY
   ...
   V0_33:double = 0.028; // Via0 edge space to Metal0
   ...
   V0_49:double = 0.014; // Metal0 line end enclosure of Via0
   ...
   V0_64:double = 0.084; // M1 line end enclosure of opposite side of Via0PAX
   V0_66:double = 0.042; // Min M1 line end enclosure of any Via0, when M1 line end is exposed (on either side-edge) as defined by M1_86
   V0_69:double = 0.007; // M1 coverage of Via0TAY/TBY side, only allowed value
   V0_70:double = 0.039; // Via0 corner-to-corner space
   V0_71:double = 0.103; // Unrestricted Via0-Via0 center-to-center space for all via0s except V0AY/BY/CY/DY/EY/AW/BW/PAY (if centers are closer, vias are allowed on maximum of any 2 corners)
   ...
   V10_01:double = 0.44; // Square Via10 size ONLY ALLOWED value
   V10_02:double = 1.115; // Square Via10 to Square Via10 (center-to-center) separation
   V10_11:double = 0.08; // M10 enclosure of Square Via10
   V10_12:double = 0.08; // M10 enclosure of Square Via10, orthogonal edge
   V10_31:double = 0.8; // Width of Via10A/B/C, fixed value
   V10_32:double = 1.85; // Via10A length, fixed value
   V10_33:double = 7.4; // Via10B length, fixed value
   V10_34:double = 3.7; // Via10C length, fixed value
   V10_40:double = 2; // Via10 to Via10 space (all directions)
   V10_41:double = 2.5; // Via10 to Via10 corner-to-corner space
   V10_51:double = 0.14; // M10 enclosure of Via10 (all directions)
   V10_52:double = 0.08; // M10 enclosure of Rectangular Via10, orthogonal edge
   V11_31:double = 0.8; // Width of Via11A/B/C, fixed value
   V11_32:double = 1.85; // Via11A length, fixed value
   V11_33:double = 7.4; // Via11B length, fixed value
   ...
   V11_51:double = 0.14; // M11 enclosure of Via11 (all directions)
   ...
   V1H_09:double = 0.064; // Via1HJ length (PGD), fixed value (no edge is SA)
   V1H_10:double = 0.07; // Via1HK length (PGD), fixed value (one V1H_01 edge is SA)
   V1H_11:double = 0.048; // Via1HL length (PGD), fixed value (no edge is SA)
   ...
   V1T_20:double = 0; // The V1T_01/11 edges of V1TA/B must both be aligned with parallel metal edges.
   ...
   V1_124:double = 0.046; // Via1 corner-to-corner space (un restricted) doesn't need to meet the V1_25 one pair rule
   V1_125:double = 0.049; // Via1TB corner-to-corner space (un restricted) doesn't need to meet the V1_26 one pair rule
   ...
   V1_140:double = 0.01; // Via1 edge enclosure by width_02 Metal1 (OGD) (V1TA/TB are exceptions)
   ...
   V1_22:double = 0.087; // Unrestricted Via1A-to-Via1A center-to-center space
   V1_225:double = 0.052; // The tight V1HL to V1HA, non-SA edge corner space (<V1_225) is allowed for a single isolated via pair. The pair must be spaced from other vias by V1_28 
   V1_226:double = 0.058; // The tight V1HL to any V1, SA edge corner space (<V1_226) is allowed for 2 or fewer vias. The pair must be spaced from other vias by V1_226. Note: This rule applies only if any of the vias neighboring the V1HL via are less than 52 long (V1_227) in the PGD direction
   V1_227:double = 0.052; // Max PGD length of neighboring vias for V1_226 to apply (<)
   V1_23:double = 0.024; // Parallel full-facing metal-aligned Via1 edges can be as closely spaced as the minimum allowed M2 space. 
   V1_24:double = 0.041; // Via1 corner-to-corner space
   V1_25:double = 0; // The tight via-via corner space (<V1_124) is allowed for a single isolated via pair. The pair must be spaced from other vias by V1_28 
   V1_26:double = 0; // The tight Via1TB-Via1TB corner space (<V1_125) is allowed for a single isolated via pair. The pair must be spaced from other vias by V1_28 
   V1_28:double = 0.076; // Unrestricted min Via1 edge-to-edge space
   V1_32:double = 0.031; // Via1 to Via0 space (on different Metal1)
   V1_33:double = 0.031; // Via1 edge space to Metal1
   V1_40:double = 0.003; // Via1 edge enclosure by width_01 Metal1 (OGD) (V1TA/TB are exceptions)
   V1_42:double = 0.035; // Minimum Via1TB overlap of Metal1 (OGD)
   V1_43:double = 0; // Via1TA/TB must overlap 2 adjacent M1 lines
   V1_49:double = 0.007; // Metal1 line-end enclosure of Via1
   V1_50:double = 0.028; // Metal1 line-end enclosure of Via1, when Via1 lands on an offset M1 as defined by M1_86
   ...
   V1_61:double = 0.024; // M2 line-end enclosure of Via1 
   V1_97:double = 0.128; // V1Ts long edge to long edge space (PGD)
   ...
   V2H_10:double = 0; // Only one of the Via2HA/HG/HK/HM PGD edges are aligned to metal edges.
   ...
   V2H_20:double = 0; // None of the Via2HD/HJ/HL edges are aligned to metal edges.
   ...
   V2T_20:double = 0; // The V2T_01 edges of V2TA, V2T_03 edges of V2TB, and V2T_05 edges of V2TC must both be aligned with parallel metal edges.
   ...
   V2_128:double = 0.076; // Unrestricted min Via2 edge-to-edge space (SA edges)
   ...
   V2_142:double = 0.028; // Minimum Via2TC overlap of Metal2 (PGD). If M2 width is less than V2_42, this is the extension past the nearest M2 edge.
   ...
   V2_152:double = 0.027; // Via2 to Via1 edge-to-edge space (on different Metal2)
   ...
   V2_22:double = 0.104; // Unrestricted V2A-to-V2A center-to-center space
   V2_228:double = 0.08; // Unrestricted min V2HA SA edge to SA edge of any via2s
   V2_23:double = 0.024; // Parallel full-facing metal-aligned Via2 edges can be as closely spaced as the minimum allowed M3 space. 
   V2_24:double = 0.048; // Min Via2 corner-to-corner space (CTC space between V2_24 and V2_250 comes with restrictions)
   ...
   V2_251:double = 0; // Small via2 (32 wide - A/B/C/D/F/G/J/L/N/O/R/S/V/HA/HG/HK/HM/HD/HJ/HL) can have only one via2(big/small) at V2_24<=CTC<V2_250, other vias must be >=V2_250 CTC from the small via 
   V2_252:double = 0; // A big via2 can have 2 or fewer small via2 (32 wide) at V2_24<=CTC<V2_250 on any 2 corners, other vias must be >=V2_250 CTC from the big via 
   V2_28:double = 0.072; // Unrestricted min Via2 edge-to-edge space (non-SA edges)
   V2_32:double = 0.023; // Via2 to Via1 corner-to-corner space (on different Metal2)
   V2_33:double = 0.022; // Via2 edge space to Metal2
   ...
   V2_42:double = 0.03; // Minimum Via2TA/TB overlap of Metal2 (PGD). If M2 width is less than V2_42, this is the extension past the nearest M2 edge.
   ...
   V2_49:double = 0.009; // Metal2 line-end enclosure of Via2
   V2_51:double = 0; // Both opposite edges of a aligned via must be metal aligned
   V2_54:double = 0; // Via2HJ can only be covered by a width_L_05 metal3
   V2_61:double = 0.024; // M3 line-end enclosure of Via2 
   ...
   V3H_02:double = 0.036; // Via3HA length (PGD), fixed value (one edge SA only)
   V3H_03:double = 0.032; // Width of Via3HG (OGD), fixed value
   V3H_04:double = 0.078; // Via3HG length (PGD), fixed value (one edge SA only)
   V3H_05:double = 0.032; // Width of Via3HK (OGD), fixed value
   V3H_06:double = 0.07; // Via3HK length (PGD), fixed value (one edge SA only)
   V3H_07:double = 0.032; // Width of Via3HM (OGD), fixed value
   V3H_08:double = 0.054; // Via3HM length (PGD), fixed value (one edge SA only)
   V3H_10:double = 0; // Only one of the Via3HA/HG/HK/HM OGD edges are aligned to metal edges.
   ...
   V3H_20:double = 0; // None of the Via3HD/HJ/HL/HN edges are aligned to metal edges.
   ...
   V3T_20:double = 0; // The V3T_01 edges of V3TA, V3T_03 edges of V3TB, and V3T_05 edges of V3TC must both be aligned with parallel metal edges.
   ...
   V3_128:double = 0.076; // Unrestricted min Via3 edge-to-edge space (SA edges)
   ...
   V3_142:double = 0.028; // Minimum Via3TC overlap of Metal3 (OGD). If M3 width is less than V3_42, this is the extension past the nearest M3 edge.
   V3_15:double = 0.068; // Via3T length (PGD), fixed value
   V3_152:double = 0.027; // Via3 to Via2 edge-to-edge space (on different Metal3)
   ...
   V3_19:double = 0.032; // Via3C length (OGD), fixed value
   V3_20:double = 0; // The V3_01 edges of above Via3 must both be aligned with parallel Metal-4 edges.
   V3_22:double = 0.104; // Unrestricted V3A-to-V3A center-to-center space
   V3_228:double = 0.08; // Unrestricted min V3HA SA edge to SA edge of any via3s
   V3_23:double = 0.024; // Parallel full-facing metal-aligned Via3 edges can be as closely spaced as the minimum allowed M4 space. 
   V3_24:double = 0.048; // Min Via3 corner-to-corner space (CTC space between V3_24 and V3_250 comes with restrictions)
   ...
   V3_251:double = 0; // Small via3 (32 wide - A/B/C/D/F/G/J/L/N/O/R/S/V/X/HA/HG/HK/HM/HD/HJ/HL) can have only one via3(big/small) at V3_24<=CTC<V3_250, other vias must be >=V3_250 CTC from the small via 
   V3_252:double = 0; // A big via3 can have 2 or fewer small via3 (32 wide) at V3_24<=CTC<V3_250 on any 2 corners, other vias must be >=V3_250 CTC from the big via 
   ...
   V3_28:double = 0.072; // Unrestricted min Via3 edge-to-edge space (non-SA edges)
   V3_32:double = 0.023; // Via3 to Via2 corner-to-corner space (on different Metal3)
   V3_33:double = 0.022; // Via3 edge space to Metal3
   V3_40:double = 0.002; // Maximum Via3 overhang of Metal3 (OGD)
   V3_41:double = 0; // Via3 must be centered on Metal3 (OGD) 
   V3_42:double = 0.03; // Minimum Via3TA/TB overlap of Metal3 (OGD). If M3 width is less than V3_42, this is the extension past the nearest M3 edge.
   ...
   V3_49:double = 0.009; // Metal3 line-end enclosure of Via3
   V3_51:double = 0; // Both opposite edges of a aligned via must be metal aligned
   V3_54:double = 0; // Via3HJ can only be covered by a width_L_05 metal4
   V3_61:double = 0.024; // M4 line-end enclosure of Via3 
   ...
   V4H_10:double = 0; // Only one of the Via4HA/HG/HK/HM PGD edges are aligned to metal edges.
   ...
   V4H_20:double = 0; // None of the Via4HD/HJ/HL edges are aligned to metal edges.
   ...
   V4T_20:double = 0; // The V4T_01 edges of V4TA, V4T_03 edges of V4TB, and V4T_05 edges of V4TC must both be aligned with parallel metal edges.
   V4_01:double = 0.032; // Width of below Via4 (PGD), fixed value
   V4_02:double = 0.028; // Via4A length (OGD), fixed value
   V4_03:double = 0.03; // Via4B length (OGD), fixed value
   V4_04:double = 0.036; // Via4D length (OGD), fixed value
   V4_05:double = 0.04; // Via4F length (OGD), fixed value
   V4_06:double = 0.046; // Via4G length (OGD), fixed value
   V4_08:double = 0.056; // Via4J length (OGD), fixed value
   V4_09:double = 0.06; // Via4R length (OGD), fixed value
   V4_10:double = 0.074; // Via4V length (OGD), fixed value
   V4_101:double = 0.05; // Via4N length (OGD), fixed value
   V4_102:double = 0.08; // Via4O length (OGD), fixed value
   V4_103:double = 0.086; // Via4P length (OGD), fixed value
   V4_104:double = 0.112; // Via4Q length (OGD), fixed value
   V4_105:double = 0.158; // Via4R length (OGD), fixed value
   V4_106:double = 0.066; // Via4H length (OGD), fixed value
   V4_11:double = 0.068; // Via4L length (OGD), fixed value
   V4_111:double = 0.052; // Width (PGD) of below via4s, fixed value
   V4_112:double = 0.054; // Via4AS length (OGD), fixed value
   V4_113:double = 0.05; // Via4NS length (OGD), fixed value
   V4_114:double = 0.066; // Via4HS length (OGD), fixed value
   V4_115:double = 0.08; // Via4OS length (OGD), fixed value
   V4_116:double = 0.086; // Via4PS length (OGD), fixed value
   V4_117:double = 0.094; // Via4DS length (OGD), fixed value
   V4_118:double = 0.112; // Via4QS length (OGD), fixed value
   V4_119:double = 0.158; // Via4RS length (OGD), fixed value
   V4_12:double = 0.066; // Via4N length (OGD), fixed value
   ...
   V4_128:double = 0.076; // Unrestricted min Via4 edge-to-edge space (SA edges)
   V4_129:double = 0.04; // Via4NX (PGD), fixed value (SA edges)
   V4_13:double = 0.076; // Via4S length (OGD), fixed value
   ...
   V4_14:double = 0.084; // Via4O length (OGD), fixed value
   V4_142:double = 0.028; // Minimum Via4TC overlap of Metal4 (PGD). If M4 width is less than V4_42, this is the extension past the nearest M4 edge.
   V4_15:double = 0.054; // Via4U length (OGD), fixed value
   V4_152:double = 0.027; // Via4 to Via3 edge-to-edge space (on different Metal4)
   V4_16:double = 0.078; // Via4V Width (PGD) , fixed value (SA edges)
   V4_17:double = 0.08; // Via4V length (OGD), fixed value
   V4_19:double = 0.032; // Via4C length (OGD), fixed value
   V4_20:double = 0; // The V4_01 edges of above Via4 must both be aligned with parallel Metal-5 edges.
   V4_22:double = 0.104; // Unrestricted V4A-to-V4A center-to-center space
   V4_228:double = 0.08; // Unrestricted min V4HA SA edge to SA edge of any via4s
   V4_23:double = 0.024; // Parallel full-facing metal-aligned Via4 edges can be as closely spaced as the minimum allowed M5 space. 
   V4_24:double = 0.048; // Min Via4 corner-to-corner space (CTC space between V4_24 and V4_250 comes with restrictions)
   V4_240:double = 0; // Only V4_01 width vias can overhang Metal4 (PGD)
   V4_250:double = 0.071; // Min unrestricted Via4 corner-to-corner space
   V4_251:double = 0; // Small via4 (32 wide - A/B/C/D/F/G/J/L/N/O/R/S/V/HA/HG/HK/HM/HD/HJ/HL) can have only one via4(big/small) at V4_24<=CTC<V4_250, other vias must be >=V4_250 CTC from the small via 
   V4_252:double = 0; // A big via4 can have 2 or fewer small via4 (32 wide) at V4_24<=CTC<V4_250 on any 2 corners, other vias must be >=V4_250 CTC from the big via 
   V4_28:double = 0.072; // Unrestricted min Via4 edge-to-edge space (non-SA edges)
   ...
   V4_32:double = 0.023; // Via4 to Via3 corner-to-corner space (on different Metal4)
   V4_33:double = 0.022; // Via4 edge space to Metal4
   V4_40:double = 0.002; // Maximum Via4 overhang of Metal4 (PGD)
   V4_41:double = 0; // Via4 must be centered on Metal4 (PGD) 
   V4_42:double = 0.03; // Minimum Via4TA/TB overlap of Metal4 (PGD). If M4 width is less than V4_42, this is the extension past the nearest M4 edge.
   ...
   V4_49:double = 0.009; // Metal4 line-end enclosure of Via4
   V4_51:double = 0; // Both opposite edges of a aligned via must be metal aligned
   V4_54:double = 0; // Via4HJ can only be covered by a width_L_05 metal5
   V4_61:double = 0.024; // M5 line-end enclosure of Via4 
   V4_62:double = 0.006; // Min M5 line-side enclosure of Via4HD/HJ/HL (OGD) 
   ...
   V5_01:double = 0.032; // Width of below Via5 (OGD), fixed value (SA edges)
   V5_02:double = 0.04; // Via5A length (PGD), fixed value
   V5_03:double = 0.044; // Via5B length (PGD), fixed value
   V5_04:double = 0.144; // Via5DS length (PGD), fixed value
   V5_05:double = 0.16; // Via5ES length (PGD), fixed value
   V5_06:double = 0.064; // Via5D length (PGD), fixed value
   V5_07:double = 0.104; // Via5M length (PGD), fixed value
   V5_08:double = 0.2; // Via5N length (PGD), fixed value
   V5_09:double = 0.108; // Via5FA length (PGD), fixed value
   V5_10:double = 0.048; // Via5N length (PGD), fixed value
   V5_101:double = 0.056; // Width of Via5S (OGD), fixed value (SA edge)
   V5_102:double = 0.044; // Length of Via5S (PGD), fixed value
   V5_103:double = 0.048; // Width of Via5U (OGD), fixed value (SA edge)
   V5_104:double = 0.076; // Length of Via5U (PGD), fixed value
   V5_105:double = 0.048; // Width of Via5V (OGD), fixed value (SA edge)
   V5_106:double = 0.09; // Length of Via5V (PGD), fixed value
   ...
   V5_11:double = 0.06; // Via5O length (PGD), fixed value
   ...
   V5_12:double = 0.076; // Via5Q length (PGD), fixed value
   V5_128:double = 0.12; // Unrestricted min Via5 edge-to-edge space (SA edges)
   V5_13:double = 0.09; // Via5R length (PGD), fixed value
   V5_14:double = 0.056; // Via5M length (PGD), fixed value
   V5_15:double = 0.068; // Via5T length (PGD), fixed value
   V5_152:double = 0.028; // Via5 to Via4 edge-to-edge space (on different Metal5)
   V5_153:double = 0.035; // Via5 on isolated M6 to Via4 space (on different Metal5)
   V5_154:double = 0.04; // Isolated M6 line for V5_153 is defined as a line with exposed edges on opposite edges of the line with overlap of > V5_154
   ...
   V5_19:double = 0; // V5_01 edge of above vias must both be aligned with parallel Metal-6 edges.
   V5_22:double = 0.095; // Unrestricted V5A-to-V5A center-to-center space
   V5_23:double = 0.04; // Parallel full-facing metal-aligned Via5 edges can be as closely spaced as the minimum allowed M6 space. 
   V5_24:double = 0.044; // Min Via5 corner-to-corner space
   V5_240:double = 0; // Only V5_01 (32nm), V5_161 (44nm) width vias (except Via5MP) can overhang Metal5 (OGD)
   ...
   V5_28:double = 0.072; // Unrestricted min Via5 edge-to-edge space
   V5_29:double = 0.036; // Via5 min edge offset if corner-to-corner space is less than V5_30
   V5_30:double = 0.134; // Via5  corner-to-corner space limit for V5_29
   V5_32:double = 0.025; // Via5 to Via4 corner-to-corner space (on different Metal5)
   V5_33:double = 0.022; // Via5 edge space to Metal5
   V5_40:double = 0.002; // Maximum Via5 overhang of Metal5 (OGD)
   V5_41:double = 0; // Via5 must be centered on Metal5 (OGD)
   V5_42:double = 0; // Via5YZ can only land on width_L_05/06 M5 lines (M5L_05/06)
   V5_49:double = 0.012; // Metal5 line-end enclosure of Via5
   V5_51:double = 0; // Both opposite edges of a aligned via must be metal aligned
   V5_52:double = 0; // Via5YZ must be centered under M6_13/14/15 width M6 (only)
   V5_54:double = 0.022; // Metal6 concave corner space to Via5
   V5_61:double = 0.022; // Metal6 line-end enclosure of Via5  (except Via5YZ)
   V5_62:double = 0.032; // Metal6 line-end enclosure of Via5YZ
   ...
   V6_22:double = 0.137; // Via6A-Via6A center-to-center space
   V6_23:double = 0.056; // Via6 metal aligned edges space when the other edges (non-metal limited edges) are perfectly aligned
   V6_24:double = 0.059; // Via6 corner-to-corner space
   V6_240:double = 0; // Via6H are not allowed to overhang
   V6_25:double = 0.1; // Via6 facing edge space (V6_23,27,28 are exceptions)
   V6_27:double = 0.168; // Via6C/CX/D/E/F/G/H/CY/DX/EX facing short-edge to short-edge space 
   V6_28:double = 0.168; // Via6 metal aligned edges space when the other edges (non-metal limited edges) are NOT perfectly aligned
   V6_29:double = 0.02; // Via6 min edge offset if corner-to-corner space is less than V6_30
   V6_30:double = 0.098; // Via6  corner-to-corner space limit for V6_29
   V6_31:double = 0.036; // Via6 to Via5 edge-edge space (on different M6)
   V6_32:double = 0.03; // Via6 to Via5 corner-to-corner space (on different M6)
   V6_33:double = 0.03; // Via6 edge space to Metal6
   ...
   V6_49:double = 0.016; // Metal6 line end enclosure of Via6
   V6_51:double = 0; // Both opposite edges of a aligned via must be metal aligned
   V6_54:double = 0.032; // M7 concave corner space to Via6
   V6_55:double = 0.032; // M7 convex corner coverage of Via6 corner
   V6_61:double = 0.032; // M7 line end enclosure of Via6 
   ...
   V7_01:double = 0.126; // Via7A width (PGD), fixed value
   V7_02:double = 0.074; // Via7A length (OGD), fixed value
   V7_03:double = 0.21; // Via7B width (PGD), fixed value
   V7_04:double = 0.074; // Via7B length (OGD), fixed value
   V7_05:double = 0.14; // Via7F width (PGD), fixed value
   V7_06:double = 0.074; // Via7F length (OGD), fixed value
   V7_07:double = 0.192; // Via7FS length (PGD), fixed value
   V7_08:double = 0.212; // Via7GS length (PGD), fixed value
   V7_09:double = 0.236; // Via7HS length (PGD), fixed value
   V7_10:double = 0.3; // Via7JS length (PGD), fixed value
   V7_101:double = 0.092; // Width of below Via7, fixed value (OGD SA-edge)
   V7_102:double = 0.08; // Via7KS length (PGD), fixed value
   V7_103:double = 0.11; // Via7LS length (PGD), fixed value
   V7_104:double = 0.124; // Via7MS length (PGD), fixed value
   V7_105:double = 0.148; // Via7NS length (PGD), fixed value
   V7_106:double = 0.168; // Via7OS length (PGD), fixed value
   V7_107:double = 0.192; // Via7PS length (PGD), fixed value
   V7_108:double = 0.212; // Via7QS length (PGD), fixed value
   V7_109:double = 0.236; // Via7RS length (PGD), fixed value
   ...
   V7_128:double = 0.378; // Unrestricted min Via7 edge-to-edge space (SA edges, SA to non-SA edges)
   ...
   V7_22:double = 0.275; // Via7A-to-Via7A center-to-center space (on different M7 lines)
   V7_23:double = 0.126; // Parallel full-facing metal-aligned Via7 edges can be as closely spaced as the minimum allowed M8 space. 
   V7_24:double = 0.131; // Via7 corner-to-corner space
   V7_28:double = 0.15; // Unrestricted min Via7 edge-to-edge space (non-SA edges)
   V7_29:double = 0.068; // Via7 min edge offset if corner-to-corner space is less than V7_30
   V7_30:double = 0.228; // Via7 corner-to-corner space limit for V7_29
   V7_32:double = 0.047; // Via7 to Via6 space (on different Metal7, all-directional check)
   V7_33:double = 0.047; // Via7 edge space to Metal7
   ...
   V7_49:double = 0.028; // Metal7 line-end enclosure of Via7
   V7_51:double = 0; // Both opposite edges of a aligned via (Via7A/B/F) must be metal aligned
   V7_52:double = 0; // M8 enclosure of Via7C/D/E (one edge at a corner)
   V7_53:double = 0.028; // M8 line-end enclosure of Via7C/D/E, orthogonal edge
   V7_54:double = 0.028; // Metal8 concave corner space to Via7A/B/F
   V7_61:double = 0.028; // Metal8 line-end enclosure of Via7A/B/F 
   ...
   V8_01:double = 0.14; // Square Via8 size ONLY ALLOWED value
   V8_02:double = 0.356; // Square Via8 to Square Via8 (center-to-center) separation
   V8_101:double = 0.11; // Square Via8SA ONLY ALLOWED value
   V8_11:double = 0.007; // Maximum Square Via8 overhang of Metal8
   V8_12:double = 0.04; // M8 enclosure of Square Via8, orthogonal edge
   ...
   V8_153:double = 0; // A Rectangular Via8 that overhangs an M8 edge is only allowed on OGD M8 and must be centered on the OGD M8 line.
   V8_21:double = 0.21; // Square Via8 to Via7 (square/rectangular) space (on different M8 net, all-directional check)
   V8_31:double = 0.14; // Rectangular Via8 width, ONLY ALLOWED value
   V8_32:double = 0.28; // Rectangular Via8 length, ONLY ALLOWED value
   V8_33:double = 0.275; // Rectangular Via8 Long edge facing space to Square or Rectangular Via8 
   ...
   V8_40:double = 0; // Redundant Rectangular Via8s must be aligned with each other
   V8_41:double = 0.21; // Rectangular Via8 to Via7 (square/rectangular) space (on different M8 net, all-directional check)
   V8_51:double = 0; // M8 enclosure of Rectangular Via8 (one edge at a corner)
   V8_52:double = 0.04; // M8 enclosure of Rectangular Via8, orthogonal edge
   V8_53:double = 0.018; // Max extent of Rectangular Via8 short edge beyond M8 side
   V8_61:double = 0.007; // Max extent of Square Via8 edge beyond M9 edge
   V8_62:double = 0.04; // M9 coverage of Square Via8 orthogonal edge
   V8_71:double = 0.02; // Max extent of Rectangular Via8 long edge beyond M9 edge
   V8_72:double = 0.04; // M9 coverage of Rectangular Via8 short edge, minimum
   ...
   V8err_131:double = 0.11; // Rectangular Via8RA width, ONLY ALLOWED value
   V8err_132:double = 0.22; // Rectangular Via8RA length, ONLY ALLOWED value
   ...
   V9_01:double = 0.44; // Square Via9 size ONLY ALLOWED value
   V9_02:double = 1.115; // Square Via9 to Square Via9 (center-to-center) separation
   V9_11:double = 0.08; // M9 enclosure of Square Via9
   V9_12:double = 0.08; // M9 enclosure of Square Via9, orthogonal edge
   V9_21:double = 0.21; // Square Via9 to Via8 (square/rectangular) space (on different M9 net, all-directional check)
   V9_31:double = 0.44; // Rectangular Via9 width, ONLY ALLOWED value
   V9_32:double = 0.88; // Rectangular Via9 length, ONLY ALLOWED value
   V9_33:double = 0.64; // Rectangular Via9 space to Via9 (square/rectangular, includes all combinations of long edges, short edges, and corners), all-directional check
   V9_34:double = 3.7; // Via9C length, fixed value
   V9_35:double = 0.212; // Rectangular Via9 Corner-to-corner space to Square or Rectangular Via9 
   V9_39:double = 0.16; // Redundant Rectangular Via9 spacing between facing Long edges, for electrically shorted vias, fixed value  (note this is an allowed exception to V9_33)
   V9_40:double = 2; // Via9 to Via9 space (all directions)
   V9_41:double = 2.5; // Via9 to Via9 corner-to-corner space
   V9_51:double = 0.08; // M9 enclosure of Rectangular Via9
   V9_52:double = 0.08; // M9 enclosure of Rectangular Via9, orthogonal edge
   V9_61:double = 0.007; // Max extent of Square Via9 edge beyond M10 edge
   V9_62:double = 0.04; // M10 coverage of Square Via9 orthogonal edge
   V9_71:double = 0.02; // Max extent of Rectangular Via9 long edge beyond M10 edge
   V9_72:double = 0.04; // M10 coverage of Rectangular Via9 short edge, minimum
   ...
   VC_134:double = 0.036; // The TCN line end that has the VC_34 overhang needs to have a TCN ETE space of =VC_134, also note this line end falls of the 21nm TCN line end grid by 6nm) 
   ...
   VC_22:double = 0.089; // Unrestricted VCNAX-to-VCNAX center-to-center space
   VC_23:double = 0.028; // Parallel full-facing metal-aligned VCN edges can be as closely spaced as the minimum allowed M0 space.  (merged via)
   ...
   VC_36:double = 0.026; // VCN space to Diffcon, PGD
   VC_37:double = 0.034; // VCN space to Diffcon, OGD
   VC_38:double = 0.026; // VCN PGD offset from Diffcon line-end, if corner-to-corner space is < VC_37
   ...
   VC_44:double = 0.026; // VCN edge space to Polycon side (PGD)
   VC_46:double = 0.038; // VCN edge space to Polycon end (OGD)
   VC_47:double = 0.024; // max VCNHB (SA edge) OGD edge enclosure of Polycon side (PGD)
   VC_48:double = 0.026; // VCN to Polycon PGD offset, if VCN-Polycon corners are < VC_46
   VC_49:double = 0.028; // VCNHC edge space to Polycon side (PGD)
   VC_51:double = 0; // VCNHB/HC can be under a M0L_03/04 line
   VC_61:double = 0.022; // Minimum M0 line end enclosure of VCN
   VC_70:double = 0.039; // VCN corner-to-corner space
   VD_07:double = 0.46; // Via7 space threshold that subjects the array to max area check
   VD_08:double = 0.46; // Via8 space threshold that subjects the array to max area check
   VD_09:double = 1.35; // Via9 space threshold that subjects the array to max area check
   VD_10:double = 0.46; // Via9 space threshold that subjects the array to max area check
   VD_11:double = 1.35; // Via10 space threshold that subjects the array to max area check
   VD_17:double = 0.838; // Via 7 array width exception limit
   VD_18:double = 0.838; // Via 8 array width exception limit
   VD_19:double = 0.838; // Via 9 array width exception limit
   VD_20:double = 0.838; // Via 9 array width exception limit
   VD_21:double = 0.838; // Via 10 array width exception limit
   ...
   VD_30:double = 47.47; // Maximum Via 9 array area after merge and exception
   VD_31:double = 47.47; // Maximum Via 10 array area after merge and exception
   ...
   VD_60:double = 18.4; // Max width of merged Via 9 array
   VD_61:double = 18.4; // Max width of merged Via 10 array
   ...
   XG_06:double = 0.039; // XGOXID enclosure of poly end,  in PGD
   XG_07:double = 0.039; // XGOXID space to poly end,  in PGD
   ...
   drHash:typeHashString2String = { 
      ...
      xc(APC_42) => "Polycon end overlap of poly for PC_41",
      xc(APC_44) => "Polycon end space to poly side",
      ...
      xc(APL_25) => "Poly end space to diffusion PGD",
      ...
      xc(BLDI_102) => "Max allowed INTERMEDIATE Exposed N-diffusion density (%), within a 245um x 245um window size (RF X73Aonly)",
      ...
      xc(BU_21) => "Width of outer ring from EOA that requires additional rules",
      ...
      xc(CD_105) => "Minimum concentrated local Metal 5 density (%), within a 2.1um x 2.1um window size",
      ...
      xc(CD_205) => "Maximum concentrated local Metal 5 density (%), within a 3.15um x 3.15um window size",
      ...
      xc(DA_03) => "Any transition regions to transition region space OGD",
      ...
      xc(DA_31) => "Poly fixed layout comparison for Digital-to-TGULV Transition Ring",
      ...
      xc(DC_05) => "Max allowed space between any Diffcon or Polycon edges, in the smaller of either direction",
      ...
      xc(DC_23) => "Minimum space on both sides of the isolated diffcon",
      xc(DC_24) => "Minimum space from atleast one end of the isolated diffcon",
      ...
      xc(DF_56) => "Tap PGD/OGD edges must follow standard diffusion rules",
      xc(DF_80) => "Every diffusion should have a TCN",
      xc(DF_84) => "Tap to Transistor diffusion space PGD (within same well)",
      xc(DG_01) => "Diffusion check grid width (fixed value)",
      xc(DG_02) => "Diffusion check grid space (fixed value)",
      xc(DG_03) => "Minimum Diffusion check grid length",
      ...
      xc(DN_01) => "DN_01 deep n-well width ",
      xc(DN_02) => "DN_02 deep n-well space ",
      xc(DN_03) => "DN_03 deep n-well overlap of n-well ",
      xc(DN_04) => "DN_04 extension of n-well beyond deep n-well ",
      xc(DN_05) => "DN_05 deep n-well space to n-well outside ",
      xc(DN_07) => "DN_07 deep n-well enclosure of p-gates ",
      xc(DN_08) => "DN_08 deep n-well space to p-gates outside the deep nwell ",
      xc(DN_09) => "DN_09 deep n-well space to BJTID, CAPID or wellResID ",
      xc(DN_10) => "DN_10 The isolated pwell inside the deep nwell must have a pwell tap (ptap) ",
      xc(DN_11) => "DN_11 Max distance from N+ active diff inside DNW to a ptap connected to Vss ",
      xc(DN_12) => "DN_12 Max distance from N+ active diff (inside DNW) to ntap in nwell (connected to DNW) connected to Vcc* ",
      xc(DN_13) => "DN_13 deep n-well space to diffusions outside (active or tap) ",
      ...
      xc(DT_03) => "Any transition regions to transition region space OGD",
      ...
      xc(DT_31) => "Poly fixed layout comparison for Digital-to-TG Transition Ring",
      ...
      xc(DX_03) => "Any transition regions to transition region space OGD",
      ...
      xc(DX_31) => "Poly fixed layout comparison for Digital-to-ULP Transition Ring",
      ...
      xc(EA_01) => "Edge-of-Active (EOA) PGD length must be a whole multiple of",
      xc(EA_02) => "Edge-of-Active (EOA) OGD length must be a whole multiple of",
      ...
      xc(EHV_01) => "Polycon space to Diffcon",
      xc(EHV_02) => "VCN space to Diffcon (PGD)",
      xc(EHV_04) => "VCN space to polycon (PGD)",
      ...
      xc(ENW_14) => "N-well space",
      xc(ENW_21) => "N+ active diffusion space to extra high voltage nwells",
      xc(ENW_22) => "P+ active diffusion enclosure by extra high voltage nwell",
      ...
      xc(HNW_14) => "N-well space",
      xc(HNW_21) => "N+ active diffusion space to high voltage nwells",
      xc(HNW_22) => "P+ active diffusion enclosure by high voltage nwell",
      xc(HV_01) => "Polycon space to Diffcon",
      xc(HV_02) => "VCN space to Diffcon (PGD)",
      xc(HV_04) => "VCN space to polycon (PGD)",
      ...
      xc(IPD_203) => "Via2 ",
      xc(IPD_204) => "Via3 ",
      xc(IPD_205) => "Via4 (non vcc nodes)",
      xc(IPD_206) => "Via5 (non vcc nodes)",
      xc(IPD_207) => "Via6 (non vcc nodes)",
      xc(IPD_208) => "Via7 (non vcc nodes)",
      xc(IPD_209) => "Via8 (non vcc nodes)",
      xc(IPD_210) => "Via9 (non vcc nodes)",
      xc(IPD_211) => "Via10 (non vcc nodes)",
      xc(IPD_212) => "Via11 (non vcc nodes)",
      xc(IPD_300) => "ViaCN",
      xc(IPD_301) => "Via0",
      xc(IPD_302) => "Via1 ",
      xc(IPD_303) => "Via2 ",
      xc(IPD_304) => "Via3 ",
      xc(IPD_305) => "Via4 (non vcc nodes)",
      xc(IPD_306) => "Via5 (non vcc nodes)",
      xc(IPD_307) => "Via6 (non vcc nodes)",
      xc(IPD_308) => "Via7 (non vcc nodes)",
      xc(IPD_309) => "Via8 (non vcc nodes)",
      xc(IPD_310) => "Via9 (non vcc nodes)",
      xc(IPD_311) => "Via10 (non vcc nodes)",
      xc(IPD_312) => "Via11 (non vcc nodes)",
      ...
      xc(IPG_01) => "Limit Ratio of Metal or GCN+TCNarea to uv1/uv2/nal N-transistors",
      ...
      xc(IPG_04) => "Limit Ratio of Metal or GCN+TCNarea to uv1/uv2/nal inverter with sub-tap Ze (smaller of N/P Z)  (um^2 /um)",
      ...
      xc(IPG_301) => "Limit Ratio of TV1 area to uv1/uv2/nal N-transistors",
      ...
      xc(IPG_304) => "Limit Ratio of TV1 area to uv1/uv2/nal inverter with sub-tap Ze (smaller of N/P Z)  (um^2 /um)",
      ...
      xc(LDI_505) => "Min Intermediate Metal 5 density (%) relative to actual global Metal 5 density, within a 70um x 70um window size. ",
      ...
      xc(LD_105) => "Min required local Metal 5 density (%), within a 25um x 25um window size",
      ...
      xc(LD_110) => "Min required local Metal 10 density (%), within a 25um x 25um window size",
      xc(LD_111) => "Min required local Metal 11 density (%), within a 25um x 25um window size",
      ...
      xc(LD_205) => "Max allowed local Metal 5 density (%), within a 9um x 9um window size",
      ...
      xc(LD_210) => "Max allowed local Metal 10 density (%), within a 9um x 9um window size",
      xc(LD_211) => "Max allowed local Metal 11 density (%), within a 9um x 9um window size",
      ...
      xc(LD_508) => "Min required local Via8 density (%), within a 11um x 11um window size",
      xc(LD_509) => "Min required local Via9 density (%), within a 11um x 11um window size",
      xc(LD_510) => "Min required local Via10 density (%), within a 53um x 53um window size",
      xc(LD_511) => "Min required local Via11 density (%), within a 53um x 53um window size",
      ...
      xc(LD_610) => "Max required local Via10 density (%), within a 53um x 53um window size",
      ...
      xc(LD_81) => "Min required local RDL density (%), 120um x 120um window size",
      ...
      xc(LMI_04) => "Separation of LMI arrays, orthogonal to TSV spine",
      xc(LMI_05) => "Separation of LMI arrays, parallel to TSV spine",
      xc(LMI_06) => "RDL (217;0), RDLPAD (217;40 or 217;47) enclosure of LMI (all sides), fixed",
      xc(LMI_07) => "Cantilever LMI pads will not extend beyond the square that encloses the standard LMI array",
      xc(LMI_08) => "Cantilever LMI pads must be centered with the standard LMI array along the central axis",
      xc(LMI_09) => "Cantilever LMI pad array width (number of pad), only allowed value in OGD",
      xc(LMI_10) => "Cantilever LMI pad array height (number of pads), only allowed value in PGD",
      ...
      xc(LMI_14) => "LMI array edge distance to active die edge (EOA) (orthogonal to spine)",
      ...
      xc(M0_126) => "(B:28-32),(C:54-80)",
      xc(M0_127) => "(B:36-60),(C:78-80)",
      xc(M0_128) => "(B:78-80),(C:28)",
      xc(M0_129) => "(B),(B)",
      xc(M0_130) => "(C),(C)",
      ...
      xc(M0_137) => "(B:28-32),(C:42-80),(B:28-48)",
      xc(M0_138) => "(B:28-32),(C:28,48-80),(B:54-60)",
      xc(M0_139) => "(B:28-32),(C:28,54-80),(B:78-80)",
      xc(M0_140) => "(B:36-48),(C:54-80),(B:36-48)",
      xc(M0_141) => "(B:36-60),(C:28,78-80),(B:54-80)",
      xc(M0_142) => "(B:78-80),(C:28),(B:78-80)",
      ...
      xc(M0_812) => "Metal0 line-end overlap of TG poly, fixed value 1 (M0 line ends must terminate within the poly)",
      xc(M0_813) => "Metal0 line-end overlap of TG poly, fixed value 2 (M0 line ends must terminate within the poly)",
      xc(M0_814) => "Metal0 line-end overlap of TG poly, fixed value 3 (M0 line ends must terminate within the poly)",
      xc(M0_82) => "Metal0 line-end overlap of poly, fixed value (M0 line ends must terminate within the poly)",
      xc(M0_822) => "Metal0 line-end overlap of TGULV poly, fixed value 1 (M0 line ends must terminate within the poly)",
      xc(M0_823) => "Metal0 line-end overlap of TGULV poly, fixed value 2 (M0 line ends must terminate within the poly)",
      ...
      xc(M10_00) => "Only Rectangular M10 shape is allowed for width_01 and width_03/05/06/09/10 shield wires.",
      xc(M10_01) => "M10 width",
      xc(M10_02) => "M10 space",
      xc(M10_03) => "width_03 value (OGD/PGD)",
      xc(M10_04) => "width_04 value (OGD only)",
      ...
      xc(M10_121) => "width_06 to width_06 space, fixed space exception",
      xc(M10_20) => "width_01 wire cannot be sandwiched between two width_03/05/06/09/10 wires at min space on both sides",
      xc(M10_21) => "Maximum allowed M10 width",
      xc(M10_22) => "Min required M10 hole area (sq um)",
      xc(M10_23) => "Minimum length of at least one M10 segment, when two segments are adjacent at a corner",
      xc(M10_24) => "Min required M10 length/extent",
      xc(M10_35) => "width_02/03 to width_02/03 space, min unrestricted",
      xc(M10_37) => "max edge lengths that can violate the forbidden spaces if space between the edges is >=M10_38",
      xc(M10_38) => "width_01-10 to width_01-10 unrestricted space (min) ",
      xc(M10_41) => "M10 coverage of Square Via9 (one edge at a corner)",
      xc(M10_42) => "Metal10 end-to-end space width_01 line to any line (min)",
      xc(M10_43) => "M10 coverage of Square Via9 orthogonal edge",
      xc(M10_50) => "width_02/03 attacker (PGD) to width_01 victim (OGD) is not allowed.  Width_01 victim must be shielded (physically) by parallel rectangular-only width_03/05/06/09/10 wire.",
      xc(M10_51) => "M10 coverage of Rectangular Via9 (one edge at a corner)",
      xc(M10_52) => "M10 coverage of Rectangular Via9 orthogonal edge",
      ...
      xc(M10_80) => "Corner-to-corner space, when corners have no overlap",
      xc(M10_81) => "Internal corner-to-corner width ",
      xc(M10_82) => "Width between facing concave corner extensions of opposite directions ",
      ...
      xc(M11_01) => "M11 width",
      xc(M11_02) => "M11 space",
      xc(M11_21) => "Maximum allowed M11 width",
      xc(M11_22) => "Min required M11 hole area (sq um)",
      xc(M11_23) => "Minimum length of at least one M11 segment, when two segments are adjacent at a corner",
      xc(M11_24) => "Min required M11 length/extent",
      xc(M11_41) => "M11 coverage of Square Via10 (one edge at a corner)",
      xc(M11_43) => "M11 coverage of Square Via10 orthogonal edge",
      xc(M11_51) => "M11 coverage of Rectangular Via10 (one edge at a corner)",
      xc(M11_52) => "M11 coverage of Rectangular Via10 orthogonal edge",
      ...
      xc(M1_01) => "width_01 value, PGD only",
      xc(M1_100) => "M1 width_02 is only allowed inside ULPpitchID",
      xc(M1_101) => "width_02 value, PGD only",
      xc(M1_21) => "width_01 to width_01 or width_02 to width_02 space1 (fixed value, minimum)",
      ...
      xc(M1_36) => "Maximum space (OGD/PGD) (<)",
      ...
      xc(M1_69) => "A short line < M1_69 long cannot have exposed edges >M1_85 on one side or both sides",
      ...
      xc(M2BB_22) => "(B) - (B) unrestricted space (multi track skip) (M2BB_31/M2BB_32 is the exception to this rule)",
      xc(M2BB_31) => "(B) - (B) min unrestricted space (>)",
      xc(M2BB_32) => "(B) - (B) max unrestricted space (<)",
      xc(M2BB_33) => "Min width of B line next to the unrestricted space",
      xc(M2BB_34) => "Min width of C line next to the above B line next to the unrestricted space",
      xc(M2BB_35) => "The above B line next to the unrestricted space needs to be floating (no vias above or below)",
      xc(M2BB_36) => "Maximum space (PGD) (<)",
      xc(M2BB_37) => "Maximum space (OGD) (<)",
      xc(M2BB_38) => "Min PGD space between unrestricted spaces",
      xc(M2BC_21) => "(B) to (C-B) unrestricted space (multi track skip)",
      ...
      xc(M2CC_27) => "(B-C) to (C-B) unrestricted space (multi track skip)",
      xc(M2CC_28) => "For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)",
      ...
      xc(M2_126) => "(B:28-36),(C:60-84)",
      xc(M2_127) => "(B:38-46),(C:84)",
      xc(M2_128) => "(B:56-84),(C:28-36)",
      xc(M2_129) => "(B),(B)",
      xc(M2_130) => "(C),(C)",
      ...
      xc(M2_136) => "(B:28-36),(C:56-84),(B:28-36)",
      xc(M2_137) => "(B:28-46),(C:60-84),(B:38-46)",
      xc(M2_138) => "(B:28-36),(C:28-36,60-84),(B:56-84)",
      xc(M2_139) => "(B:38-46),(C:28-36,84),(B:56-84)",
      xc(M2_140) => "(B:56-84),(C:28-36),(B:56-84)",
      xc(M2_141) => "(B:28),(C:56),(B:76)",
      xc(M2_147) => "Width <= 32nm (M2S_03), need line end offset on sides >= M2_147",
      xc(M2_148) => "32nm (M2S_03) < Width <= 46nm (M2M_03), need line end offset on sides >= M2_148",
      xc(M2_20) => "Line end are extended by M2_20 before doing any side to side space checks",
      xc(M2_21) => "B to C min space",
      ...
      xc(M2_37) => "max edge lengths that can violate the forbidden spaces if space  between the edges is >=M2_38",
      xc(M2_38) => "Unrestricted space (min) ",
      ...
      xc(M2_44) => "All line ends for widths <= M2_45 must be a aligned or covered at M2_46 space ",
      xc(M2_45) => "Max widths for M2_44 check ",
      xc(M2_46) => "Space at which the line ends must be aligned or covered ",
      xc(M2_47) => "Lines <= M2_45 wide cannot be isolated, must be next to another narrow or wide line ",
      xc(M2_48) => "Minimum overlap of line ends in opposite directions at minimum space",
      xc(M2_49) => "Minimum offset of line ends in opposite directions (line ends are extended by M2_43), applies to > M2_45 wide wires",
      ...
      xc(M3BB_22) => "(B) - (B) unrestricted space (multi track skip) (M3BB_31/M3BB_32 is the exception to this rule)",
      xc(M3BB_31) => "(B) - (B) min unrestricted space (>)",
      xc(M3BB_32) => "(B) - (B) max unrestricted space (<)",
      xc(M3BB_33) => "Min width of B line next to the unrestricted space",
      xc(M3BB_34) => "Min width of C line next to the above B line next to the unrestricted space",
      xc(M3BB_35) => "The above B line next to the unrestricted space needs to be floating (no vias above or below) ",
      xc(M3BB_36) => "Maximum space (OGD) (<)",
      xc(M3BB_37) => "Maximum space (PGD) (<)",
      xc(M3BB_38) => "Min OGD space between unrestricted spaces",
      xc(M3BC_21) => "(B) to (C-B) unrestricted space (multi track skip)",
      ...
      xc(M3CC_27) => "(B-C) to (C-B) unrestricted space (multi track skip)",
      xc(M3CC_28) => "For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)",
      ...
      xc(M3_126) => "(B:28-36),(C:60-84)",
      xc(M3_127) => "(B:40-46),(C:84)",
      xc(M3_128) => "(B:56-84),(C:28-36)",
      xc(M3_129) => "(B),(B)",
      xc(M3_130) => "(C),(C)",
      ...
      xc(M3_136) => "(B:28-36),(C:56-84),(B:28-36)",
      xc(M3_137) => "(B:28-46),(C:60-84),(B:40-46)",
      xc(M3_138) => "(B:28-36),(C:28-36,60-84),(B:56-84)",
      xc(M3_139) => "(B:40-46),(C:28-36,84),(B:56-84)",
      xc(M3_140) => "(B:56-84),(C:28-36),(B:56-84)",
      xc(M3_141) => "(B:28),(C:56),(B:76)",
      xc(M3_142) => "(B:38-52),(C:82-84),(B:56-84)",
      xc(M3_143) => "(B:56-84),(C:32-36),(B:56-84)",
      xc(M3_147) => "Width <= 32nm (M3S_03), need line end offset on sides >= M3_147",
      xc(M3_148) => "32nm (M3S_03) < Width <= 46nm (M3M_03), need line end offset on sides >= M3_148",
      xc(M3_20) => "Line end are extended by M3_20 before doing any side to side space checks",
      xc(M3_21) => "B to C min space",
      ...
      xc(M3_37) => "max edge lengths that can violate the forbidden spaces if space  between the edges is >=M3_38",
      xc(M3_38) => "Unrestricted space (min) ",
      ...
      xc(M3_45) => "Max widths for M3_44 check ",
      xc(M3_46) => "Space at which the line ends must be aligned or covered ",
      xc(M3_47) => "Lines <= M3_45 wide cannot be isolated, must be next to another narrow or wide line ",
      xc(M3_48) => "Minimum overlap of line ends in opposite directions at minimum space",
      xc(M3_49) => "Minimum offset of line ends in opposite directions (line ends are extended by M3_43), applies to > M3_45 wide wires",
      ...
      xc(M4BB_22) => "(B) - (B) unrestricted space (multi track skip) (M4BB_31/M4BB_32 is the exception to this rule)",
      xc(M4BB_31) => "(B) - (B) min unrestricted space (>)",
      xc(M4BB_32) => "(B) - (B) max unrestricted space (<)",
      xc(M4BB_33) => "Min width of B line next to the unrestricted space",
      xc(M4BB_34) => "Min width of C line next to the above B line next to the unrestricted space",
      xc(M4BB_35) => "The above B line next to the unrestricted space needs to be floating (no vias above or below) ",
      xc(M4BB_36) => "Maximum space (PGD) (<)",
      xc(M4BB_37) => "Maximum space (OGD) (<)",
      xc(M4BB_38) => "Min PGD space between unrestricted spaces",
      xc(M4BC_21) => "(B) to (C-B) unrestricted space (multi track skip)",
      ...
      xc(M4CC_27) => "(B-C) to (C-B) unrestricted space (multi track skip)",
      xc(M4CC_28) => "For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)",
      ...
      xc(M4_126) => "(B:28-36),(C:60-84)",
      xc(M4_127) => "(B:40-46),(C:84)",
      xc(M4_128) => "(B:54-84),(C:28-36)",
      xc(M4_129) => "(B),(B)",
      xc(M4_130) => "(C),(C)",
      ...
      xc(M4_136) => "(B:28-36),(C:54-84),(B:28-36)",
      xc(M4_137) => "(B:28-46),(C:60-84),(B:40-46)",
      xc(M4_138) => "(B:28-36),(C:28-36,60-84),(B:54-84)",
      xc(M4_139) => "(B:40-46),(C:28-36,84),(B:54-84)",
      xc(M4_140) => "(B:54-84),(C:28-36),(B:54-84)",
      xc(M4_141) => "(B:28),(C:56),(B:76)",
      xc(M4_142) => "(B:28),(C:54),(B:76)",
      xc(M4_147) => "Width <= 32nm (M4S_03), need line end offset on sides >= M4_147",
      xc(M4_148) => "32nm (M4S_03) < Width <= 46nm (M4M_03), need line end offset on sides >= M4_148",
      xc(M4_20) => "Line end are extended by M4_20 before doing any side to side space checks",
      xc(M4_21) => "B to C min space",
      ...
      xc(M4_23) => "width_02 to width_02 space range min",
      ...
      xc(M4_37) => "max edge lengths that can violate the forbidden spaces if space  between the edges is >=M4_38",
      xc(M4_38) => "Unrestricted space (min) ",
      ...
      xc(M4_45) => "Max widths for M4_44 check ",
      xc(M4_46) => "Space at which the line ends must be aligned or covered ",
      xc(M4_47) => "Lines <= M4_45 wide cannot be isolated, must be next to another narrow or wide line ",
      xc(M4_48) => "Minimum overlap of line ends in opposite directions at minimum space",
      xc(M4_49) => "Minimum offset of line ends in opposite directions (line ends are extended by M4_43), applies to > M4_45 wide wires",
      ...
      xc(M5BB_22) => "(B) - (B) unrestricted space (multi track skip) (M5BB_31/M5BB_32 is the exception to this rule)",
      xc(M5BB_31) => "(B) - (B) min unrestricted space (>)",
      xc(M5BB_32) => "(B) - (B) max unrestricted space (<)",
      xc(M5BB_33) => "Min width of B line next to the unrestricted space",
      xc(M5BB_34) => "Min width of C line next to the above B line next to the unrestricted space",
      xc(M5BB_35) => "The above B line next to the unrestricted space needs to be floating (no vias above or below) ",
      xc(M5BB_36) => "Maximum space (OGD) (<)",
      xc(M5BB_37) => "Maximum space (PGD) (<)",
      xc(M5BB_38) => "Min OGD space between unrestricted spaces",
      xc(M5BC_21) => "(B) to (C-B) unrestricted space (multi track skip)",
      ...
      xc(M5CC_27) => "(B-C) to (C-B) unrestricted space (multi track skip)",
      xc(M5CC_28) => "For width <= 36 C to any C, in (B-C) - (C-B) pair, unrestricted space (multi track skip)",
      ...
      xc(M5_06) => "width_06 value (PGD/OGD)",
      xc(M5_07) => "width_07 value (PGD only)",
      xc(M5_08) => "width_08 value (PGD only)",
      xc(M5_126) => "(B:28-36),(C:60-84)",
      xc(M5_127) => "(B:40-46),(C:84)",
      xc(M5_128) => "(B:56-84),(C:28-36)",
      xc(M5_129) => "(B),(B)",
      xc(M5_130) => "(C),(C)",
      xc(M5_131) => "(B:28-36),(C:28-46),(B:28-36)",
      xc(M5_132) => "(B:28-46),(C:28-56),(B:40-46)",
      xc(M5_133) => "(B:28-36),(C:40-56),(B:56-84)",
      xc(M5_134) => "(B:40-46),(C:40-76),(B:56-84)",
      xc(M5_135) => "(B:56-84),(C:40-84),(B:56-84)",
      xc(M5_136) => "(B:28-36),(C:56-84),(B:28-36)",
      xc(M5_137) => "(B:28-46),(C:60-84),(B:40-46)",
      xc(M5_138) => "(B:28-36),(C:28-36,60-84),(B:56-84)",
      xc(M5_139) => "(B:40-46),(C:28-36,84),(B:56-84)",
      xc(M5_140) => "(B:56-84),(C:28-36),(B:56-84)",
      xc(M5_141) => "(B:28),(C:56),(B:76)",
      xc(M5_147) => "Width <= 32nm (M5S_03), need line end offset on sides >= M5_147",
      xc(M5_148) => "32nm (M5S_03) < Width <= 46nm (M5M_03), need line end offset on sides >= M5_148",
      xc(M5_20) => "Line end are extended by M5_20 before doing any side to side space checks",
      xc(M5_21) => "B to C min space",
      xc(M5_22) => "Every C line should have an adjacent B line at M5_21 space on atleast one side, along its entire length (allowed to have M5_42 ETE gaps)",
      xc(M5_23) => "width_02 to width_02-06 space range min",
      xc(M5_24) => "width_02 to width_02-06 space range max",
      xc(M5_25) => "width_03-08 to width_03-08 unrestricted space min",
      xc(M5_26) => "width_07/08 to width_00/01/02 space range min",
      xc(M5_27) => "width_07/08 to width_00/01/02 space range max",
      xc(M5_28) => "Width_00 to width_05/06 space exception (fixed value)",
      xc(M5_35) => "width_06 to width_06 unrestricted space (min)",
      xc(M5_37) => "max edge lengths that can violate the forbidden spaces if space  between the edges is >=M5_38",
      xc(M5_38) => "Unrestricted space (min) ",
      xc(M5_41) => "End-to-end space (min), when line-ends are completely aligned and lines are same type (B-B, C-C)",
      ...
      xc(M5_44) => "All line ends for widths <= M5_45 must be a aligned or covered at M5_46 space ",
      xc(M5_45) => "Max widths for M5_44 check ",
      xc(M5_46) => "Space at which the line ends must be aligned or covered ",
      xc(M5_47) => "Lines <= M5_45 wide cannot be isolated, must be next to another narrow or wide line ",
      xc(M5_48) => "Minimum overlap of line ends in opposite directions at minimum space",
      xc(M5_49) => "Minimum offset of line ends in opposite directions (line ends are extended by M5_43), applies to > M5_45 wide wires",
      xc(M5_51) => "Width_06 attacker to width_00-08 victim min space",
      xc(M5_52) => "Width_00-08 attacker to width_06 victim min space",
      xc(M5_60) => "Min length of M5 line (any type, any width)",
      ...
      xc(M5_72) => "segments can be smaller than M5_70 if both adjacent segments are >= M5_73",
      xc(M5_73) => "Minimum segment lengths for M5_72",
      xc(M5_74) => "M5_72 segment to line end space",
      xc(M5_80) => "Corner-to-corner space, when corners have no overlap",
      xc(M5_81) => "Internal corner-to-corner width ",
      xc(M5_82) => "Width between facing concave corner extensions of opposite directions ",
      xc(M5_83) => "Min width of notched line section",
      xc(M5_84) => "Above rule applies to notch length less than",
      ...
      xc(M6_153) => "Minimum overlap of the line ends forming the ETE space (>=)",
      xc(M6_16) => "width_13/14/15 must be rectangles only (no jog or junction allowed)",
      xc(M6_160) => "Minimum overlap of Width_04 line end with an adjacent line in the opposite direction, if the ETE space of the width_04 line is = M6_161 ",
      xc(M6_161) => "Maximum ETE space for M6_160 (=)",
      xc(M6_162) => "Minimum overlap of Width_04 line end with an adjacent line in the opposite direction, if the ETE space of the width_04 line is > M6_161 ",
      ...
      xc(M6_44) => "Width_01/02 to width_01-15 end-to-end space if overlap between facing ends is < M6_45 (min)",
      xc(M6_45) => "Overlap between facing line ends",
      xc(M6_46) => "Length of unfaced edge of a width_01-07/12 line (max value)",
      xc(M6_47) => "ETE space between a <=M6_03 line and a <=M6_07 line, when the line ends are not facing each other (The line ends of the <=M6_03 wide lines are extended by M6_48 prior to this check)",
      xc(M6_48) => "Line end extensions of the <=M6_3 wide line for M6_47 check",
      ...
      xc(M6_72) => "segments can be smaller than M6_70 if both adjacent segments are >= M6_73",
      xc(M6_73) => "Minimum segment lengths for M6_72",
      xc(M6_80) => "Corner-to-corner space, when corners have no overlap",
      xc(M6_81) => "Internal corner-to-corner width ",
      xc(M6_82) => "Width between facing concave corner extensions of opposite directions ",
      xc(M6_83) => "Min width of notched line section",
      xc(M6_84) => "Above rule applies to notch length less than",
      ...
      xc(M7_37) => "max edge lengths that can violate the forbidden spaces if space  between the edges is >=M7_38",
      xc(M7_38) => "width_01/02/03/04/05/06/07 to width_01/02/03/04/05/06/07 unrestricted space (min) ",
      ...
      xc(M7_71) => "Minimum lengths of at least one segment, when both adjacent at a corner",
      xc(M7_72) => "segments can be smaller than M7_70 if both adjacent segments are >= M7_73",
      xc(M7_73) => "Minimum segment lengths for M7_72",
      xc(M7_74) => "M7_72 segment to line end space",
      xc(M7_80) => "Corner-to-corner space, when corners have no overlap",
      xc(M7_81) => "Internal corner-to-corner width ",
      xc(M7_82) => "Width between facing concave corner extensions of opposite directions ",
      xc(M7_83) => "Min width of notched line section",
      xc(M7_84) => "Above rule applies to notch length less than",
      ...
      xc(M8_00) => "Only Rectangular M8 shape is allowed for width_01 and width_03/05/06/09/10 shield wires.",
      xc(M8_01) => "width_01 value (OGD only)",
      xc(M8_02) => "width_02 value (OGD/PGD)",
      ...
      xc(M8_121) => "width_06 to width_06 space, fixed space exception",
      xc(M8_20) => "width_01 wire cannot be sandwiched between two width_03/05/06/09/10 wires at min space on both sides",
      xc(M8_21) => "width_01 to width_01/03/05/06/09/10 space, fixed space1",
      xc(M8_22) => "width_01 to width_01/03/05/06/09/10 space, fixed space2",
      xc(M8_23) => "width_01 to width_01/03/05/06/09/10 space, fixed space3",
      xc(M8_24) => "width_02-10 to width_02-10 space, min unrestricted",
      xc(M8_25) => "width_00 to width_00-09 unrestricted space min",
      xc(M8_26) => "width_00 to width_07-09 space range1 min",
      xc(M8_27) => "width_00 to width_07-09 space range1 max",
      xc(M8_32) => "width_02-09 to width_02-09 unrestricted space (min)",
      xc(M8_35) => "width_02/03 to width_02/03 space, min unrestricted",
      xc(M8_37) => "max edge lengths that can violate the forbidden spaces if space between the edges is >=M8_38",
      xc(M8_38) => "width_01-10 to width_01-10 unrestricted space (min) ",
      xc(M8_41) => "Metal8 end-to-end space (min)",
      xc(M8_42) => "Metal8 end-to-end space width_01 line to any line (min)",
      ...
      xc(M8_51) => "OGD/PGD attacker to victim unrestricted space (min)",
      xc(M8_52) => "Width_01 attacker to victim unrestricted space (min)",
      xc(M8_60) => "Min length for all widths",
      xc(M8_65) => "Min required M8 hole area (sq um)",
      ...
      xc(M8_80) => "Corner-to-corner space, when corners have no overlap",
      xc(M8_81) => "Internal corner-to-corner width ",
      xc(M8_82) => "Width between facing concave corner extensions of opposite directions ",
      xc(M8_83) => "Min width of notched line section",
      xc(M8_84) => "Above rule applies to notch length less than",
      ...
      xc(M9_00) => "Only Rectangular M9 shape is allowed for width_01 and width_03/05/06/09/10 shield wires.",
      xc(M9_01) => "width_01 value (PGD only)",
      xc(M9_02) => "width_02 value (OGD/PGD)",
      xc(M9_03) => "width_03 value (OGD/PGD)",
      xc(M9_04) => "width_04 value (PGD only)",
      ...
      xc(M9_10) => "width_10 value (PGD only)",
      xc(M9_121) => "width_06 to width_06 space, fixed space exception",
      xc(M9_20) => "width_01 wire cannot be sandwiched between two width_03/05/06/09/10 wires at min space on both sides",
      xc(M9_21) => "width_01 to width_01/03/05/06/09/10 space, fixed space1",
      xc(M9_22) => "width_01 to width_01/03/05/06/09/10 space, fixed space2",
      xc(M9_23) => "width_01 to width_01/03/05/06/09/10 space, fixed space3",
      xc(M9_24) => "width_02-10 to width_02-10 space, min unrestricted",
      xc(M9_35) => "width_02/03 to width_02/03 space, min unrestricted",
      xc(M9_37) => "max edge lengths that can violate the forbidden spaces if space between the edges is >=M9_38",
      xc(M9_38) => "width_01-10 to width_01-10 unrestricted space (min) ",
      xc(M9_41) => "Metal9 end-to-end space (min)",
      xc(M9_42) => "Metal9 end-to-end space width_01 line to any line (min)",
      xc(M9_43) => "M9 coverage of Square Via8 orthogonal edge",
      xc(M9_50) => "width_02/03 attacker (OGD) to width_01 victim (PGD) is not allowed.  Width_01 victim must be shielded (physically) by parallel rectangular-only width_03/05/06/09/10 wire.",
      xc(M9_51) => "OGD/PGD attacker to victim unrestricted space (min)",
      xc(M9_52) => "Width_01 attacker to victim unrestricted space (min)",
      xc(M9_60) => "Min length for all widths",
      xc(M9_65) => "Min required M9 hole area (sq um)",
      xc(M9_71) => "Minimum length of at least one segment, when two segments are adjacent at a corner",
      xc(M9_80) => "Corner-to-corner space, when corners have no overlap",
      xc(M9_81) => "Internal corner-to-corner width ",
      xc(M9_82) => "Width between facing concave corner extensions of opposite directions ",
      xc(MC_01) => "Outer edges of the PRS cells must be line-on-line with the EDM cells boundary.",
      xc(MC_02) => "CE1/2/3 cannot overlap the PRS cells",
      xc(MC_03) => "CE1/2/3 cannot overlap the logo cells",
      ...
      xc(MIM_51) => "Minimum CE1/2 enclosure of Via10 (all directions)",
      xc(MIM_52) => "Via10 space to unconnected CE1/2",
      xc(MIM_53) => "Via10 cannot land on overlapping CE1/2",
      xc(MIM_54) => "Via10 space to unconnected CE1, when the Via10 is connected to 0 or 1 capacitor plates",
      xc(MIM_55) => "Via10 space to unconnected CE2, when the Via10 is connected to 0 or 1 capacitor plates",
      xc(MIM_61) => "CE1/2 electrode layers cannot be used as a resistor, must have a M10 or TM1 shunt",
      ...
      xc(NW_01) => "N-well space to N+ active (all directions), P+ tap (OGD)",
      xc(NW_03) => "N-well enclosure of P+ active (all directions), N+ tap (OGD)",
      xc(NW_12) => "N-well width",
      xc(NW_128) => "Maximum distance from P active diff with gate in the well to a well tap, for I/O and high voltage wells and pad-connected diffusions",
      xc(NW_129) => "Maximum distance from N active diff with gate in the p-well to a sub tap, for I/O and high voltage wells and pad-connected diffusions",
      xc(NW_14) => "N-well space",
      xc(NW_17) => "Min required drawn N-well area (in sq um)",
      xc(NW_18) => "Min required drawn N-well hole area (in sq um)",
      xc(NW_21) => "N+ active diffusion space to high voltage nwells",
      xc(NW_22) => "P+ active diffusion enclosure by high voltage nwell",
      xc(NW_23) => "N-well convex corner enclosure of P+ active diffusion corner",
      xc(NW_24) => "N-well concave corner space to N+ active diffusion corner",
      xc(NW_25) => "Minimum N-well segment lengths, when both adjacent at a corner",
      ...
      xc(NW_31) => "N-well space to P+ tap (PGD)",
      xc(NW_33) => "N-well enclosure of N+ tap (PGD)",
      ...
      xc(NW_55) => "N-well X- or Y-direction enclosure of N+ tap diff near short n-well jog <=NW_57",
      xc(NW_56) => "N-well X- or Y-direction space to P+ tap diff near short n-well jog <=NW_57",
      xc(NW_57) => "Max length of short NWL jog for which rules NW_55,NW_56 apply",
      xc(NW_58) => "N+ tap diff or P+ tap diff distance to NWL edge when facing an opposite-type tap spaced at <NW_58 from the NWL edge",
      ...
      xc(PC_21) => "Polycon side-to-side space (min)",
      xc(PC_23) => "Polycon side-to-side forbidden space (fixed value)",
      xc(PC_25) => "Min Polycon end-to-end space, when facing ends are aligned (min)",
      ...
      xc(PC_36) => "Minimum overlap between line-ends in opposite directions, when at a PC_21 side-to-side space. PC_36 overlap is allowed when the ETE space is > PC_56 or the length of all the adjacent GCNs is >=PC_57",
      xc(PC_41) => "Poly overlap of polycon (PGD) for PC_42",
      xc(PC_42) => "Polycon end overlap of poly for PC_41",
      xc(PC_43) => "Polycon side space to poly line-end",
      xc(PC_44) => "Polycon end space to poly side",
      xc(PC_45) => "Poly overlap of polycon (PGD) for PC_46",
      xc(PC_46) => "Polycon end extension beyond poly side for PC_45",
      ...
      xc(PC_56) => "Min Polycon end-to-end space to allow PC_36 overlap",
      xc(PC_57) => "Min length of the 3 adjacent GCNs to allow PC_36 overlap",
      xc(PC_61) => "Min Polycon side space to gate/diffusion OGD edge",
      xc(PC_81) => "Polycon space to Diffcon",
      xc(PC_82) => "Diffcon overlap of Polycon in PGD for PC_83",
      xc(PC_83) => "Polycon end overlap of Diffcon in OGD for PC_82",
      xc(PC_84) => "Diffcon overlap of Polycon in PGD for PC_85",
      xc(PC_85) => "Polycon end extension beyond Diffcon side (OGD) for PC_84",
      xc(PC_91) => "PC_21, PC_92 spaces on opposite sides of a GCN are not allowed",
      xc(PC_92) => "Space for the PC_91 check",
      xc(PC_93) => "Polycon line extension for PC_91/92 side-to-side space checks only",
      xc(PG_01) => "Poly check grid width (fixed value)",
      xc(PG_02) => "Poly check grid Pitch (fixed value)",
      ...
      xc(PL_04) => "Short poly end-to-end space (fixed value) (cannot be isolated)",
      xc(PL_05) => "Long poly end-to-end space (fixed value)",
      xc(PL_06) => "Long poly end-to-end space range (maximum)",
      xc(PL_07) => "Medium poly end-to-end space (fixed value)",
      xc(PL_08) => "Long poly end-to-end space range unrestricted min",
      xc(PL_09) => "Space between PL_05 and PL_08 is not allowed",
      ...
      xc(PL_105) => "Need an even number of synthesized polygons in the loop ",
      xc(PL_106) => "Oversize of narrow cut for PL_105 check",
      xc(PL_11) => "Poly endcap length",
      ...
      xc(PL_25) => "Poly end space to diffusion PGD",
      ...
      xc(PL_62) => "A PL_04 end-to-end adjacent to a long cut on one side must also be adjacent to a PL_04 or a long cut on its other side. PL_04 cannot be isolated.",
      ...
      xc(PL_69) => "A PL_07 region adjacent to a PL_04 must be centered or satify PL_16",
      xc(PL_70) => "Cannot have a single isolated PL_04 next to a centered PL_07",
      xc(PL_71) => "A centered PL_07 cannot have a GCN",
      ...
      xc(RDL_16) => "Maximum RDL wire length",
      ...
      xc(SK_62) => "Disallowed V6/V7 non-redundant stack, if under TV1 and max via5 density > 5% (600X600nm window)  and metal7 density < 40% (500X500nm window)",
      ...
      xc(SK_72) => "Disallowed V7/V8 non-redundant stack, if under TV1 and max via6 density > 5% (600X600nm window) and metal8 density < 40% (500X500nm window)",
      ...
      xc(TM1_51) => "TM1 coverage of Via10 (all directions)",
      xc(TM1_60) => "TM1 space above inductors templates has special handling",
      xc(TPC_42) => "Polycon end overlap of poly for PC_41",
      xc(TPC_44) => "Polycon end space to poly side",
      xc(TPC_46) => "Polycon overlap with poly (in OGD) for PC_45",
      ...
      xc(TPL_25) => "Poly end space to diffusion PGD",
      ...
      xc(TSV_07) => "Transistor keepout zone from M1 catch cup grid (all sides)",
      ...
      xc(TV1_51) => "TM1 enclosure of  TV1 (all directions)",
      ...
      xc(TX_06) => "TGOXID enclosure of poly end,  in PGD",
      xc(TX_07) => "TGOXID space to poly end,  in PGD",
      ...
      xc(UHV_01) => "Polycon space to Diffcon",
      xc(UHV_02) => "VCN space to Diffcon (PGD)",
      xc(UHV_04) => "VCN space to polycon (PGD)",
      ...
      xc(UHV_40) => "VCN space to Diffcon side (OGD)",
      xc(UHV_41) => "VCN space to Polycon end (OGD)",
      ...
      xc(UNW_14) => "N-well space",
      xc(UNW_21) => "N+ active diffusion space to ultra high voltage nwells",
      xc(UNW_22) => "P+ active diffusion enclosure by ultra high voltage nwell",
      ...
      xc(V0_122) => "Unrestricted Via0AY-to-Via0AY center-to-center space",
      xc(V0_142) => "Minimum Via0TBX/TBY overlap of M0",
      xc(V0_171) => "Unrestricted Via0-Via0 center-to-center space for all V0AY/BY/CY/DY/EY/AW/BW/PAY (if centers are closer, vias are allowed on maximum of any 2 corners)",
      xc(V0_19) => "V0_02-V0T_10 edges are SA edges, the line end edge of Via0PAX can also be self aligned",
      xc(V0_22) => "Unrestricted Via0AX-to-Via0AX center-to-center space",
      xc(V0_23) => "Parallel full-facing metal-aligned Via0 edges can be as closely spaced as the minimum allowed M1 space.  (merged via)",
      ...
      xc(V0_252) => "Via0TAY/TBY can have 2 or fewer via0 at V0_70<=CTC<V0_250 on any 2 corners, other vias must be >=V0_250 CTC from Via0TAY/TBY ",
      ...
      xc(V0_31) => "Via0 to VCN space (on different Metal0)",
      xc(V0_32) => "Facing V0PAX/PAY pair to adjacent V0PAX/PAY",
      ...
      xc(V0_33) => "Via0 edge space to Metal0",
      ...
      xc(V0_49) => "Metal0 line end enclosure of Via0",
      ...
      xc(V0_64) => "M1 line end enclosure of opposite side of Via0PAX",
      xc(V0_66) => "Min M1 line end enclosure of any Via0, when M1 line end is exposed (on either side-edge) as defined by M1_86",
      xc(V0_69) => "M1 coverage of Via0TAY/TBY side, only allowed value",
      xc(V0_70) => "Via0 corner-to-corner space",
      xc(V0_71) => "Unrestricted Via0-Via0 center-to-center space for all via0s except V0AY/BY/CY/DY/EY/AW/BW/PAY (if centers are closer, vias are allowed on maximum of any 2 corners)",
      ...
      xc(V10_02) => "Square Via10 to Square Via10 (center-to-center) separation",
      xc(V10_11) => "M10 enclosure of Square Via10",
      xc(V10_12) => "M10 enclosure of Square Via10, orthogonal edge",
      xc(V10_31) => "Width of Via10A/B/C, fixed value",
      xc(V10_32) => "Via10A length, fixed value",
      xc(V10_33) => "Via10B length, fixed value",
      xc(V10_34) => "Via10C length, fixed value",
      xc(V10_40) => "Via10 to Via10 space (all directions)",
      xc(V10_41) => "Via10 to Via10 corner-to-corner space",
      xc(V10_51) => "M10 enclosure of Via10 (all directions)",
      xc(V10_52) => "M10 enclosure of Rectangular Via10, orthogonal edge",
      xc(V11_31) => "Width of Via11A/B/C, fixed value",
      xc(V11_32) => "Via11A length, fixed value",
      xc(V11_33) => "Via11B length, fixed value",
      ...
      xc(V11_51) => "M11 enclosure of Via11 (all directions)",
      ...
      xc(V1H_09) => "Via1HJ length (PGD), fixed value (no edge is SA)",
      xc(V1H_10) => "Via1HK length (PGD), fixed value (one V1H_01 edge is SA)",
      xc(V1H_11) => "Via1HL length (PGD), fixed value (no edge is SA)",
      ...
      xc(V1T_20) => "The V1T_01/11 edges of V1TA/B must both be aligned with parallel metal edges.",
      ...
      xc(V1_124) => "Via1 corner-to-corner space (un restricted) doesn't need to meet the V1_25 one pair rule",
      xc(V1_125) => "Via1TB corner-to-corner space (un restricted) doesn't need to meet the V1_26 one pair rule",
      ...
      xc(V1_140) => "Via1 edge enclosure by width_02 Metal1 (OGD) (V1TA/TB are exceptions)",
      ...
      xc(V1_22) => "Unrestricted Via1A-to-Via1A center-to-center space",
      xc(V1_225) => "The tight V1HL to V1HA, non-SA edge corner space (<V1_225) is allowed for a single isolated via pair. The pair must be spaced from other vias by V1_28 ",
      xc(V1_226) => "The tight V1HL to any V1, SA edge corner space (<V1_226) is allowed for 2 or fewer vias. The pair must be spaced from other vias by V1_226. Note: This rule applies only if any of the vias neighboring the V1HL via are less than 52 long (V1_227) in the PGD direction",
      xc(V1_227) => "Max PGD length of neighboring vias for V1_226 to apply (<)",
      xc(V1_23) => "Parallel full-facing metal-aligned Via1 edges can be as closely spaced as the minimum allowed M2 space. ",
      xc(V1_24) => "Via1 corner-to-corner space",
      xc(V1_25) => "The tight via-via corner space (<V1_124) is allowed for a single isolated via pair. The pair must be spaced from other vias by V1_28 ",
      xc(V1_26) => "The tight Via1TB-Via1TB corner space (<V1_125) is allowed for a single isolated via pair. The pair must be spaced from other vias by V1_28 ",
      xc(V1_28) => "Unrestricted min Via1 edge-to-edge space",
      xc(V1_32) => "Via1 to Via0 space (on different Metal1)",
      xc(V1_33) => "Via1 edge space to Metal1",
      xc(V1_40) => "Via1 edge enclosure by width_01 Metal1 (OGD) (V1TA/TB are exceptions)",
      xc(V1_42) => "Minimum Via1TB overlap of Metal1 (OGD)",
      xc(V1_43) => "Via1TA/TB must overlap 2 adjacent M1 lines",
      xc(V1_49) => "Metal1 line-end enclosure of Via1",
      xc(V1_50) => "Metal1 line-end enclosure of Via1, when Via1 lands on an offset M1 as defined by M1_86",
      ...
      xc(V1_61) => "M2 line-end enclosure of Via1 ",
      xc(V1_97) => "V1Ts long edge to long edge space (PGD)",
      ...
      xc(V2H_10) => "Only one of the Via2HA/HG/HK/HM PGD edges are aligned to metal edges.",
      ...
      xc(V2H_20) => "None of the Via2HD/HJ/HL edges are aligned to metal edges.",
      ...
      xc(V2T_20) => "The V2T_01 edges of V2TA, V2T_03 edges of V2TB, and V2T_05 edges of V2TC must both be aligned with parallel metal edges.",
      ...
      xc(V2_128) => "Unrestricted min Via2 edge-to-edge space (SA edges)",
      ...
      xc(V2_142) => "Minimum Via2TC overlap of Metal2 (PGD). If M2 width is less than V2_42, this is the extension past the nearest M2 edge.",
      ...
      xc(V2_152) => "Via2 to Via1 edge-to-edge space (on different Metal2)",
      ...
      xc(V2_22) => "Unrestricted V2A-to-V2A center-to-center space",
      xc(V2_228) => "Unrestricted min V2HA SA edge to SA edge of any via2s",
      xc(V2_23) => "Parallel full-facing metal-aligned Via2 edges can be as closely spaced as the minimum allowed M3 space. ",
      xc(V2_24) => "Min Via2 corner-to-corner space (CTC space between V2_24 and V2_250 comes with restrictions)",
      ...
      xc(V2_251) => "Small via2 (32 wide - A/B/C/D/F/G/J/L/N/O/R/S/V/HA/HG/HK/HM/HD/HJ/HL) can have only one via2(big/small) at V2_24<=CTC<V2_250, other vias must be >=V2_250 CTC from the small via ",
      xc(V2_252) => "A big via2 can have 2 or fewer small via2 (32 wide) at V2_24<=CTC<V2_250 on any 2 corners, other vias must be >=V2_250 CTC from the big via ",
      xc(V2_28) => "Unrestricted min Via2 edge-to-edge space (non-SA edges)",
      xc(V2_32) => "Via2 to Via1 corner-to-corner space (on different Metal2)",
      xc(V2_33) => "Via2 edge space to Metal2",
      xc(V2_40) => "Maximum Via2 overhang of Metal2 (PGD)",
      xc(V2_41) => "Via2 must be centered on Metal2 (PGD) (V2_241 is an exception)",
      xc(V2_42) => "Minimum Via2TA/TB overlap of Metal2 (PGD). If M2 width is less than V2_42, this is the extension past the nearest M2 edge.",
      ...
      xc(V2_49) => "Metal2 line-end enclosure of Via2",
      xc(V2_51) => "Both opposite edges of a aligned via must be metal aligned",
      xc(V2_54) => "Via2HJ can only be covered by a width_L_05 metal3",
      xc(V2_61) => "M3 line-end enclosure of Via2 ",
      ...
      xc(V3H_02) => "Via3HA length (PGD), fixed value (one edge SA only)",
      xc(V3H_03) => "Width of Via3HG (OGD), fixed value",
      xc(V3H_04) => "Via3HG length (PGD), fixed value (one edge SA only)",
      xc(V3H_05) => "Width of Via3HK (OGD), fixed value",
      xc(V3H_06) => "Via3HK length (PGD), fixed value (one edge SA only)",
      xc(V3H_07) => "Width of Via3HM (OGD), fixed value",
      xc(V3H_08) => "Via3HM length (PGD), fixed value (one edge SA only)",
      xc(V3H_10) => "Only one of the Via3HA/HG/HK/HM OGD edges are aligned to metal edges.",
      ...
      xc(V3H_20) => "None of the Via3HD/HJ/HL/HN edges are aligned to metal edges.",
      ...
      xc(V3T_20) => "The V3T_01 edges of V3TA, V3T_03 edges of V3TB, and V3T_05 edges of V3TC must both be aligned with parallel metal edges.",
      ...
      xc(V3_128) => "Unrestricted min Via3 edge-to-edge space (SA edges)",
      ...
      xc(V3_142) => "Minimum Via3TC overlap of Metal3 (OGD). If M3 width is less than V3_42, this is the extension past the nearest M3 edge.",
      xc(V3_15) => "Via3T length (PGD), fixed value",
      xc(V3_152) => "Via3 to Via2 edge-to-edge space (on different Metal3)",
      ...
      xc(V3_19) => "Via3C length (OGD), fixed value",
      xc(V3_20) => "The V3_01 edges of above Via3 must both be aligned with parallel Metal-4 edges.",
      xc(V3_22) => "Unrestricted V3A-to-V3A center-to-center space",
      xc(V3_228) => "Unrestricted min V3HA SA edge to SA edge of any via3s",
      xc(V3_23) => "Parallel full-facing metal-aligned Via3 edges can be as closely spaced as the minimum allowed M4 space. ",
      xc(V3_24) => "Min Via3 corner-to-corner space (CTC space between V3_24 and V3_250 comes with restrictions)",
      ...
      xc(V3_251) => "Small via3 (32 wide - A/B/C/D/F/G/J/L/N/O/R/S/V/X/HA/HG/HK/HM/HD/HJ/HL) can have only one via3(big/small) at V3_24<=CTC<V3_250, other vias must be >=V3_250 CTC from the small via ",
      xc(V3_252) => "A big via3 can have 2 or fewer small via3 (32 wide) at V3_24<=CTC<V3_250 on any 2 corners, other vias must be >=V3_250 CTC from the big via ",
      ...
      xc(V3_28) => "Unrestricted min Via3 edge-to-edge space (non-SA edges)",
      xc(V3_32) => "Via3 to Via2 corner-to-corner space (on different Metal3)",
      xc(V3_33) => "Via3 edge space to Metal3",
      xc(V3_40) => "Maximum Via3 overhang of Metal3 (OGD)",
      xc(V3_41) => "Via3 must be centered on Metal3 (OGD) ",
      xc(V3_42) => "Minimum Via3TA/TB overlap of Metal3 (OGD). If M3 width is less than V3_42, this is the extension past the nearest M3 edge.",
      ...
      xc(V3_49) => "Metal3 line-end enclosure of Via3",
      xc(V3_51) => "Both opposite edges of a aligned via must be metal aligned",
      xc(V3_54) => "Via3HJ can only be covered by a width_L_05 metal4",
      xc(V3_61) => "M4 line-end enclosure of Via3 ",
      ...
      xc(V4H_10) => "Only one of the Via4HA/HG/HK/HM PGD edges are aligned to metal edges.",
      ...
      xc(V4H_20) => "None of the Via4HD/HJ/HL edges are aligned to metal edges.",
      ...
      xc(V4T_20) => "The V4T_01 edges of V4TA, V4T_03 edges of V4TB, and V4T_05 edges of V4TC must both be aligned with parallel metal edges.",
      xc(V4_01) => "Width of below Via4 (PGD), fixed value",
      ...
      xc(V4_06) => "Via4G length (OGD), fixed value",
      xc(V4_08) => "Via4J length (OGD), fixed value",
      xc(V4_09) => "Via4R length (OGD), fixed value",
      xc(V4_10) => "Via4V length (OGD), fixed value",
      xc(V4_101) => "Via4N length (OGD), fixed value",
      xc(V4_102) => "Via4O length (OGD), fixed value",
      xc(V4_103) => "Via4P length (OGD), fixed value",
      xc(V4_104) => "Via4Q length (OGD), fixed value",
      xc(V4_105) => "Via4R length (OGD), fixed value",
      xc(V4_106) => "Via4H length (OGD), fixed value",
      xc(V4_11) => "Via4L length (OGD), fixed value",
      xc(V4_111) => "Width (PGD) of below via4s, fixed value",
      xc(V4_112) => "Via4AS length (OGD), fixed value",
      xc(V4_113) => "Via4NS length (OGD), fixed value",
      xc(V4_114) => "Via4HS length (OGD), fixed value",
      xc(V4_115) => "Via4OS length (OGD), fixed value",
      xc(V4_116) => "Via4PS length (OGD), fixed value",
      xc(V4_117) => "Via4DS length (OGD), fixed value",
      xc(V4_118) => "Via4QS length (OGD), fixed value",
      xc(V4_119) => "Via4RS length (OGD), fixed value",
      xc(V4_12) => "Via4N length (OGD), fixed value",
      ...
      xc(V4_128) => "Unrestricted min Via4 edge-to-edge space (SA edges)",
      xc(V4_129) => "Via4NX (PGD), fixed value (SA edges)",
      xc(V4_13) => "Via4S length (OGD), fixed value",
      ...
      xc(V4_14) => "Via4O length (OGD), fixed value",
      xc(V4_142) => "Minimum Via4TC overlap of Metal4 (PGD). If M4 width is less than V4_42, this is the extension past the nearest M4 edge.",
      xc(V4_15) => "Via4U length (OGD), fixed value",
      xc(V4_152) => "Via4 to Via3 edge-to-edge space (on different Metal4)",
      xc(V4_16) => "Via4V Width (PGD) , fixed value (SA edges)",
      xc(V4_17) => "Via4V length (OGD), fixed value",
      xc(V4_19) => "Via4C length (OGD), fixed value",
      xc(V4_20) => "The V4_01 edges of above Via4 must both be aligned with parallel Metal-5 edges.",
      xc(V4_22) => "Unrestricted V4A-to-V4A center-to-center space",
      xc(V4_228) => "Unrestricted min V4HA SA edge to SA edge of any via4s",
      xc(V4_23) => "Parallel full-facing metal-aligned Via4 edges can be as closely spaced as the minimum allowed M5 space. ",
      xc(V4_24) => "Min Via4 corner-to-corner space (CTC space between V4_24 and V4_250 comes with restrictions)",
      xc(V4_240) => "Only V4_01 width vias can overhang Metal4 (PGD)",
      xc(V4_250) => "Min unrestricted Via4 corner-to-corner space",
      xc(V4_251) => "Small via4 (32 wide - A/B/C/D/F/G/J/L/N/O/R/S/V/HA/HG/HK/HM/HD/HJ/HL) can have only one via4(big/small) at V4_24<=CTC<V4_250, other vias must be >=V4_250 CTC from the small via ",
      xc(V4_252) => "A big via4 can have 2 or fewer small via4 (32 wide) at V4_24<=CTC<V4_250 on any 2 corners, other vias must be >=V4_250 CTC from the big via ",
      xc(V4_28) => "Unrestricted min Via4 edge-to-edge space (non-SA edges)",
      ...
      xc(V4_32) => "Via4 to Via3 corner-to-corner space (on different Metal4)",
      xc(V4_33) => "Via4 edge space to Metal4",
      xc(V4_40) => "Maximum Via4 overhang of Metal4 (PGD)",
      xc(V4_41) => "Via4 must be centered on Metal4 (PGD) ",
      xc(V4_42) => "Minimum Via4TA/TB overlap of Metal4 (PGD). If M4 width is less than V4_42, this is the extension past the nearest M4 edge.",
      ...
      xc(V4_49) => "Metal4 line-end enclosure of Via4",
      xc(V4_51) => "Both opposite edges of a aligned via must be metal aligned",
      xc(V4_54) => "Via4HJ can only be covered by a width_L_05 metal5",
      xc(V4_61) => "M5 line-end enclosure of Via4 ",
      xc(V4_62) => "Min M5 line-side enclosure of Via4HD/HJ/HL (OGD) ",
      ...
      xc(V5_04) => "Via5DS length (PGD), fixed value",
      xc(V5_05) => "Via5ES length (PGD), fixed value",
      xc(V5_06) => "Via5D length (PGD), fixed value",
      xc(V5_07) => "Via5M length (PGD), fixed value",
      xc(V5_08) => "Via5N length (PGD), fixed value",
      xc(V5_09) => "Via5FA length (PGD), fixed value",
      xc(V5_10) => "Via5N length (PGD), fixed value",
      xc(V5_101) => "Width of Via5S (OGD), fixed value (SA edge)",
      xc(V5_102) => "Length of Via5S (PGD), fixed value",
      xc(V5_103) => "Width of Via5U (OGD), fixed value (SA edge)",
      xc(V5_104) => "Length of Via5U (PGD), fixed value",
      xc(V5_105) => "Width of Via5V (OGD), fixed value (SA edge)",
      xc(V5_106) => "Length of Via5V (PGD), fixed value",
      ...
      xc(V5_11) => "Via5O length (PGD), fixed value",
      ...
      xc(V5_12) => "Via5Q length (PGD), fixed value",
      xc(V5_128) => "Unrestricted min Via5 edge-to-edge space (SA edges)",
      xc(V5_13) => "Via5R length (PGD), fixed value",
      xc(V5_14) => "Via5M length (PGD), fixed value",
      xc(V5_15) => "Via5T length (PGD), fixed value",
      xc(V5_152) => "Via5 to Via4 edge-to-edge space (on different Metal5)",
      xc(V5_153) => "Via5 on isolated M6 to Via4 space (on different Metal5)",
      xc(V5_154) => "Isolated M6 line for V5_153 is defined as a line with exposed edges on opposite edges of the line with overlap of > V5_154",
      ...
      xc(V5_19) => "V5_01 edge of above vias must both be aligned with parallel Metal-6 edges.",
      xc(V5_22) => "Unrestricted V5A-to-V5A center-to-center space",
      xc(V5_23) => "Parallel full-facing metal-aligned Via5 edges can be as closely spaced as the minimum allowed M6 space. ",
      xc(V5_24) => "Min Via5 corner-to-corner space",
      xc(V5_240) => "Only V5_01 (32nm), V5_161 (44nm) width vias (except Via5MP) can overhang Metal5 (OGD)",
      ...
      xc(V5_28) => "Unrestricted min Via5 edge-to-edge space",
      xc(V5_29) => "Via5 min edge offset if corner-to-corner space is less than V5_30",
      xc(V5_30) => "Via5  corner-to-corner space limit for V5_29",
      xc(V5_32) => "Via5 to Via4 corner-to-corner space (on different Metal5)",
      xc(V5_33) => "Via5 edge space to Metal5",
      xc(V5_40) => "Maximum Via5 overhang of Metal5 (OGD)",
      xc(V5_41) => "Via5 must be centered on Metal5 (OGD)",
      xc(V5_42) => "Via5YZ can only land on width_L_05/06 M5 lines (M5L_05/06)",
      xc(V5_49) => "Metal5 line-end enclosure of Via5",
      xc(V5_51) => "Both opposite edges of a aligned via must be metal aligned",
      xc(V5_52) => "Via5YZ must be centered under M6_13/14/15 width M6 (only)",
      xc(V5_54) => "Metal6 concave corner space to Via5",
      xc(V5_61) => "Metal6 line-end enclosure of Via5  (except Via5YZ)",
      xc(V5_62) => "Metal6 line-end enclosure of Via5YZ",
      ...
      xc(V6_22) => "Via6A-Via6A center-to-center space",
      xc(V6_23) => "Via6 metal aligned edges space when the other edges (non-metal limited edges) are perfectly aligned",
      xc(V6_24) => "Via6 corner-to-corner space",
      xc(V6_240) => "Via6H are not allowed to overhang",
      xc(V6_25) => "Via6 facing edge space (V6_23,27,28 are exceptions)",
      xc(V6_27) => "Via6C/CX/D/E/F/G/H/CY/DX/EX facing short-edge to short-edge space ",
      xc(V6_28) => "Via6 metal aligned edges space when the other edges (non-metal limited edges) are NOT perfectly aligned",
      xc(V6_29) => "Via6 min edge offset if corner-to-corner space is less than V6_30",
      xc(V6_30) => "Via6  corner-to-corner space limit for V6_29",
      xc(V6_31) => "Via6 to Via5 edge-edge space (on different M6)",
      xc(V6_32) => "Via6 to Via5 corner-to-corner space (on different M6)",
      xc(V6_33) => "Via6 edge space to Metal6",
      ...
      xc(V6_49) => "Metal6 line end enclosure of Via6",
      xc(V6_51) => "Both opposite edges of a aligned via must be metal aligned",
      xc(V6_54) => "M7 concave corner space to Via6",
      xc(V6_55) => "M7 convex corner coverage of Via6 corner",
      xc(V6_61) => "M7 line end enclosure of Via6 ",
      ...
      xc(V7_01) => "Via7A width (PGD), fixed value",
      xc(V7_02) => "Via7A length (OGD), fixed value",
      xc(V7_03) => "Via7B width (PGD), fixed value",
      xc(V7_04) => "Via7B length (OGD), fixed value",
      xc(V7_05) => "Via7F width (PGD), fixed value",
      xc(V7_06) => "Via7F length (OGD), fixed value",
      xc(V7_07) => "Via7FS length (PGD), fixed value",
      xc(V7_08) => "Via7GS length (PGD), fixed value",
      xc(V7_09) => "Via7HS length (PGD), fixed value",
      xc(V7_10) => "Via7JS length (PGD), fixed value",
      xc(V7_101) => "Width of below Via7, fixed value (OGD SA-edge)",
      xc(V7_102) => "Via7KS length (PGD), fixed value",
      xc(V7_103) => "Via7LS length (PGD), fixed value",
      xc(V7_104) => "Via7MS length (PGD), fixed value",
      xc(V7_105) => "Via7NS length (PGD), fixed value",
      xc(V7_106) => "Via7OS length (PGD), fixed value",
      xc(V7_107) => "Via7PS length (PGD), fixed value",
      xc(V7_108) => "Via7QS length (PGD), fixed value",
      xc(V7_109) => "Via7RS length (PGD), fixed value",
      ...
      xc(V7_22) => "Via7A-to-Via7A center-to-center space (on different M7 lines)",
      xc(V7_23) => "Parallel full-facing metal-aligned Via7 edges can be as closely spaced as the minimum allowed M8 space. ",
      xc(V7_24) => "Via7 corner-to-corner space",
      xc(V7_28) => "Unrestricted min Via7 edge-to-edge space (non-SA edges)",
      xc(V7_29) => "Via7 min edge offset if corner-to-corner space is less than V7_30",
      xc(V7_30) => "Via7 corner-to-corner space limit for V7_29",
      xc(V7_32) => "Via7 to Via6 space (on different Metal7, all-directional check)",
      xc(V7_33) => "Via7 edge space to Metal7",
      ...
      xc(V7_49) => "Metal7 line-end enclosure of Via7",
      xc(V7_51) => "Both opposite edges of a aligned via (Via7A/B/F) must be metal aligned",
      xc(V7_52) => "M8 enclosure of Via7C/D/E (one edge at a corner)",
      xc(V7_53) => "M8 line-end enclosure of Via7C/D/E, orthogonal edge",
      xc(V7_54) => "Metal8 concave corner space to Via7A/B/F",
      xc(V7_61) => "Metal8 line-end enclosure of Via7A/B/F ",
      ...
      xc(V8_01) => "Square Via8 size ONLY ALLOWED value",
      xc(V8_02) => "Square Via8 to Square Via8 (center-to-center) separation",
      xc(V8_101) => "Square Via8SA ONLY ALLOWED value",
      xc(V8_11) => "Maximum Square Via8 overhang of Metal8",
      xc(V8_12) => "M8 enclosure of Square Via8, orthogonal edge",
      xc(V8_131) => "Rectangular Via8RA width, ONLY ALLOWED value",
      xc(V8_132) => "Rectangular Via8RA length, ONLY ALLOWED value",
      xc(V8_153) => "A Rectangular Via8 that overhangs an M8 edge is only allowed on OGD M8 and must be centered on the OGD M8 line.",
      ...
      xc(V8_32) => "Rectangular Via8 length, ONLY ALLOWED value",
      xc(V8_33) => "Rectangular Via8 Long edge facing space to Square or Rectangular Via8 ",
      ...
      xc(V8_40) => "Redundant Rectangular Via8s must be aligned with each other",
      xc(V8_41) => "Rectangular Via8 to Via7 (square/rectangular) space (on different M8 net, all-directional check)",
      xc(V8_51) => "M8 enclosure of Rectangular Via8 (one edge at a corner)",
      xc(V8_52) => "M8 enclosure of Rectangular Via8, orthogonal edge",
      xc(V8_53) => "Max extent of Rectangular Via8 short edge beyond M8 side",
      xc(V8_61) => "Max extent of Square Via8 edge beyond M9 edge",
      xc(V8_62) => "M9 coverage of Square Via8 orthogonal edge",
      xc(V8_71) => "Max extent of Rectangular Via8 long edge beyond M9 edge",
      xc(V8_72) => "M9 coverage of Rectangular Via8 short edge, minimum",
      ...
      xc(V8err_131) => "Rectangular Via8RA width, ONLY ALLOWED value",
      xc(V8err_132) => "Rectangular Via8RA length, ONLY ALLOWED value",
      xc(V8err_31) => "Rectangular Via8RS width, ONLY ALLOWED value",
      xc(V8err_32) => "Rectangular Via8RS length, ONLY ALLOWED value",
      xc(V9_01) => "Square Via9 size ONLY ALLOWED value",
      xc(V9_02) => "Square Via9 to Square Via9 (center-to-center) separation",
      xc(V9_11) => "M9 enclosure of Square Via9",
      xc(V9_12) => "M9 enclosure of Square Via9, orthogonal edge",
      xc(V9_21) => "Square Via9 to Via8 (square/rectangular) space (on different M9 net, all-directional check)",
      xc(V9_31) => "Rectangular Via9 width, ONLY ALLOWED value",
      xc(V9_32) => "Rectangular Via9 length, ONLY ALLOWED value",
      xc(V9_33) => "Rectangular Via9 space to Via9 (square/rectangular, includes all combinations of long edges, short edges, and corners), all-directional check",
      xc(V9_34) => "Via9C length, fixed value",
      xc(V9_35) => "Rectangular Via9 Corner-to-corner space to Square or Rectangular Via9 ",
      xc(V9_39) => "Redundant Rectangular Via9 spacing between facing Long edges, for electrically shorted vias, fixed value  (note this is an allowed exception to V9_33)",
      xc(V9_40) => "Via9 to Via9 space (all directions)",
      xc(V9_41) => "Via9 to Via9 corner-to-corner space",
      xc(V9_51) => "M9 enclosure of Rectangular Via9",
      xc(V9_52) => "M9 enclosure of Rectangular Via9, orthogonal edge",
      xc(V9_61) => "Max extent of Square Via9 edge beyond M10 edge",
      xc(V9_62) => "M10 coverage of Square Via9 orthogonal edge",
      xc(V9_71) => "Max extent of Rectangular Via9 long edge beyond M10 edge",
      xc(V9_72) => "M10 coverage of Rectangular Via9 short edge, minimum",
      ...
      xc(VC_134) => "The TCN line end that has the VC_34 overhang needs to have a TCN ETE space of =VC_134, also note this line end falls of the 21nm TCN line end grid by 6nm) ",
      ...
      xc(VC_22) => "Unrestricted VCNAX-to-VCNAX center-to-center space",
      xc(VC_23) => "Parallel full-facing metal-aligned VCN edges can be as closely spaced as the minimum allowed M0 space.  (merged via)",
      ...
      xc(VC_36) => "VCN space to Diffcon, PGD",
      xc(VC_37) => "VCN space to Diffcon, OGD",
      xc(VC_38) => "VCN PGD offset from Diffcon line-end, if corner-to-corner space is < VC_37",
      ...
      xc(VC_44) => "VCN edge space to Polycon side (PGD)",
      xc(VC_46) => "VCN edge space to Polycon end (OGD)",
      xc(VC_47) => "max VCNHB (SA edge) OGD edge enclosure of Polycon side (PGD)",
      xc(VC_48) => "VCN to Polycon PGD offset, if VCN-Polycon corners are < VC_46",
      xc(VC_49) => "VCNHC edge space to Polycon side (PGD)",
      xc(VC_51) => "VCNHB/HC can be under a M0L_03/04 line",
      xc(VC_61) => "Minimum M0 line end enclosure of VCN",
      xc(VC_70) => "VCN corner-to-corner space",
      ...
      xc(VD_10) => "Via9 space threshold that subjects the array to max area check",
      xc(VD_11) => "Via10 space threshold that subjects the array to max area check",
      xc(VD_17) => "Via 7 array width exception limit",
      xc(VD_18) => "Via 8 array width exception limit",
      xc(VD_19) => "Via 9 array width exception limit",
      xc(VD_20) => "Via 9 array width exception limit",
      xc(VD_21) => "Via 10 array width exception limit",
      ...
      xc(VD_30) => "Maximum Via 9 array area after merge and exception",
      xc(VD_31) => "Maximum Via 10 array area after merge and exception",
      xc(VD_57) => "Max width of merged Via 7 array",
      xc(VD_58) => "Max width of merged Via 8 array",
      xc(VD_59) => "Max width of merged Via 9 array",
      xc(VD_60) => "Max width of merged Via 9 array",
      xc(VD_61) => "Max width of merged Via 10 array",
      ...
      xc(XG_06) => "XGOXID enclosure of poly end,  in PGD",
      xc(XG_07) => "XGOXID space to poly end,  in PGD",
   ...
   Error_LDW_610 = empty_violation();
   drErrHash[xc(LDW_610)] = Error_LDW_610;
   ...
   Error_LD_610 = empty_violation();
   drErrHash[xc(LD_610)] = Error_LD_610;
   ...
   Error_LMI_07 = empty_violation();
   drErrHash[xc(LMI_07)] = Error_LMI_07;
   Error_LMI_08 = empty_violation();
   drErrHash[xc(LMI_08)] = Error_LMI_08;
   Error_LMI_09 = empty_violation();
   drErrHash[xc(LMI_09)] = Error_LMI_09;
   Error_LMI_10 = empty_violation();
   drErrHash[xc(LMI_10)] = Error_LMI_10;
   ...
   Error_LMI_14 = empty_violation();
   drErrHash[xc(LMI_14)] = Error_LMI_14;
   ...
   Error_M10_43 = empty_violation();
   drErrHash[xc(M10_43)] = Error_M10_43;
   ...
   Error_M9_10 = empty_violation();
   drErrHash[xc(M9_10)] = Error_M9_10;
   ...
   Error_V6_55 = empty_violation();
   drErrHash[xc(V6_55)] = Error_V6_55;
   ...
   Error_V8err_131 = empty_violation();
   drErrHash[xc(V8err_131)] = Error_V8err_131;
   Error_V8err_132 = empty_violation();
   drErrHash[xc(V8err_132)] = Error_V8err_132;
   ...
   Error_VD_18 = empty_violation();
   drErrHash[xc(VD_18)] = Error_VD_18;
   ...
   drErrGDSHash:typeHashString2gds = { 
      ...
      xc(V8err_131) => { 141 , 1131 },
      xc(V8err_132) => { 141 , 1132 },
