// $Header: /ds/data/2647/server_vault/Projects/drwork/x12dev_drwork/rst/x12dev_drwork_rst/PXL/1273/p1273d6_Tdevxtr.rs.rca 1.34 Wed Sep 17 09:54:18 2014 kperrey Experimental $

// $Log: p1273d6_Tdevxtr.rs.rca $
// 
//  Revision: 1.34 Wed Sep 17 09:54:18 2014 kperrey
//  hsd 2743 ; add rm0m1 as possible schematic equiv for a rm0
// 
//  Revision: 1.33 Sat Aug 16 12:52:43 2014 kperrey
//  include 1273/p1273dx_Tdevxtr_mvsw.rs to support the icf sov/scv/som/scm/aliasd devices
// 
//  Revision: 1.32 Fri Aug  8 09:33:35 2014 kperrey
//  moved duplicated code device function to common file p12723_Tdevxtrfun.rs
// 
//  Revision: 1.31 Tue Aug  5 22:23:40 2014 kperrey
...
// 
//  Revision: 1.30 Tue Aug  5 16:28:21 2014 kperrey
//  save point so I can remove the scm/som/scv/sov stuff
// 
//  Revision: 1.29 Thu Jul 31 22:44:11 2014 kperrey
...
// 
//  Revision: 1.28 Thu Jul 17 20:29:55 2014 kperrey
//  hsd 2567 ; create the nulv pulv devices
// 
//  Revision: 1.27 Thu Jul 17 11:32:32 2014 kperrey
//  include p1273dx_Tdevxtr_sclmfc.rs for scaleable mfc support and add sclMFCCalcProps function
// 
//  Revision: 1.26 Mon Jul  7 15:48:05 2014 kperrey
//  hsd 2425; add the scm schematic device to all metal res ; create new scmx som somx resistor devices
// 
//  Revision: 1.25 Fri Jun 20 12:23:20 2014 kperrey
//  if _drRFRV then add add prop PRE to rfreqCalcPropsStacked and rfreqCalcPropsParallel
// 
//  Revision: 1.24 Tue Jun  3 09:52:06 2014 kperrey
//  added handling for _drRFblock (a rcextract thing) from srimathi ; slightly different than what srimathi supplied
// 
//  Revision: 1.23 Wed Apr 23 15:06:06 2014 kperrey
//  add rtm1m9c4 rtcnfm0 rgcnfm0 rpfm0 schematic support Hasanur
// 
//  Revision: 1.22 Thu Apr 17 15:01:52 2014 kperrey
//  hsd 2287 ; change case of pin names (lc now) for mimcap_scl and mimcap_stk_scl
// 
//  Revision: 1.21 Mon Mar 31 16:21:03 2014 kperrey
//  from srimathi ; _drNoRCdevPropExt controls dual_hierarchy_extraction
// 
//  Revision: 1.20 Tue Mar 18 16:41:37 2014 kperrey
//  add the mim_scl stuff from ICF
// 
//  Revision: 1.19 Tue Mar 18 10:22:31 2014 kperrey
//  only support a m9(d1) or m12(d6) stack; limit use of ICFdevices
// 
//  Revision: 1.18 Thu Mar 13 18:58:57 2014 kperrey
//  fixed a type devIDcnt should have been devIDCnt
// 
//  Revision: 1.17 Wed Mar 12 22:16:24 2014 kperrey
...
// 
//  Revision: 1.16 Tue Mar 11 22:35:18 2014 kperrey
//  no need to write lvsmult to net file
// 
//  Revision: 1.15 Tue Mar 11 17:22:55 2014 kperrey
...
// 
//  Revision: 1.14 Mon Mar  3 13:56:57 2014 kperrey
//  hsd 2165 ; remove poly_nores_nogate referance now just all poly_nores
// 
//  Revision: 1.13 Mon Feb 24 14:23:20 2014 kperrey
//  hsd 2146 - change xmult -> multx and ymult -> multy ; fix the includes for the *rcefun files  added rcext/ to the include so will automatically look in the rcext subdir ; hsd 2145 - if _drRCextract skip mncap/mpcap device creation since they all should be filtered anyway
// 
//  Revision: 1.12 Thu Feb 20 19:58:37 2014 kperrey
//  hsd 2130; add nstk pstk devices into the extraction
// 
//  Revision: 1.11 Thu Feb 20 14:14:07 2014 kperrey
...
// 
//  Revision: 1.10 Thu Feb 20 10:55:04 2014 kperrey
...
// 
//  Revision: 1.9 Thu Feb 20 08:14:52 2014 kperrey
...
// 
//  Revision: 1.8 Thu Feb 13 19:23:26 2014 kperrey
//  hsd 2122 ; change property NS to STLEN
// 
//  Revision: 1.7 Thu Jan 30 08:40:10 2014 cpark3
//  updates for RC extraction
// 
//  Revision: 1.6 Wed Jan 15 11:31:20 2014 kperrey
//  give all most devices simulation_model_name same as device name (as per Synopsys) ; make the rf devices use x_card = true
// 
//  Revision: 1.5 Sun Jan  5 16:24:41 2014 kperrey
...
// 
//  Revision: 1.4 Wed Oct 30 08:37:00 2013 kperrey
//  hsd 1926; add device for mcr resistor
// 
//  Revision: 1.3 Thu Sep  5 14:22:58 2013 kperrey
//  hsd 1866 ; support ICF scaleable inductor ind2t_scl_*
// 
//  Revision: 1.2 Mon Jun 10 08:47:51 2013 kperrey
//  support the djnw device for perc
// 
//  Revision: 1.1 Thu Mar 28 18:56:38 2013 kperrey
//  similar to d5 but add m11/m12 ; support DEEPNWELL devices
// 
...
// start device extraction definitions
// nstk/pstk
nmos(
...
#else
   // substitute nsd/psd with nsd_rf/psd_rf  
   // n/puv2rf
   nmos(
      matrix = trace_devMtrx,
      device_name = "nuv2rf",
...
// Deleted diode definition for DNW_lite - ICF
// deepnwell diodes
pn (
   matrix = trace_devMtrx,
   device_name = "ddnwpw",
   device_body = dnpdnw_anode,
   anode = dnpdnw_anode,
   cathode = dnpdnw_cathode,
   processing_layer_hash = { "pwell" => {pwellPhysical} },
   property_function = pnDNWCalcAP,
   properties = {
      {name = "pj", type = DOUBLE, scale = MICRO},
      {name = "area", type = DOUBLE, scale = PICO}
   },
   merge_parallel = false, //optional
   bulk_relationship = INTERACT, //optional
   schematic_devices = {{device_name = "ddnwpw", anode = "ANODE", cathode = "CATHODE" }},
   extract_shorted_device = true, //optional
   reference_layer = DEEPNWELL, //optional
   processing_mode = HIERARCHICAL //optional
);
np (
   matrix = trace_devMtrx,
   device_name = "ddnwpsub",
   device_body = dpndnw_cathode,
   anode = dpndnw_anode,
   cathode = dpndnw_cathode,
   processing_layer_hash = { "deepnwell" => {DEEPNWELL} },
   ...
   merge_parallel = false, //optional
   bulk_relationship = INTERACT, //optional
   schematic_devices = {{device_name = "ddnwpsub", anode = "ANODE", cathode = "CATHODE" }},
   extract_shorted_device = true, //optional
   reference_layer = DEEPNWELL, //optional
   processing_mode = HIERARCHICAL //optional
);
