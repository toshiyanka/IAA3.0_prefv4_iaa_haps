// $Header: /ds/data/2647/server_vault/Projects/drwork/x12dev_drwork/rst/x12dev_drwork_rst/PXL/1273/p1273d1_metal_via_common.rs.rca 1.1 Wed May 22 10:08:30 2013 dgthakur Experimental $
//
// $Log: p1273d1_metal_via_common.rs.rca $
// 
//  Revision: 1.1 Wed May 22 10:08:30 2013 dgthakur
//  metal common file for 1273.1
// 
...
//*** p1273 metal via common definitions file - Start with 1273.4 copy 19May2013 *** 
#ifndef _P1273D1_METAL_VIA_COMMON_RS_
#define _P1273D1_METAL_VIA_COMMON_RS_
...
mx(_pgd_width) = {MX(03)};
mx(_ogd_width) = {MX(00), MX(02), MX(03), MX(09), MX(04), MX(05), MX(06), MX(07), MX(08), MX(10), MX(11)};

//w00 is mapped to w01 in code
DRBIN_PgdOgd()
DRBIN_GetPGDWidthOne(03)
DRBIN_GetOGDWidthAll(01,02,03,09,04,05,06,07,08,10,11,99)
DRBIN_GetBadWidthAndEdges()
...
#endif //_P1272D1_METAL_VIA_COMMON_RS_
