// $Header: /ds/data/2647/server_vault/Projects/drwork/x12dev_drwork/rst/x12dev_drwork_rst/PXL/1273/p1273dx_M4.rs.rca 1.3 Tue May  7 18:55:10 2013 dgthakur Experimental $
//
// $Log: p1273dx_M4.rs.rca $
// 
...
//*** p1273 M4 runset - Dipto Thakurta Started 27Jun11 *** 
#ifndef _P1273DX_M4_RS_
#define _P1273DX_M4_RS_
...
MXM(02),MXM(03),
MXL(08),MXL(01),MXL(02),MXL(09),MXL(03),MXL(07),MXL(05),MXL(06)
};
...
drInvalidBCB_( xc(MX(136)), mx(b_all), mx(c_all), [0.028, 0.036], [0.054, 0.084], [0.028, 0.036], <=MX(21), mx(perp_dir));
drInvalidBCB_( xc(MX(137)), mx(b_all), mx(c_all), [0.028, 0.046], [0.060, 0.084], [0.038, 0.046], <=MX(21), mx(perp_dir));
drInvalidBCB_( xc(MX(138)), mx(b_all), mx(c_all), [0.028, 0.036], [0.028, 0.036], [0.054, 0.084], <=MX(21), mx(perp_dir), mx(TW));
drInvalidBCB_( xc(MX(138)), mx(b_all), mx(c_all), [0.028, 0.036], [0.060, 0.084], [0.054, 0.084], <=MX(21), mx(perp_dir));
drInvalidBCB_( xc(MX(139)), mx(b_all), mx(c_all), [0.040, 0.046], [0.028, 0.036], [0.054, 0.084], <=MX(21), mx(perp_dir));
drInvalidBCB_( xc(MX(139)), mx(b_all), mx(c_all), [0.040, 0.046], [0.084, 0.084], [0.054, 0.084], <=MX(21), mx(perp_dir));
drInvalidBCB_( xc(MX(140)), mx(b_all), mx(c_all), [0.054, 0.084], [0.028, 0.036], [0.054, 0.084], <=MX(21), mx(perp_dir));
drInvalidBCB_( xc(MX(141)), mx(b_all), mx(c_all), [0.028, 0.028], [0.056, 0.056], [0.076, 0.076], <=MX(21), mx(perp_dir));
drInvalidBCB_( xc(MX(142)), mx(b_all), mx(c_all), [0.028, 0.028], [0.054, 0.054], [0.076, 0.076], <=MX(21), mx(perp_dir));
...
drInvalidBC_( xc(MX(128)), mx(b_all), [0.054,0.084], mx(c_all), [0.028, 0.036], <=MX(21), mx(perp_dir), mx(TW));
...
drPassthruStack.push_front({ mx(b), {22,0} });
drPassthruStack.push_front({ mx(c), {114,0} });
drPassthruStack.push_front({ mx(b_synth), {22,1} });
drPassthruStack.push_front({ mx(c_synth), {114,1} });
