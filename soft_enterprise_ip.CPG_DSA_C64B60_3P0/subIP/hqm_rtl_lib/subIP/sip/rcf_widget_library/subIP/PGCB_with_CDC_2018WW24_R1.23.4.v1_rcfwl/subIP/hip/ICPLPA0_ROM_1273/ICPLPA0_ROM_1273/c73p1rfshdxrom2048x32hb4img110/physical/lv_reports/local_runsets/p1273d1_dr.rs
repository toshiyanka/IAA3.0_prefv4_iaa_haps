// $Header: /ds/data/2647/server_vault/Projects/drwork/x12dev_drwork/rst/x12dev_drwork_rst/PXL/1273/p1273d1_dr.rs.rca 1.19 Fri Oct  3 19:40:37 2014 dgthakur Experimental $ 
// $Log: p1273d1_dr.rs.rca $
// 
//  Revision: 1.19 Fri Oct  3 19:40:37 2014 dgthakur
//  updated for rev1.0 rules. 

#ifndef _P1273d1_DR_RS_
   #define _P1273d1_DR_RS_
   ...
   // -i /nfs/pdx/disks/drwork.disks.12/work_areas/dgthakur/1272drwork/db_root/drwork/x12dev_drwork/rst/x12dev_drwork_rst/Latest/PXL/mystuff/drfile/1273_full.1.txt 
   ...
   GD_109:double = 50; // Minimum Global Metal 9 Layer density (%)
   ...
   GD_209:double = 80; // Max Global Metal 9 layer density (%)
   ...
   IPD_211:double = 1000000; // Via10 (non vcc nodes)
   IPD_212:double = 1000000; // Via11 (non vcc nodes)
   ...
   IPD_311:double = 1000000; // Via10 (non vcc nodes)
   IPD_312:double = 1000000; // Via11 (non vcc nodes)
   ...
   IPN_11:double = 280; // Metal-10
   IPN_110:double = 275; // Metal-9
   IPN_111:double = 170; // Metal-10
   ...
   IPN_210:double = 850; // Metal-9
   IPN_211:double = 570; // Metal-10
   ...
   IPN_305:double = 210; // Via4
   IPN_306:double = 275; // Via5
   IPN_307:double = 275; // Via6
   IPN_308:double = 475; // Via7
   IPN_309:double = 475; // Via8
   IPN_310:double = 35; // Via9
   IPN_311:double = 95; // Via10
   ...
   IPN_405:double = 210; // Via4
   IPN_406:double = 275; // Via5
   IPN_407:double = 275; // Via6
   IPN_408:double = 475; // Via7
   IPN_409:double = 475; // Via8
   IPN_410:double = 35; // Via9
   IPN_411:double = 95; // Via10
   ...
   LDW_109:double = 25; // Window for LD_109
   ...
   LDW_209:double = 9; // Window for LD_209
   ...
   LDW_507:double = 6.8; // Window for LD_507
   ...
   LDW_508:double = 15; // Window for LD_508
   ...
   LDW_509:double = 53; // Window for LD_509
   ...
   LD_109:double = 40; // Min required local Metal 9 density (%), within a 25um x 25um window size
   ...
   LD_209:double = 90; // Max allowed local Metal 9 density (%), within a 9um x 9um window size
   ...
   LD_507:double = 0.21; // Min required local Via7 density (%), within a 6.8um x 6.8um window size
   LD_508:double = 0.3; // Min required local Via8 density (%), within a 15um x 15um window size
   LD_509:double = 0.5; // Min required local Via9 density (%), within a 53um x 53um window size
   ...
   M10_21:double = 0.126; // width_01 to width_01/03/05/06/09/10 space, fixed space1
   M10_22:double = 0.378; // width_01 to width_01/03/05/06/09/10 space, fixed space2
   M10_23:double = 0.63; // width_01 to width_01/03/05/06/09/10 space, fixed space3
   M10_24:double = 0.14; // width_02-10 to width_02-10 space, min unrestricted
   ...
   M5_21:double = 0.024; // B to C min space (fixed value for adjacent lines)
   ...
   M5_23:double = 0; // M5CID and M5BID layers can be used to force/flip drawn B/C layers and must fully cover the Metal-5 lines.
   ...
   M5_38:double = 0.076; // Min unrestricted space for rule M5_37
   ...
   M5_45:double = 0.055; // Max width for M5_44 check 
   M5_46:double = 0.024; // Space at which the line ends must be aligned or covered (fixed value) for M5_44 check
   M5_47:double = 0; // Lines <= M5_45 wide cannot be isolated (cannot be exposed on both sides), must be next to another narrow or wide line 
   M5_48:double = 0.07; // Minimum overlap of adjacent line ends in opposite directions at minimum space
   ...
   M8_09:double = 0.126; // width_09 value (OGD)
   M8_10:double = 0.378; // width_10 value (OGD only)
   M8_11:double = 0.468; // width_11 value (OGD only)
   ...
   M8_21:double = 0.08; // width_00 to width_00-05/09 space range1 min
   M8_22:double = 0.1; // width_00 to width_00-05/09 space range1 max
   M8_23:double = 0.23; // width_00 to width_00-11 space range2 min
   M8_24:double = 0.251; // width_00 to width_00-11 space range2 max
   M8_25:double = 0.4; // width_00 to width_00-11 unrestricted space min
   M8_26:double = 0.08; // width_00 to width_06/07/08/10/11 space range1 min
   M8_27:double = 0.11; // width_00 to width_06/07/08/10/11 space range1 max
   M8_32:double = 0.08; // width_02-11 to width_02-11 unrestricted space (min)
   M8_35:double = 0.12; // width_03 to width_03 unrestricted space (min) 
   M8_37:double = 0.12; // max edge lengths that can violate the forbidden spaces if space  between the edges is >=M8_38
   M8_38:double = 0.25; // Width_00-11 to width_00-11 unrestricted space (min) 
   ...
   M8_51:double = 0.08; // width_03 attacker to width_00-11 victim unrestricted space OGD (min)
   M8_52:double = 0.12; // width_00-11 attacker to width_03 victim unrestricted space PGD (min)
   ...
   M8_80:double = 0.113; // Corner-to-corner space, when corners have no overlap
   M8_81:double = 0.113; // Internal corner-to-corner width 
   M8_82:double = 0.12; // Width between facing concave corner extensions of opposite directions 
   ...
   M9_00:double = 0; // Only Rectangular M9 shape is allowed for width_01 and width_04/06/07/08 shield wires.
   M9_01:double = 0.54; // M9 width
   M9_02:double = 0.54; // M9 space
   M9_03:double = 0.192; // width_03 value (PGD only)
   M9_04:double = 0.21; // width_04 value (PGD/OGD)
   M9_05:double = 0.26; // width_05 value (PGD only)
   M9_06:double = 0.36; // width_06 value (PGD only)
   M9_07:double = 0.378; // width_07 value (PGD only)
   M9_08:double = 0.406; // width_08 value (PGD only)
   M9_09:double = 0.42; // width_09 value (PGD only)
   ...
   M9_21:double = 6; // Maximum allowed M9 width
   M9_22:double = 2.2; // Min required M9 hole area (sq um)
   M9_23:double = 0.54; // Minimum length of at least one M9 segment, when two segments are adjacent at a corner
   M9_24:double = 2.13; // Min required M9 length/extent
   M9_35:double = 0.14; // width_02/04 to width_02/04 space, min unrestricted
   M9_37:double = 0.198; // max edge lengths that can violate the forbidden spaces if space between the edges is >=M9_38
   M9_38:double = 0.378; // width_01-09 to width_01-09 unrestricted space (min) 
   M9_41:double = 0.05; // M9 coverage of Via8A (one edge at a corner)
   M9_42:double = 0.198; // Metal9 end-to-end space width_01 line to any line (min)
   M9_43:double = 0.13; // M9 coverage of Via8A orthogonal edge
   ...
   M9_51:double = 0.05; // M9 coverage of Via8B (one edge at a corner)
   M9_52:double = 0.13; // M9 coverage of Via8B orthogonal edge
   ...
   MIM_51:double = 0.4; // Minimum CE1/2 enclosure of Via9 (all directions)
   MIM_52:double = 1; // Min Via9 space to unconnected CE1/2
   MIM_53:double = 0; // Via9 cannot land on overlapping CE1/2
   MIM_54:double = 1.76; // Min Via9 space to unconnected CE1, when the Via9 is connected to 0 or 1 capacitor plates
   MIM_55:double = 1.6; // Min Via9 space to unconnected CE2, when the Via9 is connected to 0 or 1 capacitor plates
   MIM_61:double = 0; // CE1/2 electrode layers cannot be used as a resistor, must have a M9 or TM1 shunt
   ...
   TM1_51:double = 3; // Min TM1 coverage of Via9 (all directions)
   ...
   V10_31:double = 0.44; // Rectangular Via10 width, ONLY ALLOWED value
   V10_32:double = 0.88; // Rectangular Via10 length, ONLY ALLOWED value
   V10_33:double = 0.64; // Rectangular Via10 space to Via10 (square/rectangular, includes all combinations of long edges, short edges, and corners), all-directional check
   V10_51:double = 0.08; // M10 enclosure of Rectangular Via10
   ...
   V4_128:double = 0.076; // Unrestricted min Via4 edge-to-edge space, between SA edges
   ...
   V4_152:double = 0.027; // Min Via4 to Via3 edge-to-edge space (on different Metal4)
   ...
   V4_22:double = 0.104; // Unrestricted V4A-to-V4A center-to-center space (min)
   V4_228:double = 0.08; // Unrestricted min V4HA SA edge to SA edge of any via4
   V4_23:double = 0.024; // Parallel full-facing metal-aligned Via4 edges can be as closely spaced as the minimum allowed M5 space.  (only allowed value)
   V4_24:double = 0.048; // Min Via4 corner-to-corner space (Note that space values between V4_24 and V4_250 come with restrictions)
   ...
   V4_28:double = 0.072; // Unrestricted min Via4 edge-to-edge space, between non-SA edges
   ...
   V4_32:double = 0.023; // Min Via4 to Via3 corner-to-corner space (on different Metal4)
   ...
   V4_42:double = 0.03; // Minimum Via4TA/TB overlap of Metal4 (PGD). If M4 width is <V4_42, then Via4TA/TB OGD edge enclosure of M4 inside edge must be >=V4_42.
   ...
   V4_49:double = 0.009; // Min Metal4 line-end enclosure of Via4
   ...
   V4_61:double = 0.024; // Min M5 line-end enclosure of Via4 
   ...
   V5_22:double = 0.095; // Unrestricted V5A-to-V5A center-to-center space (min)
   V5_23:double = 0.04; // Parallel full-facing metal-aligned Via5 edges can be as closely spaced as the minimum allowed M6 space. (min value, allowed up to max value <V5_128)
   ...
   V5_32:double = 0.025; // Min Via5 to Via4 corner-to-corner space (on different Metal5)
   V5_33:double = 0.022; // Min Via5 edge space to Metal5
   ...
   V5_61:double = 0.022; // Min Metal6 line-end enclosure of Via5  (except Via5YZ)
   ...
   V7_10:double = 0.126; // Via7HS length (PGD), fixed value
   ...
   V7_121:double = 0.132; // Via7ZT width (OGD), fixed value (SA edges)
   V7_122:double = 0.15; // Via7ZT length (PGD), fixed value
   ...
   V7_131:double = 0.074; // Via7HA width (OGD), fixed value
   V7_132:double = 0.264; // Via7HA length (PGD), fixed value
   ...
   V7_22:double = 0.195; // Via7AS-to-Via7AS center-to-center space (on different M7 lines)
   V7_23:double = 0.08; // Parallel full-facing metal-aligned Via7 edges can be as closely spaced as the minimum allowed M8 space. 
   V7_230:double = 0.164; // Max value for rule V7_23 spacing check
   V7_24:double = 0.088; // Via7 corner-to-corner space
   V7_28:double = 0.15; // Unrestricted min Via7 edge-to-edge space (non-SA edges)
   V7_29:double = 0.038; // Via7 min edge offset if corner-to-corner space is less than V7_30
   V7_30:double = 0.15; // Via7  corner-to-corner space limit for V7_29
   V7_32:double = 0.046; // Via7 to Via6 space (on different Metal7, all-directional check)
   V7_33:double = 0.041; // Via7 edge space to Metal7
   V7_40:double = 0.009; // Maximum Via7 overhang of Metal7 (OGD/PGD)
   V7_401:double = 0.009; // Min Metal7 enclosure of Via7ZT (V7_40 not allowed for Via7ZT)
   V7_402:double = 0.005; // Min Metal7 enclosure of Via7HA (V7_40 not allowed fro Via7HA)
   ...
   V7_51:double = 0; // Both opposite edges of a aligned via must be metal aligned (except for Via7ZT and Via7HA)
   ...
   V7_54:double = 0.028; // Metal8 concave corner space to Via7
   V7_60:double = 0.057; // Metal8 lateral enclosure of Via7HA (in PGD) (min)
   V7_61:double = 0.028; // Metal8 line-end enclosure of Via7 
   V7_63:double = 0; // Via7ZT not allowed under width_01 - 09 M8 (only width_10/11 allowed to cover Via7ZT)
   ...
   V8_00:double = 0.38; // Square Via8 (Via8A) width (PGD), ONLY ALLOWED value
   V8_01:double = 0.44; // Square Via8 (Via8A) length (OGD), ONLY ALLOWED value
   V8_02:double = 1.115; // Square Via8 to Square Via8 (center-to-center) separation
   V8_101:double = 0.11; // Square Via8SA ONLY ALLOWED value
   V8_11:double = 0.044; // M8 enclosure of Square Via8
   V8_12:double = 0.08; // M8 enclosure of Square Via8, orthogonal edge
   ...
   V8_31:double = 0.38; // Rectangular Via8 (Via8B) width (PGD), ONLY ALLOWED value
   V8_32:double = 0.88; // Rectangular Via8 (Via8B) length (OGD), ONLY ALLOWED value
   V8_33:double = 0.64; // Rectangular Via8 space to Via8 (square/rectangular, includes all combinations of long edges, short edges, and corners), all-directional check
   ...
   V8_41:double = 0.18; // Rectangular Via8 to Via7 (square/rectangular) space (on different M8 net, all-directional check)
   V8_51:double = 0.044; // M8 enclosure of Rectangular Via8
   V8_52:double = 0.08; // M8 enclosure of Rectangular Via8, orthogonal edge
   V8_53:double = 0.018; // Max extent of Rectangular Via8 short edge beyond M8 side
   V8_61:double = 0; // M9 coverage of Square Via8 (one edge at a corner)
   ...
   V9_01:double = 0.14; // Square Via9 size ONLY ALLOWED value
   V9_02:double = 0.356; // Square Via9 to Square Via9 (center-to-center) separation
   V9_11:double = 0.007; // Maximum Square Via9 overhang of Metal9
   V9_12:double = 0.04; // M9 enclosure of Square Via9, orthogonal edge
   V9_21:double = 0.21; // Square Via9 to Via8 (square/rectangular) space (on different M9 net, all-directional check)
   V9_31:double = 0.8; // Width of Via9A/B/C, fixed value
   V9_32:double = 1.85; // Via9A length, fixed value
   V9_33:double = 7.4; // Via9B length, fixed value
   ...
   V9_40:double = 2; // Min Via9 to Via9 space (all directions)
   V9_41:double = 2.5; // Min Via9 to Via9 corner-to-corner space
   V9_51:double = 0.14; // Min M9 enclosure of Via9 (all directions)
   V9_52:double = 0.04; // M9 enclosure of Rectangular Via9, orthogonal edge
   ...
   VD_09:double = 0.46; // Via8 space threshold that subjects the array to max area check
   ...
   VD_19:double = 0.838; // Via 8 array width exception limit
   ...
   VD_29:double = 47.47; // Maximum Via 8 array area after merge and exception
   ...
   VD_59:double = 18.4; // Max width of merged Via 8 array
   ...
   drHash:typeHashString2String = { 
      ...
      xc(LD_109) => "Min required local Metal 9 density (%), within a 25um x 25um window size",
      ...
      xc(LD_209) => "Max allowed local Metal 9 density (%), within a 9um x 9um window size",
      ...
      xc(LD_507) => "Min required local Via7 density (%), within a 6.8um x 6.8um window size",
      xc(LD_508) => "Min required local Via8 density (%), within a 15um x 15um window size",
      xc(LD_509) => "Min required local Via9 density (%), within a 53um x 53um window size",
      ...
      xc(M10_21) => "width_01 to width_01/03/05/06/09/10 space, fixed space1",
      xc(M10_22) => "width_01 to width_01/03/05/06/09/10 space, fixed space2",
      xc(M10_23) => "width_01 to width_01/03/05/06/09/10 space, fixed space3",
      xc(M10_24) => "width_02-10 to width_02-10 space, min unrestricted",
      ...
      xc(M5_21) => "B to C min space (fixed value for adjacent lines)",
      ...
      xc(M5_23) => "M5CID and M5BID layers can be used to force/flip drawn B/C layers and must fully cover the Metal-5 lines.",
      ...
      xc(M5_38) => "Min unrestricted space for rule M5_37",
      ...
      xc(M5_45) => "Max width for M5_44 check ",
      xc(M5_46) => "Space at which the line ends must be aligned or covered (fixed value) for M5_44 check",
      xc(M5_47) => "Lines <= M5_45 wide cannot be isolated (cannot be exposed on both sides), must be next to another narrow or wide line ",
      xc(M5_48) => "Minimum overlap of adjacent line ends in opposite directions at minimum space",
      ...
      xc(M8_09) => "width_09 value (OGD)",
      xc(M8_10) => "width_10 value (OGD only)",
      xc(M8_11) => "width_11 value (OGD only)",
      ...
      xc(M8_21) => "width_00 to width_00-05/09 space range1 min",
      xc(M8_22) => "width_00 to width_00-05/09 space range1 max",
      xc(M8_23) => "width_00 to width_00-11 space range2 min",
      xc(M8_24) => "width_00 to width_00-11 space range2 max",
      xc(M8_25) => "width_00 to width_00-11 unrestricted space min",
      xc(M8_26) => "width_00 to width_06/07/08/10/11 space range1 min",
      xc(M8_27) => "width_00 to width_06/07/08/10/11 space range1 max",
      xc(M8_32) => "width_02-11 to width_02-11 unrestricted space (min)",
      ...
      xc(M8_38) => "Width_00-11 to width_00-11 unrestricted space (min) ",
      ...
      xc(M8_51) => "width_03 attacker to width_00-11 victim unrestricted space OGD (min)",
      xc(M8_52) => "width_00-11 attacker to width_03 victim unrestricted space PGD (min)",
      ...
      xc(M9_00) => "Only Rectangular M9 shape is allowed for width_01 and width_04/06/07/08 shield wires.",
      xc(M9_01) => "M9 width",
      xc(M9_02) => "M9 space",
      xc(M9_03) => "width_03 value (PGD only)",
      ...
      xc(M9_21) => "Maximum allowed M9 width",
      xc(M9_22) => "Min required M9 hole area (sq um)",
      xc(M9_23) => "Minimum length of at least one M9 segment, when two segments are adjacent at a corner",
      xc(M9_24) => "Min required M9 length/extent",
      xc(M9_35) => "width_02/04 to width_02/04 space, min unrestricted",
      xc(M9_37) => "max edge lengths that can violate the forbidden spaces if space between the edges is >=M9_38",
      xc(M9_38) => "width_01-09 to width_01-09 unrestricted space (min) ",
      xc(M9_41) => "M9 coverage of Via8A (one edge at a corner)",
      xc(M9_42) => "Metal9 end-to-end space width_01 line to any line (min)",
      xc(M9_43) => "M9 coverage of Via8A orthogonal edge",
      ...
      xc(M9_51) => "M9 coverage of Via8B (one edge at a corner)",
      xc(M9_52) => "M9 coverage of Via8B orthogonal edge",
      ...
      xc(MIM_51) => "Minimum CE1/2 enclosure of Via9 (all directions)",
      xc(MIM_52) => "Min Via9 space to unconnected CE1/2",
      xc(MIM_53) => "Via9 cannot land on overlapping CE1/2",
      xc(MIM_54) => "Min Via9 space to unconnected CE1, when the Via9 is connected to 0 or 1 capacitor plates",
      xc(MIM_55) => "Min Via9 space to unconnected CE2, when the Via9 is connected to 0 or 1 capacitor plates",
      xc(MIM_61) => "CE1/2 electrode layers cannot be used as a resistor, must have a M9 or TM1 shunt",
      ...
      xc(TM1_51) => "Min TM1 coverage of Via9 (all directions)",
      ...
      xc(V10_33) => "Rectangular Via10 space to Via10 (square/rectangular, includes all combinations of long edges, short edges, and corners), all-directional check",
      xc(V10_51) => "M10 enclosure of Rectangular Via10",
      ...
      xc(V4_23) => "Parallel full-facing metal-aligned Via4 edges can be as closely spaced as the minimum allowed M5 space.  (only allowed value)",
      xc(V4_24) => "Min Via4 corner-to-corner space (Note that space values between V4_24 and V4_250 come with restrictions)",
      ...
      xc(V4_28) => "Unrestricted min Via4 edge-to-edge space, between non-SA edges",
      ...
      xc(V4_42) => "Minimum Via4TA/TB overlap of Metal4 (PGD). If M4 width is <V4_42, then Via4TA/TB OGD edge enclosure of M4 inside edge must be >=V4_42.",
      ...
      xc(V4_61) => "Min M5 line-end enclosure of Via4 ",
      ...
      xc(V5_22) => "Unrestricted V5A-to-V5A center-to-center space (min)",
      xc(V5_23) => "Parallel full-facing metal-aligned Via5 edges can be as closely spaced as the minimum allowed M6 space. (min value, allowed up to max value <V5_128)",
      ...
      xc(V5_32) => "Min Via5 to Via4 corner-to-corner space (on different Metal5)",
      ...
      xc(V5_61) => "Min Metal6 line-end enclosure of Via5  (except Via5YZ)",
      ...
      xc(V7_10) => "Via7HS length (PGD), fixed value",
      ...
      xc(V7_121) => "Via7ZT width (OGD), fixed value (SA edges)",
      xc(V7_122) => "Via7ZT length (PGD), fixed value",
      ...
      xc(V7_131) => "Via7HA width (OGD), fixed value",
      xc(V7_132) => "Via7HA length (PGD), fixed value",
      ...
      xc(V7_22) => "Via7AS-to-Via7AS center-to-center space (on different M7 lines)",
      ...
      xc(V7_401) => "Min Metal7 enclosure of Via7ZT (V7_40 not allowed for Via7ZT)",
      xc(V7_402) => "Min Metal7 enclosure of Via7HA (V7_40 not allowed fro Via7HA)",
      ...
      xc(V7_51) => "Both opposite edges of a aligned via must be metal aligned (except for Via7ZT and Via7HA)",
      ...
      xc(V7_54) => "Metal8 concave corner space to Via7",
      xc(V7_60) => "Metal8 lateral enclosure of Via7HA (in PGD) (min)",
      xc(V7_61) => "Metal8 line-end enclosure of Via7 ",
      xc(V7_63) => "Via7ZT not allowed under width_01 - 09 M8 (only width_10/11 allowed to cover Via7ZT)",
      ...
      xc(V8_00) => "Square Via8 (Via8A) width (PGD), ONLY ALLOWED value",
      xc(V8_01) => "Square Via8 (Via8A) length (OGD), ONLY ALLOWED value",
      xc(V8_02) => "Square Via8 to Square Via8 (center-to-center) separation",
      xc(V8_101) => "Square Via8SA ONLY ALLOWED value",
      xc(V8_11) => "M8 enclosure of Square Via8",
      ...
      xc(V8_31) => "Rectangular Via8 (Via8B) width (PGD), ONLY ALLOWED value",
      xc(V8_32) => "Rectangular Via8 (Via8B) length (OGD), ONLY ALLOWED value",
      xc(V8_33) => "Rectangular Via8 space to Via8 (square/rectangular, includes all combinations of long edges, short edges, and corners), all-directional check",
      ...
      xc(V8_51) => "M8 enclosure of Rectangular Via8",
      ...
      xc(V8_61) => "M9 coverage of Square Via8 (one edge at a corner)",
      ...
      xc(V9_11) => "Maximum Square Via9 overhang of Metal9",
      ...
      xc(V9_31) => "Width of Via9A/B/C, fixed value",
      xc(V9_32) => "Via9A length, fixed value",
      xc(V9_33) => "Via9B length, fixed value",
      ...
      xc(V9_40) => "Min Via9 to Via9 space (all directions)",
      xc(V9_41) => "Min Via9 to Via9 corner-to-corner space",
      xc(V9_51) => "Min M9 enclosure of Via9 (all directions)",
      ...
      xc(VD_09) => "Via8 space threshold that subjects the array to max area check",
      ...
      xc(VD_19) => "Via 8 array width exception limit",
      ...
      xc(VD_29) => "Maximum Via 8 array area after merge and exception",
      ...
      xc(VD_59) => "Max width of merged Via 8 array",
   ...
   Error_M8_11 = empty_violation();
   drErrHash[xc(M8_11)] = Error_M8_11;
   ...
   Error_V7_121 = empty_violation();
   drErrHash[xc(V7_121)] = Error_V7_121;
   Error_V7_122 = empty_violation();
   drErrHash[xc(V7_122)] = Error_V7_122;
   Error_V7_128 = empty_violation();
   drErrHash[xc(V7_128)] = Error_V7_128;
   Error_V7_13 = empty_violation();
   drErrHash[xc(V7_13)] = Error_V7_13;
   Error_V7_131 = empty_violation();
   drErrHash[xc(V7_131)] = Error_V7_131;
   Error_V7_132 = empty_violation();
   drErrHash[xc(V7_132)] = Error_V7_132;
   ...
   Error_V7_401 = empty_violation();
   drErrHash[xc(V7_401)] = Error_V7_401;
   Error_V7_402 = empty_violation();
   drErrHash[xc(V7_402)] = Error_V7_402;
   ...
   Error_V7_60 = empty_violation();
   drErrHash[xc(V7_60)] = Error_V7_60;
   Error_V7_61 = empty_violation();
   drErrHash[xc(V7_61)] = Error_V7_61;
   Error_V7_63 = empty_violation();
   drErrHash[xc(V7_63)] = Error_V7_63;
   ...
   Error_V8_00 = empty_violation();
   drErrHash[xc(V8_00)] = Error_V8_00;
