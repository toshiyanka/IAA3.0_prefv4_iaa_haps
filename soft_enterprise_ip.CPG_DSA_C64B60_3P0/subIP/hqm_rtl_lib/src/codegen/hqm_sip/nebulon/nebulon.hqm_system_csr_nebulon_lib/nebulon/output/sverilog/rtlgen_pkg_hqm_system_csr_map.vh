...
//                                                                             
// File:            rtlgen_pkg_hqm_system_csr_map.vh                           
...
`ifndef CFGPKG_hqm_system_csr_map
`define CFGPKG_hqm_system_csr_map
...
package rtlgen_pkg_hqm_system_csr_map;
...
// CR 48 bits address
localparam CR_CR48_ADDR_HI = 47;
typedef struct packed { // 48
    logic [CR_CR48_ADDR_HI:0] offset;
} cfg_addr_cr48_t;
...
endpackage: rtlgen_pkg_hqm_system_csr_map
