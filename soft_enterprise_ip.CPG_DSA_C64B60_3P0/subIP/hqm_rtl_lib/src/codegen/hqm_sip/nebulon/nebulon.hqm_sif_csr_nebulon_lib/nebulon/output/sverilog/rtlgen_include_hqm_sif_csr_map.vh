...
//                                                                             
// File:            rtlgen_include_hqm_sif_csr_map.vh                          
...
`ifndef RTLGEN_INC_hqm_sif_csr_map
`define RTLGEN_INC_hqm_sif_csr_map
...
`define IMPORT_RTLGEN_LATEST_PKG import rtlgen_pkg_hqm_sif_csr_map::*; 
`endif
