...
set included_instances   {htap2 htap0 usc*}
# Examples to include only specific instance (please comment out 'set included_instances {*}' above!):
...
set excluded_modules {*intel_tap_ir* *intel_bypass_rsvd_reg}
#set excluded_modules {*intel_htap_sel *intel_tap_ir* *intel_bypass_rsvd_reg ijtag_sib sib *iov_ctrl* *__SCANDUMP_CHAIN *dfx_mem_wrapper* *_ssh_*}
...
set ir_module_names {*intel_tap_ir*}; #  * for parameterized modules
set ir_reg_names {}
