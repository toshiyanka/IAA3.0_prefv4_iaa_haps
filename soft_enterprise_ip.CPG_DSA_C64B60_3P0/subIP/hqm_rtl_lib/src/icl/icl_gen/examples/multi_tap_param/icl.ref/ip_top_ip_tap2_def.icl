...
Module ip_top_ip_tap2_def {
   ...
   LocalParameter regA1_DR_SIZE = 4 + $T2FA2_WIDTH + $T2FA3_WIDTH;
   LocalParameter regA2_DR_SIZE = 4 + $T2FA2_WIDTH + $T2FA3_WIDTH;
   LocalParameter regB_DR_SIZE = 4 + $T2FB2_WIDTH;
   ...
   //---------------------------
   Instance SLVIDCODE Of ip_top_ip_tap2_def_slvidcode_def {
   ...
   //---------------------------
   Instance regA1 Of ip_top_ip_tap2_def_regA_def {
   ...
   //---------------------------
   Instance regA2 Of ip_top_ip_tap2_def_regA_def {
      Parameter T2FA2_WIDTH = $T2FA2_WIDTH;
      Parameter T2FA3_WIDTH = $T2FA3_WIDTH;
   ...
   //---------------------------
   Instance regB Of ip_top_ip_tap2_def_regB_def {
   ...
   //---------------------------
   Instance BYPASS Of ip_top_ip_tap2_def_bypass_def {
...
//---------------------------
Module ip_top_ip_tap2_def_slvidcode_def {
   ...
   ScanRegister DR[31:0] {
      ...
      CaptureSource  32'b1001000110100010101100111;
   }
   Alias value[31:0] = DR[31:0] {
      Attribute intel_desc = "Slave ID code value for given TAP.";
      Attribute intel_AccessType = "RO";
   }
} // end of ip_top_ip_tap2_def_slvidcode_def

//---------------------------
Module ip_top_ip_tap2_def_regA_def {

   // Parameters
   Parameter T2FA2_WIDTH = 1;
   Parameter T2FA3_WIDTH = 1;

   LocalParameter F2_SIZE = $T2FA2_WIDTH;
   LocalParameter F2_MSB = 3 + $T2FA2_WIDTH;
   LocalParameter F3_LSB = 4 + $T2FA2_WIDTH;
   LocalParameter F3_SIZE = $T2FA3_WIDTH;
   LocalParameter F3_MSB = 3 + $T2FA2_WIDTH + $T2FA3_WIDTH;
...
} // end of ip_top_ip_tap2_def_regA_def

//---------------------------
Module ip_top_ip_tap2_def_regB_def {

   // Parameters
   Parameter T2FB2_WIDTH = 8;

   LocalParameter F2_SIZE = $T2FB2_WIDTH;
   LocalParameter F2_MSB = 3 + $T2FB2_WIDTH;
...
} // end of ip_top_ip_tap2_def_regB_def

//---------------------------
Module ip_top_ip_tap2_def_bypass_def {
...
} // end of ip_top_ip_tap2_def_bypass_def
