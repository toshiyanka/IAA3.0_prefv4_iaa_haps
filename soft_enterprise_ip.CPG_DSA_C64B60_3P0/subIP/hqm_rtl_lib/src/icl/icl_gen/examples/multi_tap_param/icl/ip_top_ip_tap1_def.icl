...
Module ip_top_ip_tap1_def {
   ...
   LocalParameter regA1_DR_SIZE = 4 + $T1FA2_WIDTH + $T1FA3_WIDTH;
   LocalParameter regA2_DR_SIZE = 4 + $T1FA2_WIDTH + $T1FA3_WIDTH;
   LocalParameter regB_DR_SIZE = $T1FB1_WIDTH + $T1FB2_WIDTH;
   ...
   //---------------------------
   Instance regA1 Of ip_top_ip_tap1_def_regA_def {
   ...
   //---------------------------
   Instance regA2 Of ip_top_ip_tap1_def_regA_def {
      Parameter T1FA2_WIDTH = $T1FA2_WIDTH;
      Parameter T1FA3_WIDTH = $T1FA3_WIDTH;
...
Module ip_top_ip_tap1_def_regA_def {
   ...
   LocalParameter F2_SIZE = $T1FA2_WIDTH;
   LocalParameter F2_MSB = 3 + $T1FA2_WIDTH;
   LocalParameter F3_LSB = 4 + $T1FA2_WIDTH;
   LocalParameter F3_SIZE = $T1FA3_WIDTH;
   LocalParameter F3_MSB = 3 + $T1FA2_WIDTH + $T1FA3_WIDTH;
...
Module ip_top_ip_tap1_def_regB_def {
   ...
   LocalParameter F1_SIZE = $T1FB1_WIDTH;
   LocalParameter F1_MSB = $T1FB1_WIDTH - 1;
   LocalParameter F2_LSB = $T1FB1_WIDTH;
   LocalParameter F2_SIZE = $T1FB2_WIDTH;
   LocalParameter F2_MSB = $T1FB1_WIDTH + $T1FB2_WIDTH - 1;
