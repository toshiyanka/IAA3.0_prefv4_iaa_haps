...
Module ip_top_ip_tap1_def {
   ...
   ResetPort      fdfx_powergood_d1 { ActivePolarity 0;}
   ResetPort      fdfx_powergood_d2 { ActivePolarity 0;}
   ...
   Instance regA2 Of ip_top_ip_tap1_def_regA_def {
      ...
      Attribute intel_TapRegResetType = "PWRGOOD_D2";
      Attribute intel_TapOpcodeSecurityLevel = "SECURE_RED";
      InputPort   si = Tdi;
      InputPort   rstn = fdfx_powergood_d2;
   }
   ...
   Instance regB Of ip_top_ip_tap1_def_regB_def {
      ...
      Attribute intel_TapOpcodeSecurityLevel = "SECURE_GREEN";
      Attribute intel_TapRegResetType = "PWRGOOD_D1";
      InputPort   si = Tdi;
      InputPort   rstn = fdfx_powergood_d1;
   }
