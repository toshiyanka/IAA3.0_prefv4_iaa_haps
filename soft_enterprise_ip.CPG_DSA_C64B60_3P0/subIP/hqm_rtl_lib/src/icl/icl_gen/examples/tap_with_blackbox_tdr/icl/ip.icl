...
Module ip {
   ...
   LocalParameter regBB_OPCODE = 'h40;
   ...
   LocalParameter regBB_DR_SIZE = "VARIABLE";
   ...
   LocalParameter regBB_SECURITY = $GREEN;
   ...
   ScanMux dr_mux SelectedBy IR.tir_out, unlock_red, unlock_orange_or_red {
      ...
      $regBB_OPCODE, $regBB_SECURITY: regBB.so;
   ...
   //---------------------------
   Instance regBB Of ip_with_tap_def_regBB_def {
...
//---------------------------
Module ip_with_tap_def_regBB_def {

   Attribute intel_desc = "Blackbox Register";
   ...
   ScanInterface c_bb {
      ...
      Port so;
      Port sel;
      DefaultLoadValue 12'b1;
   }
} // end of ip_with_tap_def_regBB_def
