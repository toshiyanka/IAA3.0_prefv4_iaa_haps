...
Module ip {
   ...
   DataInPort     ftap_slvidcode_1[31:0] { DefaultLoadValue 32'h0a1;}

   DataOutPort    enable_1[3:0] { Source tap1.tdr_out_regA__f1;}
   ...
   Instance tap1 Of ip_top_ip_tap1_def {
      ...
      InputPort   tdr_in_SLVIDCODE = ftap_slvidcode_1[31:0];
   }
   //---------------------------
   ...
   DataInPort     ftap_slvidcode_2[31:0] { DefaultLoadValue 32'h0a3;}
   ...
   Instance tap2 Of ip_top_ip_tap2_def {
      ...
      InputPort   fdfx_powergood     = fdfx_powergood;
      InputPort   fdfx_secure_policy = fdfx_secure_policy[3:0];
      InputPort   tdr_in_SLVIDCODE = ftap_slvidcode_2[31:0];
   }
   ...
   DataOutPort    enable_A[3:0] { Source regA.tdr_out_f1;}
...
Module ip_top_regB_def {
   ...
   DataInPort    tdr_in_f2[7:0];

   ScanRegister DR[11:0] {
      ScanInSource   si;
      ResetValue     12'b101;
      CaptureSource  tdr_in_f2,4'b101;
   }
   Alias f1[3:0] = DR[3:0] {
      Attribute intel_desc = "f1 description";
