...
# Saved on Fri Aug 26 01:54:36 2016
# Designs open: 1
#   V1: dump.vpd
...
#<Session mode="View" path="/nfs/site/disks/axx_0046/users/amlawand/hqm_ww35c/verif/tb/hqm/tests/hqm_iosf_sideband_test/session.dump.vpd1.tcl" type="Debug">
...
if {$selectedCount != 0} {
   ...
   gui_list_select -id ${Hier.1}  -current_item_name hqm_tb_top.u_hqm -current_item_type Scope  $selected 
}
gui_show_window -window ${Hier.1}
gui_list_set_filter -id ${Hier.1} -list { {Package 1} {All 0} {Process 1} {VirtPowSwitch 0} {UnnamedProcess 1} {UDP 0} {Function 1} {Block 1} {SrsnAndSpaCell 0} {OVA Unit 1} {LeafScCell 1} {LeafVlgCell 1} {Interface 1} {LeafVhdCell 1} {$unit 1} {NamedBlock 1} {Task 1} {VlgPackage 1} {ClassDef 1} {VirtIsoCell 0} }
gui_list_set_filter -id ${Hier.1} -text {*}
gui_change_design -id ${Hier.1} -design V1
catch {gui_list_expand -id ${Hier.1} hqm_tb_top}
catch {gui_list_select -id ${Hier.1} {hqm_tb_top.u_hqm}}
