...
set log file sbendpoint_lec.log -replace
...
set mapping method -name first -phase -BBOX_NAME_MATCH -nounreach
...
report key point -unmapped -both        > results/sbendpoint_unmapped.rpt
report floating signals -undriven -both > results/sbendpoint_undriven.rpt
...
report compare data -nonequivalent > results/sbendpoint_compare_data.rpt
