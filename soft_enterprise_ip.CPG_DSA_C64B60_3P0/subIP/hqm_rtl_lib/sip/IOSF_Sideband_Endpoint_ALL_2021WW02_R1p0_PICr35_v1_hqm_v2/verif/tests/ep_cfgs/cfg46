...
parameter AGT_CLK_PERIOD=5815;
parameter AGT_EXT_HEADER_SUPPORT=1;
parameter ASYNCENDPT=0;
parameter ASYNCEQDEPTH=2;
parameter ASYNCIQDEPTH=2;
...
parameter UNIQUE_EXT_HEADERS=0;
