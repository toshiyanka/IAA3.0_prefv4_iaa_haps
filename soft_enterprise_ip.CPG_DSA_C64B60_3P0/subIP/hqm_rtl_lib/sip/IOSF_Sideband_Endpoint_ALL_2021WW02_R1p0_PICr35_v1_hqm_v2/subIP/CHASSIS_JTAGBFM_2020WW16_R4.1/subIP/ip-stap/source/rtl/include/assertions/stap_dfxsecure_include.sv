...
`ifdef DFX_ASSERTIONS
   ...
   property dfxsecure_all_en_is_1_when_ftap_dfxsecure_is_all_1;
      @(ftap_dfxsecure)
      dfxsecure_all_en |-> (ftap_dfxsecure == {DFXSECURE_STAP_DFX_SECURE_WIDTH{HIGH}});
   ...
   property dfxsecure_all_dis_is_1_when_ftap_dfxsecure_is_all_0;
      @(ftap_dfxsecure)
      dfxsecure_all_dis |-> (ftap_dfxsecure == {DFXSECURE_STAP_DFX_SECURE_WIDTH{LOW}});
   ...
   // ====================================================================
   generate
      for (genvar j = 2; j < DFXSECURE_STAP_NUMBER_OF_DFX_FEATURES_TO_SECURE; j++)
      begin
