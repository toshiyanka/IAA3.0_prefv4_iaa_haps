...
if { ! [info exist TCL_ARGS_stap] } {
    ...
    if { ![info exists REPO_ROOT] } {
      if { [info exists env(REPO_ROOT)] } {
        ...
        set REPO_ROOT /nfs/iind/disks/dteg_disk011/users/svbandan/STAp-TSA/dteg-stap/target/stap/TGL/aceroot
      }
    }
...
if {[info exist CTECH_TYPE] && [info exist CTECH_VARIANT]} {
   set VERILOG_CTECH_FILES_ADD [concat $VERILOG_CTECH_FILES_ADD [glob /p/hdk/cad/ctech/c2v16ww47e_hdk141/source/p1274/$CTECH_TYPE/$CTECH_VARIANT/ctech_lib_*.{sv,v,vs} /p/hdk/cad/ctech/ctech_exp_c2v16ww52e_hdk142/source/p1274/$CTECH_TYPE/$CTECH_VARIANT/ctech_lib_*.{sv,v,vs}]]
}
