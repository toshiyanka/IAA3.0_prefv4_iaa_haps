// $Header: /ds/data/2647/server_vault/Projects/drwork/x12dev_drwork/rst/x12dev_drwork_rst/PXL/1273/p1273d6_Tconn.rs.rca 1.56 Thu Jan  8 10:35:55 2015 kperrey Experimental $

// $Log: p1273d6_Tconn.rs.rca $
// 
//  Revision: 1.56 Thu Jan  8 10:35:55 2015 kperrey
//  hsd 2997; updates from Mahesh
// 
//  Revision: 1.55 Tue Dec 30 14:29:02 2014 kperrey
//  need to connect polycon to poly_glbcon since _drTreatGCNStrapAsReal now activates dummies which were previously ignored
// 
//  Revision: 1.54 Wed Nov 26 14:51:36 2014 kperrey
//  made 2nd poly_nores a poly_glbcon ; original rcextract code created open
// 
//  Revision: 1.53 Thu Oct 30 17:00:49 2014 kperrey
//  updates from srimathi ; vianores stomp on via update for rcextract
// 
//  Revision: 1.52 Thu Sep 25 10:13:04 2014 kperrey
//  hsd 2742 ; need to have/text poly_glbcon(poly - resid) layer for full texting to occur (handle text on the gate)
// 
//  Revision: 1.51 Fri Sep  5 13:14:17 2014 kperrey
//  in RCextract have to fully connect the stomped on VIA* layer
// 
//  Revision: 1.50 Sat Aug 16 12:49:15 2014 kperrey
//  moved drc checks to p1273d6_Tchks.rs ; VIA* now via*nores to support scv/scvx icf devices
// 
//  Revision: 1.49 Tue Aug  5 22:23:40 2014 kperrey
...
// 
//  Revision: 1.48 Mon Aug  4 16:34:32 2014 kperrey
//  hsd 2606 ; the subtaps(ppickups) in deepnwell were not check
// 
//  Revision: 1.47 Thu Jul 31 22:45:42 2014 kperrey
//  hsd 2425 ; support for sov/sovx/scv/scvm via resistors ; and the via*nores layer
// 
//  Revision: 1.46 Fri Jul 25 16:49:31 2014 kperrey
//  fix cut/paste typo; include file should be p12723_UserTextPriority.rs
// 
//  Revision: 1.45 Mon Jul 21 21:29:25 2014 kperrey
//  updated short_debugging = {vue_short_finder = true, static_output = {graphics = NONE, ascii = true}}
// 
//  Revision: 1.44 Mon Jul 21 20:52:44 2014 kperrey
...
// 
//  Revision: 1.43 Sun Jul 20 16:15:43 2014 kperrey
//  switch layers for pwellsubisopin if _drRCextract
// 
//  Revision: 1.42 Thu Jul 17 20:28:14 2014 kperrey
//  hsd 2567 ; connect mos_ngate_ulv1, mos_pgate_ulv1 by poly_nores ; bodies of nulv1/pulv1 gates
// 
//  Revision: 1.41 Thu Jul 17 11:29:58 2014 kperrey
//  include p1273dx_Tconn_sclmfc.rs for scaleable mfc support
// 
//  Revision: 1.40 Fri Jun 20 12:31:35 2014 kperrey
//  attempt to support nwell/nwellesd/pwellsubiso port/pins
// 
//  Revision: 1.39 Tue Jun  3 09:49:55 2014 kperrey
//  added handling for _drRFblock (a rcextract thing) from srimathi
// 
//  Revision: 1.38 Tue May 20 13:58:19 2014 kperrey
//  hsd 2392 ; change drNO to _drNO which is the actual define
// 
//  Revision: 1.37 Thu May  1 17:25:49 2014 kperrey
//  hsd 2336; DEEPNWELL needs to be part of layer2 (ie all the welltaps need to be the same node in layer2)
// 
//  Revision: 1.36 Mon Apr 28 10:58:09 2014 kperrey
//  change connect name for SD_ERR check to match the dx file
// 
//  Revision: 1.35 Mon Apr 14 09:23:04 2014 kperrey
//  hsd 2255, metal12 connonects when ICFMIM active ; add softconn check to ensure all gates within a STACKDEVTYPE are the same node
// 
//  Revision: 1.34 Tue Mar 18 16:40:21 2014 kperrey
//  mim_scl stuff ; different than source ; use CE1/CE2 to connect the top/bottem plates instead of via12
// 
//  Revision: 1.33 Tue Mar 18 10:28:47 2014 kperrey
//  support a m9(d1) or m12(d6) stack; removed a large chunk of commented out old code
// 
//  Revision: 1.32 Fri Mar 14 16:12:57 2014 kperrey
//  add path rcext to includes as needed
// 
//  Revision: 1.31 Mon Mar  3 13:49:24 2014 kperrey
//  hsd 2165 ; remove poly_nores_nogate referance now just all poly_nores
// 
//  Revision: 1.30 Tue Feb 25 08:55:35 2014 kperrey
//  change how the rcextract is done do connect poly_nores_nogate
// 
//  Revision: 1.29 Thu Feb 20 19:57:46 2014 kperrey
//  hsd 2130; add mos_[np]gate_stk into connectivity
// 
//  Revision: 1.28 Thu Feb 20 07:55:33 2014 kperrey
...
// 
//  Revision: 1.27 Wed Jan 29 16:52:42 2014 cpark3
//  updated RC extraction codes per DTS
// 
//  Revision: 1.26 Wed Jan 15 11:33:52 2014 kperrey
//  bring more inline to p1273dx_Tconn.rs  wrt RCextract
// 
//  Revision: 1.25 Sun Jan  5 15:58:29 2014 kperrey
//  connect the rf device type gates ; derive layers for calculation w/l/nf/ns since these are based upon connections
// 
//  Revision: 1.24 Thu Dec 26 20:05:53 2013 kperrey
...
// 
//  Revision: 1.23 Wed Nov 13 10:18:02 2013 kperrey
//  virpkgroute should connect C4BEMIB instead of C4B
// 
//  Revision: 1.22 Wed Nov 13 07:36:21 2013 kperrey
...
// 
//  Revision: 1.15 Thu Sep  5 14:23:17 2013 kperrey
//  hsd 1866 ; support ICF scaleable inductor ind2t_scl_*
// 
//  Revision: 1.14 Thu Aug 29 14:03:25 2013 kperrey
//  provide mechanisdm for SC lib team to force pwell to be vss env DR_SCTxtPWL/_drSCTxtPWL(define)
// 
//  Revision: 1.13 Thu Jul 18 20:17:13 2013 kperrey
//  hsd 1808 ; moved TSV catchall to netlist connect ; build own connectivity model for vx_98 from the soft connect model
// 
//  Revision: 1.12 Mon Jun 10 08:46:45 2013 kperrey
//  add the perc djnw terminals into the connect
// 
//  Revision: 1.11 Wed Jun  5 21:22:38 2013 kperrey
//  always enable msr ; connect pwell_dnw to pwelltap/dnpdnw_anode ; add constr chk DNW cant interact 2+ PWELL_SUBISO and node cant connect both pwell_dnw and __drsubstrate
// 
//  Revision: 1.10 Thu Mar 28 18:29:36 2013 kperrey
//  similar to d5 but add m11/m12 and the pwell/deepnwell layers
// 
//  Revision: 1.9 Fri Mar 22 08:52:43 2013 kperrey
//  add mos_n/pgate_tg160 to the connects for nal/pal160 support
// 
//  Revision: 1.8 Mon Jan 14 08:04:28 2013 kperrey
//  fix name usage LMI->LMIPAD ; text LMIPAD layer for the connects
// 
//  Revision: 1.7 Fri Jan 11 20:14:35 2013 kperrey
//  as per Kalyan; connect LMI to rdlnores
// 
//  Revision: 1.6 Fri Dec 28 12:00:07 2012 kperrey
//  added handling for NV3/PV3
// 
//  Revision: 1.5 Mon Dec 17 09:20:05 2012 kperrey
//  hsd 1458 ; need to remove ce1GND2Stack in determining ceNOM
// 
//  Revision: 1.4 Thu Dec 13 17:37:49 2012 kperrey
...
#ifndef _P1273D6_TCONN_RS_
#define _P1273D6_TCONN_RS_
...
met3rcstop = MET3RCSTOP interacting RFREQDEVTYPE;
...
p_dummy_gate_fbd_rf = p_dummy_gate_fbd and met3rcstop;
p_dummy_gate_fbd = p_dummy_gate_fbd not p_dummy_gate_fbd_rf;

poly_nores_rf = poly_nores_rf not p_dummy_gate_fbd_rf;
//vias
...
#if defined(_drMFC2block) || defined(_drMFCblock)

mfcstoptm1 = TM1RCSTOP interacting mfcscldev ;
met12rcstop = MET12RCSTOP interacting mfcscldev;
met11rcstop = MET11RCSTOP interacting mfcscldev;
met10rcstop = MET10RCSTOP interacting mfcscldev;
met9rcstop = MET9RCSTOP interacting mfcscldev;
met8rcstop = MET8RCSTOP interacting mfcscldev;
met7rcstop = MET7RCSTOP interacting mfcscldev;
met6rcstop = MET6RCSTOP interacting mfcscldev;
met5rcstop = MET5RCSTOP interacting mfcscldev;
met4rcstop = MET4RCSTOP interacting mfcscldev;
met3rcstop1 = MET3RCSTOP interacting mfcscldev;
met2rcstop = MET3RCSTOP interacting mfcscldev;
met1rcstop = MET1RCSTOP interacting mfcscldev;
met0rcstop = MET0RCSTOP interacting mfcscldev;

met0rcstart = MET0RCSTART interacting mfcscldev;
met1rcstart = MET1RCSTART interacting mfcscldev;
met2rcstart = MET2RCSTART interacting mfcscldev;
met3rcstart = MET3RCSTART interacting mfcscldev;
met4rcstart = MET4RCSTART interacting mfcscldev;
met5rcstart = MET5RCSTART interacting mfcscldev;
met6rcstart = MET6RCSTART interacting mfcscldev;
met7rcstart = MET7RCSTART interacting mfcscldev;
met8rcstart = MET8RCSTART interacting mfcscldev;
met9rcstart = MET9RCSTART interacting mfcscldev;
met10rcstart = MET10RCSTART interacting mfcscldev;
met11rcstart = MET11RCSTART interacting mfcscldev;
met12rcstart = MET12RCSTART interacting mfcscldev;
tm1rcstart = TM1RCSTART interacting mfcscldev;

m1_start = met1rcstart or met0rcstart;
m2_start = met2rcstart or m1_start;
m3_start = met3rcstart or m2_start;
m4_start = met4rcstart or m3_start;
m5_start = met5rcstart or m4_start;
m6_start = met6rcstart or m5_start;
m7_start = met7rcstart or m6_start;
m8_start = met8rcstart or m7_start;
m9_start = met9rcstart or m8_start;
m10_start = met10rcstart or m9_start;
m11_start = met11rcstart or m10_start;
m12_start = met12rcstart or m11_start;
tm1_start = tm1rcstart or m12_start;

#ifdef _drMFC2block
m12_stop = (mfcstoptm1 or met12rcstop) not m12_start ;
m11_stop = (met11rcstop or m12_stop) not m11_start ;
m10_stop = (met10rcstop or m11_stop) not m10_start;
m9_stop = (met9rcstop or m10_stop) not m9_start ;
m8_stop = (met8rcstop or m9_stop) not m8_start;
m7_stop = (met7rcstop or m8_stop) not m7_start;
m6_stop = (met6rcstop or m7_stop) not m6_start;
m5_stop = (met5rcstop or m6_stop) not m5_start;
m4_stop = (met4rcstop or m5_stop) not m4_start;
m3_stop = (met3rcstop1 or m4_stop) not m3_start;
m2_stop = (met2rcstop or m3_stop) not m2_start;
m1_stop = (met1rcstop or m2_stop) not m1_start;
m0_stop = (met0rcstop or m1_stop) not met0rcstart;

m12_stop_2 = mfcstoptm1 or met12rcstop;
m11_stop_2 = met11rcstop or m12_stop_2 ;
m10_stop_2 = met10rcstop or m11_stop_2;
m9_stop_2 = met9rcstop or m10_stop_2 ;
m8_stop_2 = met8rcstop or m9_stop_2;
m7_stop_2 = met7rcstop or m8_stop_2;
m6_stop_2 = met6rcstop or m7_stop_2;
m5_stop_2 = met5rcstop or m6_stop_2;
m4_stop_2 = met4rcstop or m5_stop_2;
m3_stop_2 = met3rcstop1 or m4_stop_2;
m2_stop_2 = met2rcstop or m3_stop_2;
m1_stop_2 = met1rcstop or m2_stop_2;
m0_stop_2 = met0rcstop or m1_stop_2;

m0_strt_stp = m0_stop_2 and met0rcstart;
m1_strt_stp = m1_stop_2 and m1_start;
m2_strt_stp = m2_stop_2 and m2_start;
m3_strt_stp = m3_stop_2 and m3_start;
m4_strt_stp = m4_stop_2 and m4_start;
m5_strt_stp = m5_stop_2 and m5_start;
m6_strt_stp = m6_stop_2 and m6_start;
m7_strt_stp = m7_stop_2 and m7_start;
m8_strt_stp = m8_stop_2 and m8_start;
m9_strt_stp = m9_stop_2 and m9_start;
m10_strt_stp = m10_stop_2 and m10_start;
m11_strt_stp = m11_stop_2 and m11_start;
m12_strt_stp = m12_stop_2 and m12_start;
tm1_strt_stp = mfcstoptm1 and tm1_start;

#else

m12_stop = mfcstoptm1 or met12rcstop;
m11_stop = met11rcstop or m12_stop ;
m10_stop = met10rcstop or m11_stop;
m9_stop = met9rcstop or m10_stop ;
m8_stop = met8rcstop or m9_stop;
m7_stop = met7rcstop or m8_stop;
m6_stop = met6rcstop or m7_stop;
m5_stop = met5rcstop or m6_stop;
m4_stop = met4rcstop or m5_stop;
m3_stop = met3rcstop1 or m4_stop;
m2_stop = met2rcstop or m3_stop;
m1_stop = met1rcstop or m2_stop;
m0_stop = met0rcstop or m1_stop;

#endif

#endif

//mfc2 layer generation


#ifdef _drMFC2block
mfc2_tm1 = tm1_strt_stp and tm1nores;
tm1nores = tm1nores not mfc2_tm1;
mfc2_m12 = m12_strt_stp and metal12nores;
metal12nores = metal12nores not mfc2_m12;
mfc2_m11 = m11_strt_stp and metal11nores;
metal11nores = metal11nores not mfc2_m11;
mfc2_m10 = m10_strt_stp and metal10nores;
metal10nores = metal10nores not mfc2_m10;
mfc2_m9 = m9_strt_stp and metal9nores;
metal9nores = metal9nores not mfc2_m9;
mfc2_m8 = m8_strt_stp and metal8nores;
metal8nores = metal8nores not mfc2_m8;
mfc2_m7 = m7_strt_stp and metal7nores;
metal7nores = metal7nores not mfc2_m7;
mfc2_m6 = m6_strt_stp and metal6nores;
metal6nores = metal6nores not mfc2_m6;
mfc2_m5 = m5_strt_stp and metal5nores;
metal5nores = metal5nores not mfc2_m5;
mfc2_m4 = m4_strt_stp and metal4nores;
metal4nores = metal4nores not mfc2_m4;
mfc2_m3 = m3_strt_stp and metal3nores;
metal3nores = metal3nores not mfc2_m3;
mfc2_m2 = m2_strt_stp and metal2nores;
metal2nores = metal2nores not mfc2_m2;
mfc2_m1 = m1_strt_stp and metal1nores;
metal1nores = metal1nores not mfc2_m1;
mfc2_m0 = m0_strt_stp and metal0nores;
metal0nores = metal0nores not mfc2_m0;


mfc2_via12 = tm1_strt_stp and via12nores;
via12nores = via12nores not mfc2_via12;
mfc2_via11 = m12_strt_stp  and via11nores;
via11nores = via11nores not mfc2_via11;
mfc2_via10 = m11_strt_stp and via10nores;
via10nores = via10nores not mfc2_via10;
mfc2_via9 = m10_strt_stp and via9nores;
via9nores = via9nores not mfc2_via9;
mfc2_via8 = m9_strt_stp and via8nores;
via8nores = via8nores not mfc2_via8;
mfc2_via7 = m8_strt_stp and via7nores;
via7nores = via7nores not mfc2_via7;
mfc2_via6 = m7_strt_stp and via6nores;
via6nores = via6nores not mfc2_via6;
mfc2_via5 = m6_strt_stp and via5nores;
via5nores = via5nores not mfc2_via5;
mfc2_via4 = m5_strt_stp and via4nores;
via4nores = via4nores not mfc2_via4;
mfc2_via3 = m4_strt_stp and via3nores;
via3nores = via3nores not mfc2_via3;
mfc2_via2 = m3_strt_stp  and via2nores;
via2nores = via2nores not mfc2_via2;
mfc2_via1 = m2_strt_stp and via1nores;
via1nores = via1nores not mfc2_via1;
mfc2_via0 = m1_strt_stp and via0nores;
via0nores = via0nores not mfc2_via0;


mfc2_tm1bcpin = tm1_strt_stp and[processing_mode = CELL_LEVEL] tm1bcpin;
tm1bcpin = tm1bcpin not mfc2_tm1bcpin;
mfc2_met12bcpin = m12_strt_stp and[processing_mode = CELL_LEVEL] met12bcpin;
met12bcpin = met12bcpin not mfc2_met12bcpin;
mfc2_met11bcpin = m11_strt_stp and[processing_mode = CELL_LEVEL] met11bcpin;
met11bcpin = met11bcpin not mfc2_met11bcpin;
mfc2_met10bcpin = m10_strt_stp and[processing_mode = CELL_LEVEL] met10bcpin;
met10bcpin = met10bcpin not mfc2_met10bcpin;
mfc2_met9bcpin = m9_strt_stp and[processing_mode = CELL_LEVEL] met9bcpin;
met9bcpin = met9bcpin not mfc2_met9bcpin;
mfc2_met8bcpin = m8_strt_stp and[processing_mode = CELL_LEVEL] met8bcpin;
met8bcpin = met8bcpin not mfc2_met8bcpin;
mfc2_met7bcpin = m7_strt_stp and[processing_mode = CELL_LEVEL] met7bcpin;
met7bcpin = met7bcpin not mfc2_met7bcpin;
mfc2_met6bcpin = m6_strt_stp and[processing_mode = CELL_LEVEL] met6bcpin;
met6bcpin = met6bcpin not mfc2_met6bcpin;
mfc2_met5bcpin = m5_strt_stp and[processing_mode = CELL_LEVEL] met5bcpin;
met5bcpin = met5bcpin not mfc2_met5bcpin;
mfc2_met4bcpin = m4_strt_stp and[processing_mode = CELL_LEVEL] met4bcpin;
met4bcpin = met4bcpin not mfc2_met4bcpin;
mfc2_met3bcpin = m3_strt_stp  and[processing_mode = CELL_LEVEL] met3bcpin;
met3bcpin = met3bcpin not mfc2_met3bcpin;
mfc2_met2bcpin = m2_strt_stp and[processing_mode = CELL_LEVEL] met2bcpin;
met2bcpin = met2bcpin not mfc2_met2bcpin;
mfc2_met1bcpin = m1_strt_stp and[processing_mode = CELL_LEVEL] met1bcpin;
met1bcpin = met1bcpin not mfc2_met1bcpin;
mfc2_met0bcpin = m0_strt_stp and[processing_mode = CELL_LEVEL] met0bcpin;
met0bcpin = met0bcpin not mfc2_met0bcpin;
#endif

#ifdef _drMFCblock
//mfc1
mfc1_poly_nores = poly_nores and m0_stop;
poly_nores = poly_nores not mfc1_poly_nores;
mfc1_poly_nores = mfc1_poly_nores not p_dummy_gate_fbd;
mfc1_p_dummy_gate_fbd = p_dummy_gate_fbd and m0_stop;
p_dummy_gate_fbd = p_dummy_gate_fbd not mfc1_p_dummy_gate_fbd;


mfc1_tm1 = mfcstoptm1 and tm1nores;
tm1nores = tm1nores not mfc1_tm1;
mfc1_m12 = m12_stop and metal12nores;
metal12nores = metal12nores not mfc1_m12;
mfc1_m11 = m11_stop and metal11nores;
metal11nores = metal11nores not mfc1_m11;
mfc1_m10 = m10_stop and metal10nores;
metal10nores = metal10nores not mfc1_m10;
mfc1_m9 = m9_stop and metal9nores;
metal9nores = metal9nores not mfc1_m9;
mfc1_m8 = m8_stop and metal8nores;
metal8nores = metal8nores not mfc1_m8;
mfc1_m7 = m7_stop and metal7nores;
metal7nores = metal7nores not mfc1_m7;
mfc1_m6 = m6_stop and metal6nores;
metal6nores = metal6nores not mfc1_m6;
mfc1_m5 = m5_stop and metal5nores;
metal5nores = metal5nores not mfc1_m5;
mfc1_m4 = m4_stop and metal4nores;
metal4nores = metal4nores not mfc1_m4;
mfc1_m3 = m3_stop and metal3nores;
metal3nores = metal3nores not mfc1_m3;
mfc1_m2 = m2_stop and metal2nores;
metal2nores = metal2nores not mfc1_m2;
mfc1_m1 = m1_stop and metal1nores;
metal1nores = metal1nores not mfc1_m1;
mfc1_m0 = m0_stop and metal0nores;
metal0nores = metal0nores not mfc1_m0;
mfc1_polycon = m0_stop and polycon_nores;
polycon_nores = polycon_nores not mfc1_polycon;
mfc1_diffcon = m0_stop and diffcon_nores;
diffcon_nores = diffcon_nores not mfc1_diffcon;


mfc1_via12 = mfcstoptm1 and via12nores;
via12nores = via12nores not mfc1_via12;
mfc1_via11 = m12_stop  and via11nores;
via11nores = via11nores not mfc1_via11;
mfc1_via10 = m11_stop and via10nores;
via10nores = via10nores not mfc1_via10;
mfc1_via9 = m10_stop and via9nores;
via9nores = via9nores not mfc1_via9;
mfc1_via8 = m9_stop and via8nores;
via8nores = via8nores not mfc1_via8;
mfc1_via7 = m8_stop and via7nores;
via7nores = via7nores not mfc1_via7;
mfc1_via6 = m7_stop and via6nores;
via6nores = via6nores not mfc1_via6;
mfc1_via5 = m6_stop and via5nores;
via5nores = via5nores not mfc1_via5;
mfc1_via4 = m5_stop and via4nores;
via4nores = via4nores not mfc1_via4;
mfc1_via3 = m4_stop and via3nores;
via3nores = via3nores not mfc1_via3;
mfc1_via2 = m3_stop  and via2nores;
via2nores = via2nores not mfc1_via2;
mfc1_via1 = m2_stop and via1nores;
via1nores = via1nores not mfc1_via1;
mfc1_via0 = m1_stop and via0nores;
via0nores = via0nores not mfc1_via0;
mfc1_viacong = m0_stop and VIACONG;
VIACONG = VIACONG not mfc1_viacong;
mfc1_viacont = m0_stop and VIACONT;
VIACONT = VIACONT not mfc1_viacont;


mfc1_tm1bcpin = mfcstoptm1 and[processing_mode = CELL_LEVEL] tm1bcpin;
tm1bcpin = tm1bcpin not mfc1_tm1bcpin;
mfc1_met12bcpin = m12_stop and[processing_mode = CELL_LEVEL] met12bcpin;
met12bcpin = met12bcpin not mfc1_met12bcpin;
mfc1_met11bcpin = m11_stop and[processing_mode = CELL_LEVEL] met11bcpin;
met11bcpin = met11bcpin not mfc1_met11bcpin;
mfc1_met10bcpin = m10_stop and[processing_mode = CELL_LEVEL] met10bcpin;
met10bcpin = met10bcpin not mfc1_met10bcpin;
mfc1_met9bcpin = m9_stop and[processing_mode = CELL_LEVEL] met9bcpin;
met9bcpin = met9bcpin not mfc1_met9bcpin;
mfc1_met8bcpin = m8_stop and[processing_mode = CELL_LEVEL] met8bcpin;
met8bcpin = met8bcpin not mfc1_met8bcpin;
mfc1_met7bcpin = m7_stop and[processing_mode = CELL_LEVEL] met7bcpin;
met7bcpin = met7bcpin not mfc1_met7bcpin;
mfc1_met6bcpin = m6_stop and[processing_mode = CELL_LEVEL] met6bcpin;
met6bcpin = met6bcpin not mfc1_met6bcpin;
mfc1_met5bcpin = m5_stop and[processing_mode = CELL_LEVEL] met5bcpin;
met5bcpin = met5bcpin not mfc1_met5bcpin;
mfc1_met4bcpin = m4_stop and[processing_mode = CELL_LEVEL] met4bcpin;
met4bcpin = met4bcpin not mfc1_met4bcpin;
mfc1_met3bcpin = m3_stop  and[processing_mode = CELL_LEVEL] met3bcpin;
met3bcpin = met3bcpin not mfc1_met3bcpin;
mfc1_met2bcpin = m2_stop and[processing_mode = CELL_LEVEL] met2bcpin;
met2bcpin = met2bcpin not mfc1_met2bcpin;
mfc1_met1bcpin = m1_stop and[processing_mode = CELL_LEVEL] met1bcpin;
met1bcpin = met1bcpin not mfc1_met1bcpin;
mfc1_met0bcpin = m0_stop and[processing_mode = CELL_LEVEL] met0bcpin;
met0bcpin = met0bcpin not mfc1_met0bcpin;
mfc1_poly1pin = m0_stop and[processing_mode = CELL_LEVEL] poly1pin;
poly1pin = poly1pin not mfc1_poly1pin;
mfc1_polyconpin = m0_stop and[processing_mode = CELL_LEVEL] polyconpin;
polyconpin = polyconpin not mfc1_polyconpin;
mfc1_diffconpin = m0_stop and[processing_mode = CELL_LEVEL] diffconpin;
diffconpin = diffconpin not mfc1_diffconpin;
#endif
   ...
   #endif
   #ifdef _drMFC2block
     m0TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m0, tlPinRing );
     mfc2_m0 = copy(_drFlatPortInteract__(mfc2_m0, m0TLPin_rfmfc2));
     m1TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m1, tlPinRing );
     mfc2_m1 = copy(_drFlatPortInteract__(mfc2_m1, m1TLPin_rfmfc2));
     m2TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m2, tlPinRing );
     mfc2_m2 = copy(_drFlatPortInteract__(mfc2_m2, m2TLPin_rfmfc2));
     m3TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m3, tlPinRing );
     mfc2_m3 = copy(_drFlatPortInteract__(mfc2_m3, m3TLPin_rfmfc2));
     m4TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m4, tlPinRing );
     mfc2_m4 = copy(_drFlatPortInteract__(mfc2_m4, m4TLPin_rfmfc2));
     m5TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m5, tlPinRing );
     mfc2_m5 = copy(_drFlatPortInteract__(mfc2_m5, m5TLPin_rfmfc2));
     m6TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m6, tlPinRing );
     mfc2_m6 = copy(_drFlatPortInteract__(mfc2_m6, m6TLPin_rfmfc2));
     m7TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m7, tlPinRing );
     mfc2_m7 = copy(_drFlatPortInteract__(mfc2_m7, m7TLPin_rfmfc2));
     m8TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m8, tlPinRing );
     mfc2_m8 = copy(_drFlatPortInteract__(mfc2_m8, m8TLPin_rfmfc2));
     m9TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m9, tlPinRing );
     mfc2_m9 = copy(_drFlatPortInteract__(mfc2_m9, m9TLPin_rfmfc2));
     m10TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m10, tlPinRing );
     mfc2_m10 = copy(_drFlatPortInteract__(mfc2_m10, m10TLPin_rfmfc2));
     m11TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m11, tlPinRing );
     mfc2_m11 = copy(_drFlatPortInteract__(mfc2_m11, m11TLPin_rfmfc2));
     m12TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_m12, tlPinRing );
     mfc2_m12 = copy(_drFlatPortInteract__(mfc2_m12, m12TLPin_rfmfc2));
     tm1TLPin_rfmfc2 = _drGetTopLevelPins__(mfc2_tm1, tlPinRing );
     mfc2_tm1 = copy(_drFlatPortInteract__(mfc2_tm1, tm1TLPin_rfmfc2));
   #endif     
   #ifdef _drMFCblock
     m0TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m0, tlPinRing );
     mfc1_m0 = copy(_drFlatPortInteract__(mfc1_m0, m0TLPin_rfmfc1));
     m1TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m1, tlPinRing );
     mfc1_m1 = copy(_drFlatPortInteract__(mfc1_m1, m1TLPin_rfmfc1));
     m2TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m2, tlPinRing );
     mfc1_m2 = copy(_drFlatPortInteract__(mfc1_m2, m2TLPin_rfmfc1));
     m3TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m3, tlPinRing );
     mfc1_m3 = copy(_drFlatPortInteract__(mfc1_m3, m3TLPin_rfmfc1));
     m4TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m4, tlPinRing );
     mfc1_m4 = copy(_drFlatPortInteract__(mfc1_m4, m4TLPin_rfmfc1));
     m5TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m5, tlPinRing );
     mfc1_m5 = copy(_drFlatPortInteract__(mfc1_m5, m5TLPin_rfmfc1));
     m6TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m6, tlPinRing );
     mfc1_m6 = copy(_drFlatPortInteract__(mfc1_m6, m6TLPin_rfmfc1));
     m7TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m7, tlPinRing );
     mfc1_m7 = copy(_drFlatPortInteract__(mfc1_m7, m7TLPin_rfmfc1));
     m8TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m8, tlPinRing );
     mfc1_m8 = copy(_drFlatPortInteract__(mfc1_m8, m8TLPin_rfmfc1));
     m9TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m9, tlPinRing );
     mfc1_m9 = copy(_drFlatPortInteract__(mfc1_m9, m9TLPin_rfmfc1));
     m10TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m10, tlPinRing );
     mfc1_m10 = copy(_drFlatPortInteract__(mfc1_m10, m10TLPin_rfmfc1));
     m11TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m11, tlPinRing );
     mfc1_m11 = copy(_drFlatPortInteract__(mfc1_m11, m11TLPin_rfmfc1));
     m12TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_m12, tlPinRing );
     mfc1_m12 = copy(_drFlatPortInteract__(mfc1_m12, m12TLPin_rfmfc1));
     tm1TLPin_rfmfc1 = _drGetTopLevelPins__(mfc1_tm1, tlPinRing );
     mfc1_tm1 = copy(_drFlatPortInteract__(mfc1_tm1, tm1TLPin_rfmfc1));
   #endif
   ...
   m11TLPin = _drGetTopLevelPins__(metal11nores, tlPinRing );
   metal11nores = copy(_drFlatPortInteract__(metal11nores, m11TLPin));
   m12TLPin = _drGetTopLevelPins__(metal12nores, tlPinRing );
   metal12nores = copy(_drFlatPortInteract__(metal12nores, m12TLPin));
   ...
   m11TLPin = empty_layer();
   m12TLPin = empty_layer();
...
//     met3bcpin = met3bcpin not met3bcpin_rf;
   ...
   #ifdef _drMFC2block
   mfc2_slie1_m0 = mfc2_met0bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET0BCRESID);
   mfc2_m0 = mfc2_m0 or mfc2_slie1_m0;
   mfc2_slie1_m1 = mfc2_met1bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET1BCRESID);
   mfc2_m1 = mfc2_m1 or mfc2_slie1_m1;
   mfc2_mfc2_slie1_m2 = mfc2_met2bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET2BCRESID);
   mfc2_m2 = mfc2_m2 or mfc2_mfc2_slie1_m2;
   mfc2_slie1_m3 = mfc2_met3bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET3BCRESID);
   mfc2_m3 = mfc2_m3 or mfc2_slie1_m3;
   mfc2_slie1_m4 = mfc2_met4bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET4BCRESID);
   mfc2_m4 = mfc2_m4 or mfc2_slie1_m4;
   mfc2_slie1_m5 = mfc2_met5bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET5BCRESID);
   mfc2_m5 = mfc2_m5 or mfc2_slie1_m5;
   mfc2_slie1_m6 = mfc2_met6bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET6BCRESID);
   mfc2_m6 = mfc2_m6 or mfc2_slie1_m6;
   mfc2_slie1_m7 = mfc2_met7bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET7BCRESID);
   mfc2_m7 = mfc2_m7 or mfc2_slie1_m7;
   mfc2_slie1_m8 = mfc2_met8bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET8BCRESID);
   mfc2_m8 = mfc2_m8 or mfc2_slie1_m8;
   mfc2_slie1_m9 = mfc2_met9bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET9BCRESID);
   mfc2_m9 = mfc2_m9 or mfc2_slie1_m9;
   mfc2_slie1_m10 = mfc2_met10bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET10BCRESID);
   mfc2_m10 = mfc2_m10 or mfc2_slie1_m10;
   mfc2_slie1_m11 = mfc2_met11bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET11BCRESID);
   mfc2_m11 = mfc2_m11 or mfc2_slie1_m11;
   mfc2_slie1_m12 = mfc2_met12bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET12BCRESID);
   mfc2_m12 = mfc2_m12 or mfc2_slie1_m12;
   mfc2_slie1_tm1 = mfc2_tm1bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not TM1BCRESID);
   mfc2_tm1 = mfc2_tm1 or mfc2_slie1_tm1;
   #endif 

   #ifdef _drMFCblock
   mfc1_slie1_diffcon = mfc1_diffconpin and [processing_mode = CELL_LEVEL] (SLIE1 not DIFFCONRESID);
   mfc1_diffcon = mfc1_diffcon or mfc1_slie1_diffcon;
   mfc1_slie1_polycon = mfc1_polyconpin and [processing_mode = CELL_LEVEL] (SLIE1 not POLYCONRESID);
   mfc1_polycon = mfc1_polycon or mfc1_slie1_polycon;
   mfc1_slie1_poly = mfc1_poly1pin and [processing_mode = CELL_LEVEL] (SLIE1 not PRES_ID);
   mfc1_poly_nores = mfc1_poly_nores or mfc1_slie1_poly;
   // poly_nores_nogate = poly_nores_nogate or slie1_poly;
   mfc1_slie1_m0 = mfc1_met0bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET0BCRESID);
   mfc1_m0 = mfc1_m0 or mfc1_slie1_m0;
   mfc1_slie1_m1 = mfc1_met1bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET1BCRESID);
   mfc1_m1 = mfc1_m1 or mfc1_slie1_m1;
   mfc1_mfc1_slie1_m2 = mfc1_met2bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET2BCRESID);
   mfc1_m2 = mfc1_m2 or mfc1_mfc1_slie1_m2;
   mfc1_slie1_m3 = mfc1_met3bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET3BCRESID);
   mfc1_m3 = mfc1_m3 or mfc1_slie1_m3;
   mfc1_slie1_m4 = mfc1_met4bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET4BCRESID);
   mfc1_m4 = mfc1_m4 or mfc1_slie1_m4;
   mfc1_slie1_m5 = mfc1_met5bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET5BCRESID);
   mfc1_m5 = mfc1_m5 or mfc1_slie1_m5;
   mfc1_slie1_m6 = mfc1_met6bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET6BCRESID);
   mfc1_m6 = mfc1_m6 or mfc1_slie1_m6;
   mfc1_slie1_m7 = mfc1_met7bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET7BCRESID);
   mfc1_m7 = mfc1_m7 or mfc1_slie1_m7;
   mfc1_slie1_m8 = mfc1_met8bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET8BCRESID);
   mfc1_m8 = mfc1_m8 or mfc1_slie1_m8;
   mfc1_slie1_m9 = mfc1_met9bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET9BCRESID);
   mfc1_m9 = mfc1_m9 or mfc1_slie1_m9;
   mfc1_slie1_m10 = mfc1_met10bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET10BCRESID);
   mfc1_m10 = mfc1_m10 or mfc1_slie1_m10;
   mfc1_slie1_m11 = mfc1_met11bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET11BCRESID);
   mfc1_m11 = mfc1_m11 or mfc1_slie1_m11;
   mfc1_slie1_m12 = mfc1_met12bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET12BCRESID);
   mfc1_m12 = mfc1_m12 or mfc1_slie1_m12;
   mfc1_slie1_tm1 = mfc1_tm1bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not TM1BCRESID);
   mfc1_tm1 = mfc1_tm1 or mfc1_slie1_tm1;
   #endif
   ...
   metal10nores = metal10nores or slie1_m10;
   slie1_m11 = met11bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET11BCRESID);
   metal11nores = metal11nores or slie1_m11;
   slie1_m12 = met12bcpin and [processing_mode = CELL_LEVEL] (SLIE1 not MET12BCRESID);
   metal12nores = metal12nores or slie1_m12;
...
#ifdef _drMFC2block
mfc2_m0TLPort = _drGetTopLevelPorts__(mfc2_met0bcpin);
mfc2_m0 = copy(_drFlatPortInteract__(mfc2_m0, mfc2_m0TLPort));
mfc2_m1TLPort = _drGetTopLevelPorts__(mfc2_met1bcpin);
mfc2_m1 = copy(_drFlatPortInteract__(mfc2_m1, mfc2_m1TLPort));
mfc2_m2TLPort = _drGetTopLevelPorts__(mfc2_met2bcpin);
mfc2_m2 = copy(_drFlatPortInteract__(mfc2_m2, mfc2_m2TLPort));
mfc2_m3TLPort = _drGetTopLevelPorts__(mfc2_met3bcpin);
mfc2_m3 = copy(_drFlatPortInteract__(mfc2_m3, mfc2_m3TLPort));
mfc2_m4TLPort = _drGetTopLevelPorts__(mfc2_met4bcpin);
mfc2_m4 = copy(_drFlatPortInteract__(mfc2_m4, mfc2_m4TLPort));
mfc2_m5TLPort = _drGetTopLevelPorts__(mfc2_met5bcpin);
mfc2_m5 = copy(_drFlatPortInteract__(mfc2_m5, mfc2_m5TLPort));
mfc2_m6TLPort = _drGetTopLevelPorts__(mfc2_met6bcpin);
mfc2_m6 = copy(_drFlatPortInteract__(mfc2_m6, mfc2_m6TLPort));
mfc2_m7TLPort = _drGetTopLevelPorts__(mfc2_met7bcpin);
mfc2_m7 = copy(_drFlatPortInteract__(mfc2_m7, mfc2_m7TLPort));
mfc2_m8TLPort = _drGetTopLevelPorts__(mfc2_met8bcpin);
mfc2_m8 = copy(_drFlatPortInteract__(mfc2_m8,  mfc2_m8TLPort));
mfc2_m9TLPort = _drGetTopLevelPorts__(mfc2_met9bcpin);
mfc2_m9 = copy(_drFlatPortInteract__(mfc2_m9, mfc2_m9TLPort));
mfc2_m10TLPort = _drGetTopLevelPorts__(mfc2_met10bcpin);
mfc2_m10 = copy(_drFlatPortInteract__(mfc2_m10, mfc2_m10TLPort));
mfc2_m11TLPort = _drGetTopLevelPorts__(mfc2_met11bcpin);
mfc2_m11 = copy(_drFlatPortInteract__(mfc2_m11, mfc2_m11TLPort));
mfc2_m12TLPort = _drGetTopLevelPorts__(mfc2_met12bcpin);
mfc2_m12 = copy(_drFlatPortInteract__(mfc2_m12, mfc2_m12TLPort));
mfc2_tm1TLPort = _drGetTopLevelPorts__(mfc2_tm1bcpin);
mfc2_tm1 = copy(_drFlatPortInteract__(mfc2_tm1, mfc2_tm1TLPort));
#endif
#ifdef _drMFCblock
mfc1_diffconTLPort = _drGetTopLevelPorts__(mfc1_diffconpin);
mfc1_diffcon = copy(_drFlatPortInteract__(mfc1_diffcon, mfc1_diffconTLPort));
mfc1_polyconTLPort = _drGetTopLevelPorts__(mfc1_polyconpin);
mfc1_polycon = copy(_drFlatPortInteract__(mfc1_polycon, mfc1_polyconTLPort));
mfc1_polyTLPort = _drGetTopLevelPorts__(mfc1_poly1pin);
mfc1_poly_nores = copy(_drFlatPortInteract__(mfc1_poly_nores, mfc1_polyTLPort));
mfc1_m0TLPort = _drGetTopLevelPorts__(mfc1_met0bcpin);
mfc1_m0 = copy(_drFlatPortInteract__(mfc1_m0, mfc1_m0TLPort));
mfc1_m1TLPort = _drGetTopLevelPorts__(mfc1_met1bcpin);
mfc1_m1 = copy(_drFlatPortInteract__(mfc1_m1, mfc1_m1TLPort));
mfc1_m2TLPort = _drGetTopLevelPorts__(mfc1_met2bcpin);
mfc1_m2 = copy(_drFlatPortInteract__(mfc1_m2, mfc1_m2TLPort));
mfc1_m3TLPort = _drGetTopLevelPorts__(mfc1_met3bcpin);
mfc1_m3 = copy(_drFlatPortInteract__(mfc1_m3, mfc1_m3TLPort));
mfc1_m4TLPort = _drGetTopLevelPorts__(mfc1_met4bcpin);
mfc1_m4 = copy(_drFlatPortInteract__(mfc1_m4, mfc1_m4TLPort));
mfc1_m5TLPort = _drGetTopLevelPorts__(mfc1_met5bcpin);
mfc1_m5 = copy(_drFlatPortInteract__(mfc1_m5, mfc1_m5TLPort));
mfc1_m6TLPort = _drGetTopLevelPorts__(mfc1_met6bcpin);
mfc1_m6 = copy(_drFlatPortInteract__(mfc1_m6, mfc1_m6TLPort));
mfc1_m7TLPort = _drGetTopLevelPorts__(mfc1_met7bcpin);
mfc1_m7 = copy(_drFlatPortInteract__(mfc1_m7, mfc1_m7TLPort));
mfc1_m8TLPort = _drGetTopLevelPorts__(mfc1_met8bcpin);
mfc1_m8 = copy(_drFlatPortInteract__(mfc1_m8,  mfc1_m8TLPort));
mfc1_m9TLPort = _drGetTopLevelPorts__(mfc1_met9bcpin);
mfc1_m9 = copy(_drFlatPortInteract__(mfc1_m9, mfc1_m9TLPort));
mfc1_m10TLPort = _drGetTopLevelPorts__(mfc1_met10bcpin);
mfc1_m10 = copy(_drFlatPortInteract__(mfc1_m10, mfc1_m10TLPort));
mfc1_m11TLPort = _drGetTopLevelPorts__(mfc1_met11bcpin);
mfc1_m11 = copy(_drFlatPortInteract__(mfc1_m11, mfc1_m11TLPort));
mfc1_m12TLPort = _drGetTopLevelPorts__(mfc1_met12bcpin);
mfc1_m12 = copy(_drFlatPortInteract__(mfc1_m12, mfc1_m12TLPort));
mfc1_tm1TLPort = _drGetTopLevelPorts__(mfc1_tm1bcpin);
mfc1_tm1 = copy(_drFlatPortInteract__(mfc1_tm1, mfc1_tm1TLPort));
#endif
...
m11TLPort = _drGetTopLevelPorts__(met11bcpin);
metal11nores = copy(_drFlatPortInteract__(metal11nores, m11TLPort));
m12TLPort = _drGetTopLevelPorts__(met12bcpin);
metal12nores = copy(_drFlatPortInteract__(metal12nores, m12TLPort));
...
// get ports for the bb template cells 
   ...
   #endif
   #ifdef _drMFC2block
     mfc2_m0Port = _drGetBBPorts__(drawnPortLayer = mfc2_met0bcpin, drawnDataLayer = mfc2_m0) or mfc2_met0bcpin;
     mfc2_m1Port = _drGetBBPorts__(drawnPortLayer = mfc2_met1bcpin, drawnDataLayer = mfc2_m1) or mfc2_met1bcpin;
     mfc2_m2Port = _drGetBBPorts__(drawnPortLayer = mfc2_met2bcpin, drawnDataLayer = mfc2_m2) or mfc2_met2bcpin;
     mfc2_m3Port = _drGetBBPorts__(drawnPortLayer = mfc2_met3bcpin, drawnDataLayer = mfc2_m3) or mfc2_met3bcpin;
     mfc2_m4Port = _drGetBBPorts__(drawnPortLayer = mfc2_met4bcpin, drawnDataLayer = mfc2_m4) or mfc2_met4bcpin;
     mfc2_m5Port = _drGetBBPorts__(drawnPortLayer = mfc2_met5bcpin, drawnDataLayer = mfc2_m5) or mfc2_met5bcpin;
     mfc2_m6Port = _drGetBBPorts__(drawnPortLayer = mfc2_met6bcpin, drawnDataLayer = mfc2_m6) or mfc2_met6bcpin;
     mfc2_m7Port = _drGetBBPorts__(drawnPortLayer = mfc2_met7bcpin, drawnDataLayer = mfc2_m7) or mfc2_met7bcpin;
     mfc2_m8Port = _drGetBBPorts__(drawnPortLayer = mfc2_met8bcpin, drawnDataLayer = mfc2_m8) or mfc2_met8bcpin;
     mfc2_m9Port = _drGetBBPorts__(drawnPortLayer = mfc2_met9bcpin, drawnDataLayer = mfc2_m9) or mfc2_met9bcpin;
     mfc2_m10Port = _drGetBBPorts__(drawnPortLayer = mfc2_met10bcpin, drawnDataLayer = mfc2_m10) or mfc2_met10bcpin;
     mfc2_m11Port = _drGetBBPorts__(drawnPortLayer = mfc2_met11bcpin, drawnDataLayer = mfc2_m11) or mfc2_met11bcpin;
     mfc2_m12Port = _drGetBBPorts__(drawnPortLayer = mfc2_met12bcpin, drawnDataLayer = mfc2_m12) or mfc2_met12bcpin;
     mfc2_tm1Port = _drGetBBPorts__(drawnPortLayer = mfc2_tm1bcpin, drawnDataLayer = mfc2_tm1) or mfc2_tm1bcpin;
   #endif
   #ifdef _drMFCblock 
     mfc1_diffconPort = _drGetBBPorts__(drawnPortLayer = mfc1_diffconpin, drawnDataLayer = mfc1_diffcon) or mfc1_diffconpin;
     mfc1_polyconPort = _drGetBBPorts__(drawnPortLayer =mfc1_polyconpin, drawnDataLayer = mfc1_polycon) or mfc1_polyconpin;
     mfc1_polyPort = _drGetBBPorts__(drawnPortLayer = mfc1_poly1pin, drawnDataLayer = mfc1_poly_nores) or mfc1_poly1pin;
     mfc1_m0Port = _drGetBBPorts__(drawnPortLayer = mfc1_met0bcpin, drawnDataLayer = mfc1_m0) or mfc1_met0bcpin;
     mfc1_m1Port = _drGetBBPorts__(drawnPortLayer = mfc1_met1bcpin, drawnDataLayer = mfc1_m1) or mfc1_met1bcpin;
     mfc1_m2Port = _drGetBBPorts__(drawnPortLayer = mfc1_met2bcpin, drawnDataLayer = mfc1_m2) or mfc1_met2bcpin;
     mfc1_m3Port = _drGetBBPorts__(drawnPortLayer = mfc1_met3bcpin, drawnDataLayer = mfc1_m3) or mfc1_met3bcpin;
     mfc1_m4Port = _drGetBBPorts__(drawnPortLayer = mfc1_met4bcpin, drawnDataLayer = mfc1_m4) or mfc1_met4bcpin;
     mfc1_m5Port = _drGetBBPorts__(drawnPortLayer = mfc1_met5bcpin, drawnDataLayer = mfc1_m5) or mfc1_met5bcpin;
     mfc1_m6Port = _drGetBBPorts__(drawnPortLayer = mfc1_met6bcpin, drawnDataLayer = mfc1_m6) or mfc1_met6bcpin;
     mfc1_m7Port = _drGetBBPorts__(drawnPortLayer = mfc1_met7bcpin, drawnDataLayer = mfc1_m7) or mfc1_met7bcpin;
     mfc1_m8Port = _drGetBBPorts__(drawnPortLayer = mfc1_met8bcpin, drawnDataLayer = mfc1_m8) or mfc1_met8bcpin;
     mfc1_m9Port = _drGetBBPorts__(drawnPortLayer = mfc1_met9bcpin, drawnDataLayer = mfc1_m9) or mfc1_met9bcpin;
     mfc1_m10Port = _drGetBBPorts__(drawnPortLayer = mfc1_met10bcpin, drawnDataLayer = mfc1_m10) or mfc1_met10bcpin;
     mfc1_m11Port = _drGetBBPorts__(drawnPortLayer = mfc1_met11bcpin, drawnDataLayer = mfc1_m11) or mfc1_met11bcpin;
     mfc1_m12Port = _drGetBBPorts__(drawnPortLayer = mfc1_met12bcpin, drawnDataLayer = mfc1_m12) or mfc1_met12bcpin;
     mfc1_tm1Port = _drGetBBPorts__(drawnPortLayer = mfc1_tm1bcpin, drawnDataLayer = mfc1_tm1) or mfc1_tm1bcpin;
   #endif
   ...
   m11Port = _drGetBBPorts__(drawnPortLayer = met11bcpin, drawnDataLayer = metal11nores) or met11bcpin;
   m12Port = _drGetBBPorts__(drawnPortLayer = met12bcpin, drawnDataLayer = metal12nores) or met12bcpin;
   ...
   m11Port = _drGetBBPorts__(drawnPortLayer = met11bcpin, drawnDataLayer = metal11nores) or m11TLPort;
   m12Port = _drGetBBPorts__(drawnPortLayer = met12bcpin, drawnDataLayer = metal12nores) or m12TLPort;
...
diffconInterFace = copy(diffconPort);
   ...
   #endif
   #ifdef _drMFC2block
      mfc2_m0InterFace = copy(mfc2_m0Port);
      mfc2_m0InterFace_size = size(mfc2_m0InterFace, distance = p1272grid);
      mfc2_m0InterFace = (mfc2_m0InterFace_size not m1_stop); 
      mfc2_m0InterFace = size( mfc2_m0InterFace , distance = p1272grid);
      mfc2_m1InterFace = copy(mfc2_m1Port);
      mfc2_m1InterFace_size = size(mfc2_m1InterFace, distance = p1272grid);
      mfc2_m1InterFace = (mfc2_m1InterFace_size not m1_stop);                     
      mfc2_m1InterFace = size( mfc2_m1InterFace , distance = p1272grid);
      mfc2_m2InterFace = copy(mfc2_m2Port);
      mfc2_m2InterFace_size = size(mfc2_m2InterFace, distance = p1272grid);
      mfc2_m2InterFace = (mfc2_m2InterFace_size not m2_stop);
      mfc2_m2InterFace = size( mfc2_m2InterFace , distance = p1272grid);
      mfc2_m3InterFace = copy(mfc2_m3Port);
      mfc2_m3InterFace_size = size(mfc2_m3InterFace, distance = p1272grid);
      mfc2_m3InterFace = (mfc2_m3InterFace_size not m3_stop);
      mfc2_m3InterFace = size( mfc2_m3InterFace , distance = p1272grid);
      mfc2_m4InterFace = copy(mfc2_m4Port);
mfc2_m4InterFace_size = size(mfc2_m4InterFace, distance = p1272grid);
mfc2_m4InterFace = (mfc2_m4InterFace_size not m4_stop);
mfc2_m4InterFace = size( mfc2_m4InterFace , distance = p1272grid);
      mfc2_m5InterFace = copy(mfc2_m5Port);
mfc2_m5InterFace_size = size(mfc2_m5InterFace, distance = p1272grid);
mfc2_m5InterFace = (mfc2_m5InterFace_size not m5_stop);
mfc2_m5InterFace = size( mfc2_m5InterFace , distance = p1272grid);
      mfc2_m6InterFace = copy(mfc2_m6Port);
mfc2_m6InterFace_size = size(mfc2_m6InterFace, distance = p1272grid);
mfc2_m6InterFace = (mfc2_m6InterFace_size not m6_stop);
mfc2_m6InterFace = size( mfc2_m6InterFace , distance = p1272grid);
      mfc2_m7InterFace = copy(mfc2_m7Port);
mfc2_m7InterFace_size = size(mfc2_m7InterFace, distance = p1272grid);
mfc2_m7InterFace = (mfc2_m7InterFace_size not m7_stop);
mfc2_m7InterFace = size( mfc2_m7InterFace , distance = p1272grid);
      mfc2_m8InterFace = copy(mfc2_m8Port);
mfc2_m8InterFace_size = size(mfc2_m8InterFace, distance = p1272grid);
mfc2_m8InterFace = (mfc2_m8InterFace_size not m8_stop);
mfc2_m8InterFace = size( mfc2_m8InterFace , distance = p1272grid);
      mfc2_m9InterFace = copy(mfc2_m9Port);
mfc2_m9InterFace_size = size(mfc2_m9InterFace, distance = p1272grid);
mfc2_m9InterFace = (mfc2_m9InterFace_size not m9_stop);
mfc2_m9InterFace = size( mfc2_m9InterFace , distance = p1272grid);
      mfc2_m10InterFace = copy(mfc2_m10Port);
mfc2_m10InterFace_size = size(mfc2_m10InterFace, distance = p1272grid);
mfc2_m10InterFace = (mfc2_m10InterFace_size not m10_stop);
mfc2_m10InterFace = size( mfc2_m10InterFace , distance = p1272grid);
      mfc2_m11InterFace = copy(mfc2_m11Port);
mfc2_m11InterFace_size = size(mfc2_m11InterFace, distance = p1272grid);
mfc2_m11InterFace = (mfc2_m11InterFace_size not m11_stop);
mfc2_m11InterFace = size( mfc2_m11InterFace , distance = p1272grid);
      mfc2_m12InterFace = copy(mfc2_m12Port);
mfc2_m12InterFace_size = size(mfc2_m12InterFace, distance = p1272grid);
mfc2_m12InterFace = (mfc2_m12InterFace_size not m12_stop);
mfc2_m12InterFace = size( mfc2_m12InterFace , distance = p1272grid);
      mfc2_tm1InterFace = copy(mfc2_tm1Port);
mfc2_tm1InterFace_size = size(mfc2_tm1InterFace, distance = p1272grid);
mfc2_tm1InterFace = (mfc2_tm1InterFace_size not mfcstoptm1);
mfc2_tm1InterFace = size( mfc2_tm1InterFace , distance = p1272grid);
    #endif
    #ifdef _drMFCblock
      mfc1_polyInterFace = copy(mfc1_polyPort);
mfc1_polyInterFace_size = size(mfc1_polyInterFace, distance = p1272grid);
mfc1_polyInterFace = (mfc1_polyInterFace_size not m1_stop); 
mfc1_polyInterFace = size( mfc1_polyInterFace , distance = p1272grid);
      mfc1_polyconInterFace = copy(mfc1_polyconPort);
      mfc1_diffconInterFace = copy(mfc1_diffconPort);
mfc1_diffconInterFace_size = size(mfc1_diffconInterFace, distance = p1272grid);
mfc1_diffconInterFace = (mfc1_diffconInterFace_size not m1_stop); 
mfc1_diffconInterFace = size( mfc1_diffconInterFace , distance = p1272grid);
      mfc1_m0InterFace = copy(mfc1_m0Port);
mfc1_m0InterFace_size = size(mfc1_m0InterFace, distance = p1272grid);
mfc1_m0InterFace = (mfc1_m0InterFace_size not m1_stop); 
mfc1_m0InterFace = size( mfc1_m0InterFace , distance = p1272grid);
      mfc1_m1InterFace = copy(mfc1_m1Port);
mfc1_m1InterFace_size = size(mfc1_m1InterFace, distance = p1272grid);
mfc1_m1InterFace = (mfc1_m1InterFace_size not m1_stop);                     
mfc1_m1InterFace = size( mfc1_m1InterFace , distance = p1272grid);
      mfc1_m2InterFace = copy(mfc1_m2Port);
mfc1_m2InterFace_size = size(mfc1_m2InterFace, distance = p1272grid);
mfc1_m2InterFace = (mfc1_m2InterFace_size not m2_stop);
mfc1_m2InterFace = size( mfc1_m2InterFace , distance = p1272grid);
      mfc1_m3InterFace = copy(mfc1_m3Port);
mfc1_m3InterFace_size = size(mfc1_m3InterFace, distance = p1272grid);
mfc1_m3InterFace = (mfc1_m3InterFace_size not m3_stop);
mfc1_m3InterFace = size( mfc1_m3InterFace , distance = p1272grid);
      mfc1_m4InterFace = copy(mfc1_m4Port);
mfc1_m4InterFace_size = size(mfc1_m4InterFace, distance = p1272grid);
mfc1_m4InterFace = (mfc1_m4InterFace_size not m4_stop);
mfc1_m4InterFace = size( mfc1_m4InterFace , distance = p1272grid);
      mfc1_m5InterFace = copy(mfc1_m5Port);
mfc1_m5InterFace_size = size(mfc1_m5InterFace, distance = p1272grid);
mfc1_m5InterFace = (mfc1_m5InterFace_size not m5_stop);
mfc1_m5InterFace = size( mfc1_m5InterFace , distance = p1272grid);
      mfc1_m6InterFace = copy(mfc1_m6Port);
mfc1_m6InterFace_size = size(mfc1_m6InterFace, distance = p1272grid);
mfc1_m6InterFace = (mfc1_m6InterFace_size not m6_stop);
mfc1_m6InterFace = size( mfc1_m6InterFace , distance = p1272grid);
      mfc1_m7InterFace = copy(mfc1_m7Port);
mfc1_m7InterFace_size = size(mfc1_m7InterFace, distance = p1272grid);
mfc1_m7InterFace = (mfc1_m7InterFace_size not m7_stop);
mfc1_m7InterFace = size( mfc1_m7InterFace , distance = p1272grid);
      mfc1_m8InterFace = copy(mfc1_m8Port);
mfc1_m8InterFace_size = size(mfc1_m8InterFace, distance = p1272grid);
mfc1_m8InterFace = (mfc1_m8InterFace_size not m8_stop);
mfc1_m8InterFace = size( mfc1_m8InterFace , distance = p1272grid);
      mfc1_m9InterFace = copy(mfc1_m9Port);
mfc1_m9InterFace_size = size(mfc1_m9InterFace, distance = p1272grid);
mfc1_m9InterFace = (mfc1_m9InterFace_size not m9_stop);
mfc1_m9InterFace = size( mfc1_m9InterFace , distance = p1272grid);
      mfc1_m10InterFace = copy(mfc1_m10Port);
mfc1_m10InterFace_size = size(mfc1_m10InterFace, distance = p1272grid);
mfc1_m10InterFace = (mfc1_m10InterFace_size not m10_stop);
mfc1_m10InterFace = size( mfc1_m10InterFace , distance = p1272grid);
      mfc1_m11InterFace = copy(mfc1_m11Port);
mfc1_m11InterFace_size = size(mfc1_m11InterFace, distance = p1272grid);
mfc1_m11InterFace = (mfc1_m11InterFace_size not m11_stop);
mfc1_m11InterFace = size( mfc1_m11InterFace , distance = p1272grid);
      mfc1_m12InterFace = copy(mfc1_m12Port);
mfc1_m12InterFace_size = size(mfc1_m12InterFace, distance = p1272grid);
mfc1_m12InterFace = (mfc1_m12InterFace_size not m12_stop);
mfc1_m12InterFace = size( mfc1_m12InterFace , distance = p1272grid);
      mfc1_tm1InterFace = copy(mfc1_tm1Port);
mfc1_tm1InterFace_size = size(mfc1_tm1InterFace, distance = p1272grid);
mfc1_tm1InterFace = (mfc1_tm1InterFace_size not mfcstoptm1);
mfc1_tm1InterFace = size( mfc1_tm1InterFace , distance = p1272grid);
   ...
   m11InterFace = copy(m11Port);
   m12InterFace = copy(m12Port);
   ...
   #ifdef _drMFC2block
     mfc2_m0InterFace = mfc2_m0Port or mfc2_m0TLPin;
     mfc2_m1InterFace = mfc2_m1Port or mfc2_m1TLPin;
     mfc2_m2InterFace = mfc2_m2Port or mfc2_m2TLPin;
     mfc2_m3InterFace = mfc2_m3Port or mfc2_m3TLPin;
     mfc2_m4InterFace = mfc2_m4Port or mfc2_m4TLPin;
     mfc2_m5InterFace = mfc2_m5Port or mfc2_m5TLPin;
     mfc2_m6InterFace = mfc2_m6Port or mfc2_m6TLPin;
     mfc2_m7InterFace = mfc2_m7Port or mfc2_m7TLPin;
     mfc2_m8InterFace = mfc2_m8Port or mfc2_m8TLPin;
     mfc2_m9InterFace = mfc2_m9Port or mfc2_m9TLPin;
     mfc2_m10InterFace = mfc2_m10Port or mfc2_m10TLPin;
     mfc2_m11InterFace = mfc2_m11Port or mfc2_m11TLPin;
     mfc2_m12InterFace = mfc2_m12Port or mfc2_m12TLPin;
     mfc2_tm1InterFace = mfc2_tm1Port or mfc2_tm1TLPin;
   #endif 
   #ifdef _drMFCblock     
     mfc1_m0InterFace = mfc1_m0Port or mfc1_m0TLPin;
     mfc1_m1InterFace = mfc1_m1Port or mfc1_m1TLPin;
     mfc1_m2InterFace = mfc1_m2Port or mfc1_m2TLPin;
     mfc1_m3InterFace = mfc1_m3Port or mfc1_m3TLPin;
     mfc1_m4InterFace = mfc1_m4Port or mfc1_m4TLPin;
     mfc1_m5InterFace = mfc1_m5Port or mfc1_m5TLPin;
     mfc1_m6InterFace = mfc1_m6Port or mfc1_m6TLPin;
     mfc1_m7InterFace = mfc1_m7Port or mfc1_m7TLPin;
     mfc1_m8InterFace = mfc1_m8Port or mfc1_m8TLPin;
     mfc1_m9InterFace = mfc1_m9Port or mfc1_m9TLPin;
     mfc1_m10InterFace = mfc1_m10Port or mfc1_m10TLPin;
     mfc1_m11InterFace = mfc1_m11Port or mfc1_m11TLPin;
     mfc1_m12InterFace = mfc1_m12Port or mfc1_m12TLPin;
     mfc1_tm1InterFace = mfc1_tm1Port or mfc1_tm1TLPin;
   #endif
   ...
   m11InterFace = m11Port or m11TLPin;
   m12InterFace = m12Port or m12TLPin;
...
c4bInterFace = copy(c4bPort);
   ...
   VIA12 = copy(via12nores);
      ...
      #endif // _drRFblock
      #ifdef _drMFCblock
        mfc1_gcn_tcn = mfc1_polycon and mfc1_diffcon;
        gcn_tcn = gcn_tcn not mfc1_gcn_tcn;
      #endif // _drMFCblock
      ...
      #endif
      #ifdef _drMFCblock
         mfc1_polycon = mfc1_polycon not mfc1_gcn_tcn;
      #endif
   #endif // _drRCextractUnimp  
   ...
   #endif
#ifdef _drMFCblock
	mfc1_nsd = nsd and mfcscldev;
        nsd = nsd not mfc1_nsd;
	mfc1_psd = psd and mfcscldev;
        psd = psd not mfc1_psd;
	mfc1_npickup = npickup and mfcscldev;
        npickup = npickup not mfc1_npickup;
	mfc1_ppickup = ppickup and mfcscldev;
	ppickup = ppickup not mfc1_ppickup;
#endif

#endif

#ifdef _drRCextract
//mahesh: mimiking dnw handling

psub = not(layer1 = pwell, layer2 = ALLNWELL, processing_mode = CELL_LEVEL);
pwell_ext = copy(pwell);
#endif
   ...
   drPassthruStack.push_back({m11Port, {158,105} }); // m11 port
   drPassthruStack.push_back({m12Port, {162,105} }); // m12 port
   ...
   drPassthruStack.push_back({m11TLPin, {158,107} }); // m11 pin
   drPassthruStack.push_back({m12TLPin, {162,107} }); // m12 pin
   ...
   drPassthruStack.push_back({m11InterFace, {158,108} }); // m11 interface
   drPassthruStack.push_back({m12InterFace, {162,108} }); // m12 interface
...
// metal by vias  
      ...
      {layers = {tm1nores}, by_layer = ind_tm1_term },
	  #if _drPROCESS == 6
         #if (!defined(_drRCextract))
            {layers = {tm1nores, metal12nores, CE1, CE2, CE3}, by_layer = via12nores },
         #else
            #ifndef _drICFMIM
               {layers = {tm1nores, metal12nores}, by_layer = VIA12 },
               {layers = {tm1nores, mim_scl_top_plate}, by_layer = VIA12 },
               {layers = {tm1nores, mim_scl_bottem_plate}, by_layer = VIA12 },
               {layers = {metal12nores, CE1}, by_layer = VIA12 },
               {layers = {metal12nores, CE2}, by_layer = VIA12 },
               {layers = {metal12nores, CE3}, by_layer = VIA12 },
            #else
               {layers = {tm1nores, metal12nores}, by_layer = VIA12 },
         ...
         #endif
         {layers = {metal12nores}, by_layer = ind_m12_term },
         #ifndef _drRCextract
            {layers = {metal12nores, metal11nores}, by_layer = via11nores },
            {layers = {metal11nores, metal10nores}, by_layer = via10nores },
            {layers = {metal10nores, metal9nores}, by_layer = via9nores },
         #else
...
// diffcon connects 
      ...
      #ifdef _drMFCblock
      	{layers = {mfc1_nsd}, by_layer = nsd }, 
      	{layers = {mfc1_nsd, mfc1_diffcon}, by_layer = cont_ndiff2tcn }, 
      	{layers = {mfc1_npickup }, by_layer = npickup }, 
       	{layers = {mfc1_npickup, mfc1_diffcon }, by_layer = cont_ndiff2tcn }, 
      	{layers = {mfc1_psd}, by_layer = psd }, 
       	{layers = { mfc1_psd, mfc1_diffcon }, by_layer = cont_pdiff2tcn },
       	{layers = { mfc1_ppickup }, by_layer = ppickup },
      	{layers = { mfc1_ppickup, mfc1_diffcon }, by_layer = cont_pdiff2tcn },
      #endif
    #endif
...
// polycon connects
      ...
      {layers = {diffcon_nores,polycon_nores}, by_layer = gcn_tcn },
        ...
        {layers = {p_dummy_gate_fbd_rf }, by_layer = p_dummy_gate_fbd  },
        {layers = {poly_nores_rf,p_dummy_gate_fbd_rf }, by_layer = diffcon_nores_rf  },
        {layers = {poly_nores_rf,p_dummy_gate_fbd_rf,  diffcon_nores_rf ,poly_nores_rf}, by_layer = polycon_nores_rf},
        {layers = {p_dummy_gate_fbd_rf, poly_nores_rf, polycon_nores_rf}, by_layer = gcn_tcn_rf },
      #endif
      #ifdef _drMFCblock
        {layers = {mfc1_p_dummy_gate_fbd }, by_layer = p_dummy_gate_fbd  },
        {layers = {mfc1_poly_nores,mfc1_p_dummy_gate_fbd }, by_layer = mfc1_diffcon  },
        {layers = {mfc1_poly_nores,mfc1_p_dummy_gate_fbd,  mfc1_diffcon ,mfc1_poly_nores}, by_layer = mfc1_polycon },
        {layers = {mfc1_p_dummy_gate_fbd, mfc1_poly_nores, mfc1_polycon}, by_layer = mfc1_gcn_tcn },
        {layers = {mfc1_poly_nores, mfc1_diffcon }, by_layer = mfc1_polycon },
        {layers = {mfc1_poly_nores }, by_layer = poly_nores  },
        {layers = {mfc1_poly_nores }, by_layer = mfc1_diffcon  },
        {layers = {poly_nores }, by_layer = mfc1_diffcon  },
        {layers = {mfc1_poly_nores }, by_layer = diffcon_nores  },
        {layers = {mfc1_diffcon,mfc1_polycon}, by_layer = mfc1_gcn_tcn },
        {layers = {p_dummy_gate_fbd, mfc1_poly_nores, mfc1_polycon}, by_layer = mfc1_gcn_tcn },
      #endif
...
//    #if (!defined(_drRCextract))
      ...
      {layers = {rfreq_ngate_par, rfreq_pgate_par,
                 ...
                 rfreq_ngate_stk_tgulv, rfreq_pgate_stk_tgulv,
                 rfreq_ngate_stk_lllp, rfreq_pgate_stk_lllp,poly_nores
		         }, by_layer = mfc1_poly_nores},
#endif
#if (!(defined _drRFblock && defined _drMFCblock)) 
      {layers = {rfreq_ngate_par, rfreq_pgate_par,
                 rfreq_ngate_par_a, rfreq_pgate_par_a,
                 rfreq_ngate_par_av1, rfreq_pgate_par_av1,
                 rfreq_ngate_par_av2, rfreq_pgate_par_av2,
...
// real subset of nores for cadnav
      ...
      #if _drPROCESS == 6
         {layers = {real_m12}, by_layer = metal12nores },
         {layers = {real_m11}, by_layer = metal11nores },
...
//port connections
   ...
   #endif
   #ifdef _drMFC2block
   {layers = {mfc2_m0InterFace}, by_layer = mfc2_m0 },
   {layers = {mfc2_m1InterFace}, by_layer = mfc2_m1 },
   {layers = {mfc2_m2InterFace}, by_layer = mfc2_m2 },
   {layers = {mfc2_m3InterFace}, by_layer = mfc2_m3 },
   {layers = {mfc2_m4InterFace}, by_layer = mfc2_m4 },
   {layers = {mfc2_m5InterFace}, by_layer = mfc2_m5 },
   {layers = {mfc2_m6InterFace}, by_layer = mfc2_m6 },
   {layers = {mfc2_m7InterFace}, by_layer = mfc2_m7 },
   {layers = {mfc2_m8InterFace}, by_layer = mfc2_m8 },
   {layers = {mfc2_m9InterFace}, by_layer = mfc2_m9 },   
   #if _drPROCESS == 6
      {layers = {mfc2_m10InterFace}, by_layer = mfc2_m10 },
      {layers = {mfc2_m11InterFace}, by_layer = mfc2_m11 },
      {layers = {mfc2_m12InterFace}, by_layer = mfc2_m12 },   
   #endif // _drPROCESS == 6
   {layers = {mfc2_tm1InterFace}, by_layer = mfc2_tm1 },   
   #endif // _drMFC2block
   #ifdef _drMFCblock
   {layers = {mfc1_diffconInterFace}, by_layer = mfc1_diffcon},
   {layers = {mfc1_polyconInterFace}, by_layer = mfc1_polycon },
   {layers = {mfc1_polyInterFace}, by_layer = mfc1_poly_nores },
   {layers = {mfc1_m0InterFace}, by_layer = mfc1_m0 },
   {layers = {mfc1_m1InterFace}, by_layer = mfc1_m1 },
   {layers = {mfc1_m2InterFace}, by_layer = mfc1_m2 },
   {layers = {mfc1_m3InterFace}, by_layer = mfc1_m3 },
   {layers = {mfc1_m4InterFace}, by_layer = mfc1_m4 },
   {layers = {mfc1_m5InterFace}, by_layer = mfc1_m5 },
   {layers = {mfc1_m6InterFace}, by_layer = mfc1_m6 },
   {layers = {mfc1_m7InterFace}, by_layer = mfc1_m7 },
   {layers = {mfc1_m8InterFace}, by_layer = mfc1_m8 },
   {layers = {mfc1_m9InterFace}, by_layer = mfc1_m9 },
   #if _drPROCESS == 6
      {layers = {mfc1_m10InterFace}, by_layer = mfc1_m10 },
      {layers = {mfc1_m11InterFace}, by_layer = mfc1_m11 },
      {layers = {mfc1_m12InterFace}, by_layer = mfc1_m12 },
   #endif // _drPROCESS == 6
   {layers = {mfc1_tm1InterFace}, by_layer = mfc1_tm1 },
   #endif // _drMFCblock
   ...
   {layers = {m9InterFace}, by_layer = metal9nores },
      ...
      {layers = {m11InterFace}, by_layer = metal11nores },
      {layers = {m12InterFace}, by_layer = metal12nores },
   #endif
   ...
   txt_trace_soft_connect = text_net (
      ...
      text_layer_items = {
         ...
         #ifdef _drMFC2block
         {layer = mfc2_tm1, text_layer = TM1BC_txt},	 
         #endif
         #ifdef _drMFCblock
         {layer = mfc1_tm1, text_layer = TM1BC_txt},
	 #endif
         {layer = CE1, text_layer = CE1_txt},
         {layer = CE2, text_layer = CE2_txt},
         {layer = CE3, text_layer = CE3_txt},
         #if _drPROCESS == 6
            {layer = metal12nores, text_layer = METAL12BC_txt},
            {layer = metal11nores, text_layer = METAL11BC_txt},
            {layer = metal10nores, text_layer = METAL10BC_txt},
	    #ifdef _drMFC2block
            {layer = mfc2_m12, text_layer = METAL12BC_txt},
            {layer = mfc2_m11, text_layer = METAL11BC_txt},
            {layer = mfc2_m10, text_layer = METAL10BC_txt},	    
            #endif
	    #ifdef _drMFCblock
            {layer = mfc1_m12, text_layer = METAL12BC_txt},
            {layer = mfc1_m11, text_layer = METAL11BC_txt},
            {layer = mfc1_m10, text_layer = METAL10BC_txt},
	    #endif
         #endif
	 ...
	 #ifdef _drMFC2block
         {layer = mfc2_m9, text_layer = METAL9BC_txt},
         {layer = mfc2_m8, text_layer = METAL8BC_txt},
         {layer = mfc2_m7, text_layer = METAL7BC_txt},
         {layer = mfc2_m6, text_layer = METAL6BC_txt},
         {layer = mfc2_m5, text_layer = METAL5BC_txt},
         {layer = mfc2_m4, text_layer = METAL4BC_txt},
         {layer = mfc2_m3, text_layer = METAL3BC_txt},
         {layer = mfc2_m2, text_layer = METAL2BC_txt},
         {layer = mfc2_m1, text_layer = METAL1BC_txt},
         {layer = mfc2_m0, text_layer = METAL0BC_txt},
	 #endif 	 
	 #ifdef _drMFCblock
         {layer = mfc1_m9, text_layer = METAL9BC_txt},
         {layer = mfc1_m8, text_layer = METAL8BC_txt},
         {layer = mfc1_m7, text_layer = METAL7BC_txt},
         {layer = mfc1_m6, text_layer = METAL6BC_txt},
         {layer = mfc1_m5, text_layer = METAL5BC_txt},
         {layer = mfc1_m4, text_layer = METAL4BC_txt},
         {layer = mfc1_m3, text_layer = METAL3BC_txt},
         {layer = mfc1_m2, text_layer = METAL2BC_txt},
         {layer = mfc1_m1, text_layer = METAL1BC_txt},
         {layer = mfc1_m0, text_layer = METAL0BC_txt},
	 #endif
      #ifdef _drRCextract
	  ...
	  // {layer = poly_nores_nogate, text_layer = POLY_txt},
          ...
          #ifdef _drRFblock
		{layer = p_dummy_gate_fbd_rf, text_layer = POLY_txt},
		{layer = poly_nores_rf, text_layer = POLY_txt},
          ...
          #endif
          #ifdef _drMFCblock
                {layer = mfc1_p_dummy_gate_fbd, text_layer = POLY_txt},
                {layer = mfc1_poly_nores, text_layer = POLY_txt},
                {layer = mfc1_gcn_tcn, text_layer = POLYCON_txt},
                {layer = mfc1_nsd , text_layer = NDIFF_txt},
                {layer = mfc1_psd , text_layer = PDIFF_txt},
                {layer = mfc1_polycon , text_layer = POLYCON_txt},
                {layer = mfc1_diffcon, text_layer = DIFFCON_txt},
          #endif
      #endif
...
trace_netlist_connect = incremental_connect(
   ...
   connect_items = {
      // bulk __drsubstrate connections
         ...
         {layers = {pwelltap, dnpdnw_anode, ppickup }, by_layer = pwell },
         {layers = {pwelltap, dnpdnw_anode}, by_layer = pwell_dnw },
         {layers = {nwell_nores, dnpdnw_cathode, dpndnw_cathode}, by_layer = DEEPNWELL },
         {layers = {ppickup, nac_anode, dpndnw_anode, djnw_anode}, by_layer = __drsubstrate },
      #else
	 {layers = {dnpdnw_anode}, by_layer = pwell_ext },
	 {layers = {pwelltap, dnpdnw_anode, ppickup, pwell_ext, pwell_dnw  }, by_layer =cont_pwell2pwelltap },
	 {layers = {dnpdnw_anode}, by_layer = pwell_dnw },
         {layers = {nwell_nores, dnpdnw_cathode, dpndnw_cathode}, by_layer = DEEPNWELL },
	 {layers = {nac_anode, dpndnw_anode }, by_layer = __drsubstrate },
	 {layers = {ppickup,nac_anode, dpndnw_anode, pwell_ext,__drsubstrate}, by_layer = cont_sub2ppickup},
         #ifdef _drRFblock
            {layers = {ppickup_rf, __drsubstrate, pwell_ext}, by_layer = cont_sub2ppickup},
            {layers = {npickup_rf, nwellesd_nores}, by_layer = cont_sub2npickup}, 
            {layers = {npickup_rf, nwell_nores}, by_layer = cont_sub2npickup},
         #endif
	 #ifdef _drMFCblock
         {layers = {mfc1_ppickup, __drsubstrate, pwell_ext}, by_layer = cont_sub2ppickup},
         {layers = {mfc1_npickup, nwellesd_nores}, by_layer = cont_sub2npickup}, 
         {layers = {mfc1_npickup, nwell_nores}, by_layer = cont_sub2npickup},
         #endif
      ...
      #ifdef _drRFblock
      {layers = {diffcon_nores, polycon_nores, poly_nores, nsd, psd, npickup, ppickup, diffcon_nores_rf, polycon_nores_rf, poly_nores_rf, nsd_rf, psd_rf, npickup_rf, ppickup_rf, pwelltap},
		   by_layer = TSV }
      #else
      {layers = {diffcon_nores, polycon_nores, poly_nores, nsd, psd, npickup, ppickup, pwelltap},
		   by_layer = TSV }
      #endif
  }
); 
...
trace_netlist_connect_ported = create_ports(
   ...
   port_items = {
     ...
     #if _drPROCESS == 6
        {metal12nores, m12InterFace},
        {metal11nores, m11InterFace},
     ...
     #endif
     #ifdef _drMFC2block
     {mfc2_m0, mfc2_m0InterFace},
     {mfc2_m1, mfc2_m1InterFace},
     {mfc2_m2, mfc2_m2InterFace},
     {mfc2_m3, mfc2_m3InterFace},
     {mfc2_m4, mfc2_m4InterFace},
     {mfc2_m5, mfc2_m5InterFace},
     {mfc2_m6, mfc2_m6InterFace},
     {mfc2_m7, mfc2_m7InterFace},
     {mfc2_m8, mfc2_m8InterFace},
     {mfc2_m9, mfc2_m9InterFace},
     #if _drPROCESS == 6
     {mfc2_m10, mfc2_m10InterFace},
     {mfc2_m11, mfc2_m11InterFace},
     {mfc2_m12, mfc2_m12InterFace},     
     #endif
     {mfc2_tm1, mfc2_tm1InterFace},     
     #endif
     #ifdef _drMFCblock
     {mfc1_diffcon, mfc1_diffconInterFace},
     {mfc1_polycon, mfc1_polyconInterFace},
     {mfc1_poly_nores, mfc1_polyInterFace},
     {mfc1_m0, mfc1_m0InterFace},
     {mfc1_m1, mfc1_m1InterFace},
     {mfc1_m2, mfc1_m2InterFace},
     {mfc1_m3, mfc1_m3InterFace},
     {mfc1_m4, mfc1_m4InterFace},
     {mfc1_m5, mfc1_m5InterFace},
     {mfc1_m6, mfc1_m6InterFace},
     {mfc1_m7, mfc1_m7InterFace},
     {mfc1_m8, mfc1_m8InterFace},
     {mfc1_m9, mfc1_m9InterFace},
     #if _drPROCESS == 6
     {mfc1_m10, mfc1_m10InterFace},
     {mfc1_m11, mfc1_m11InterFace},
     {mfc1_m12, mfc1_m12InterFace},
     #endif
     {mfc1_tm1, mfc1_tm1InterFace},
     #endif
     ...
     #if (!defined(_drRCextract))  
        {pwell, pwellsubisopin}
     #else
        {pwell_ext, pwellsubisopin}
     #endif
   },
   report = {}
);
...
txt_trace_netlist_connect = text_net (
...
#ifndef _drRCextract
      {layer = pwell, text_layer = PWELL_SUBISO_txt},
      {layer = __drsubstrate, text_layer = SUBISOTEXT_txt}  // text for substrate 
   },
   #if (defined(_drSCTxtPWL))
      text_string_items = {
         #if (_drCaseSensitive == _drNO) // UPPERCASE
            {layer= pwell, text = "VSS"}
         #else
            {layer= pwell, text = "vss"}
         #endif
      },
   #endif
#else
      {layer = pwell_ext, text_layer = PWELL_SUBISO_txt},
      {layer = __drsubstrate, text_layer = SUBISOTEXT_txt}  // text for substrate 
      #if (defined(_drRCextractUnimp)  && !defined(_drRCextractMetalFillGds) )
          ,
          #include <rcext/unimp_net_text.rs>
...
#include <1273/p1273d6_Tchks.rs>

#endif // _P1273D6_TCONN_RS_
