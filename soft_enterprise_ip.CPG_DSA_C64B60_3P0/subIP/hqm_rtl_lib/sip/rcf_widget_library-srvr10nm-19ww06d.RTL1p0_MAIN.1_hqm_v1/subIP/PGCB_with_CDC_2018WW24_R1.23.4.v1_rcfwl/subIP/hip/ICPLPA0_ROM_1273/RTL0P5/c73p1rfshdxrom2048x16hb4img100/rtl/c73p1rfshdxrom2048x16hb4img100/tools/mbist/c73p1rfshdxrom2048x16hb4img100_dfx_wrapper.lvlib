...
//##############################################################################
//##
//##   Memory Name: c73p1rfshdxrom2048x16hb4img100
//##
//##   Memory Features :
//##   =========================================================================
//##       Word Width             = 16
...
MemoryTemplate (c73p1rfshdxrom2048x16hb4img100_dfx_wrapper) {

        MemoryType                           : ROM;
        CellName                             : c73p1rfshdxrom2048x16hb4img100_dfx_wrapper;
        LogicalPorts                         : 1R0W;
        OperationSet                         : ROM;
        ATD                                  : Off;
        Algorithm                            : ReadOnly;
...
//----- Start of Logical Port wrapper definition -------------------
   ...
   Port (DATA_ROM_OUT)          { BusRange: [15:0]; Direction: Output; Function: Data; }
}
