...
set ::collage_ip_info::ip_name "rlink_iosf_clkdist"
set ::collage_ip_info::ip_top_module_name "rlink_iosf_clkdist"
...
set ::collage_ip_info::ip_input_files $::env(MODEL_ROOT)/src/rtl/clkdist/rlink_iosf_clkdist.sv

set ::collage_ip_info::ip_plugin_dir "" ; # Directories - space separated list - with tcl plugin files
set ::collage_ip_info::ip_ifc_def_hook "rlink_iosf_clkdist_create_ifc_instances" ; # Set this to procedure to add IP interfaces - defined below

######################################################################
# Procedure to create IP interfaces
######################################################################
proc rlink_iosf_clkdist_create_ifc_instances {} {
