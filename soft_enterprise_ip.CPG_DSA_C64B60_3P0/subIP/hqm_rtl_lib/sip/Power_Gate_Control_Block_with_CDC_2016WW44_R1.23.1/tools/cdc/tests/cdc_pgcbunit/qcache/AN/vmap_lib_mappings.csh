...
if($status == 0) then
  $vmap_exec pgcb_collection_cdc_testlib /nfs/fm/disks/fm_pmc_00089/ssing18/PGCB/ip-pwrmisc-tgl/tools/cdc/tests/cdc_pgcbunit/pgcb_collection_cdc_testlib
else
...
if($status == 0) then
  $vmap_exec cdc_tooltb_lib /nfs/fm/disks/fm_pmc_00089/ssing18/PGCB/ip-pwrmisc-tgl/target/pgcb_collection/cdc_lib/V10.4d_1/cdc_tooltb_lib
else
...
if($status == 0) then
  $vmap_exec cdc_synccell_lib /nfs/fm/disks/fm_pmc_00089/ssing18/PGCB/ip-pwrmisc-tgl/target/pgcb_collection/cdc_lib/V10.4d_1/cdc_synccell_lib
else
...
if($status == 0) then
  $vmap_exec cdc_pgcbcg_lib /nfs/fm/disks/fm_pmc_00089/ssing18/PGCB/ip-pwrmisc-tgl/target/pgcb_collection/cdc_lib/V10.4d_1/cdc_pgcbcg_lib
else
...
if($status == 0) then
  $vmap_exec cdc_ClockDomainController_lib /nfs/fm/disks/fm_pmc_00089/ssing18/PGCB/ip-pwrmisc-tgl/target/pgcb_collection/cdc_lib/V10.4d_1/cdc_ClockDomainController_lib
else
...
if($status == 0) then
  $vmap_exec cdc_pgcbunit_lib /nfs/fm/disks/fm_pmc_00089/ssing18/PGCB/ip-pwrmisc-tgl/target/pgcb_collection/cdc_lib/V10.4d_1/cdc_pgcbunit_lib
else
...
if($status == 0) then
  $vmap_exec ieee /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../ieee
else
...
if($status == 0) then
  $vmap_exec vital2000 /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../vital2000
else
...
if($status == 0) then
  $vmap_exec verilog /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../verilog
else
...
if($status == 0) then
  $vmap_exec std_developerskit /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../std_developerskit
else
...
if($status == 0) then
  $vmap_exec synopsys /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../synopsys
else
...
if($status == 0) then
  $vmap_exec modelsim_lib /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../modelsim_lib
else
...
if($status == 0) then
  $vmap_exec sv_std /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../sv_std
else
...
if($status == 0) then
  $vmap_exec mtiAvm /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../avm
else
...
if($status == 0) then
  $vmap_exec mtiRnm /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../rnm
else
...
if($status == 0) then
  $vmap_exec mtiOvm /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../ovm-2.1.2
else
...
if($status == 0) then
  $vmap_exec mtiUvm /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../uvm-1.1d
else
...
if($status == 0) then
  $vmap_exec mtiUPF /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../upf_lib
else
...
if($status == 0) then
  $vmap_exec mtiPA /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../pa_lib
else
...
if($status == 0) then
  $vmap_exec floatfixlib /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../floatfixlib
else
...
if($status == 0) then
  $vmap_exec mc2_lib /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../mc2_lib
else
...
if($status == 0) then
  $vmap_exec osvvm /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../osvvm
else
...
if($status == 0) then
  $vmap_exec mgc_ams /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../mgc_ams
else
...
if($status == 0) then
  $vmap_exec ieee_env /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../ieee_env
else
...
if($status == 0) then
  $vmap_exec infact /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../infact
else
...
if($status == 0) then
  $vmap_exec vhdlopt_lib /nfs/site/disks/hdk_cad_root_2/cad/x86-64_linux26/mentor/questaCDC/V10.4d_1/share/modeltech/linux_x86_64/../vhdlopt_lib
else
...
if($status == 0) then
  $vmap_exec work /nfs/fm/disks/fm_pmc_00089/ssing18/PGCB/ip-pwrmisc-tgl/tools/cdc/tests/cdc_pgcbunit/qcache/AN/zin_vopt_work
else
